package classes.Scenes.Combat 
{
	...
	public class CombatAbilities extends BaseContent
	{
		...
		public function nagaBiteAttack(targetSelected:Boolean = false, monsterTarget:Monster = null):void {
		...
		public function spiderBiteAttack(targetSelected:Boolean = false, monsterTarget:Monster = null):void {
		...
		    if (rand(player.spe/2 + 40) + 20 > monsterTarget.spe/1.5) {
				...
				if (monsterTarget.lustVuln == 0) outputText("  Your aphrodisiac toxin has no effect!");
					...
					var lustDmg:int = 25 * monsterTarget.lustVuln;
		...
		public function PCWebAttack(targetSelected:Boolean = false, monsterTarget:Monster = null):void {
		...
		public function kissAttack(targetSelected:Boolean = false, monsterTarget:Monster = null):void {
		...
		public function tailSlamAttack(targetSelected:Boolean = false, monsterTarget:Monster = null):void {
			...
			// Stun chance
			var chance:int = Math.floor(monsterTarget.statusEffectv1(StatusEffects.TimesBashed) + 1);
		...
		public function tailSlapAttack(targetSelected:Boolean = false, monsterTarget:Monster = null):void {
