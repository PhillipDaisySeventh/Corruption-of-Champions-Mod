package classes.Scenes.Places.Farm
{
	...
	public class FarmCorruption extends AbstractFarmContent
	{
		...
		private function keltAChangeInManagement():void
		{
			...
			outputText("“<i>Do I look like I want or need your sloppy seconds? Godsdamn, I can only imagine what kind of pathetic creatures would have </i>you<i> lording it over them. What a joke! Now, are we going to go watch you fail miserably to hit a target from five " + UnitSystem.literalYards() + " or what?</i>” ");
		...
		private function whitneyAppearanceCorrupt():void
		{
			...
			outputText("Whitney is a " + UnitSystem.displayHeight2Short2(5, 8) + " dog");
		...
		private function firstCockOralTraining():void
		{
			...
			outputText("Slowly the dog woman does as you ask, bending forward and opening her mouth to lap at the end of your [cock biggest] with her flat tongue. Awkwardly, with one hand in her panties, she grasps your base with her other hand to steady herself with a grunt and sends her tongue running down your sensitive underside; you sigh at the delicious sensation, letting her know exactly what pleases you as she runs her wet, warm muscle over every " + UnitSystem.literalInch() + " she can reach, quickly making you fully erect and pulsing with urgency. Rather than engulf your head with her mouth though, she keeps tonguing at you, faster and faster. You frown down. It’s pleasant but not satisfying, and she’s already lost herself in the act, eyes closed and lapping at your groin like a dog going at her...");
		...
		private function firstCockOralTrainingStageTwo():void
		{
			...
			if (player.hasVagina() && player.balls > 0)
			{
				...
				if (player.cumQ() >= 1500)  outputText(" which is no mean feat, given it feels like you’ve fucked what feels like " + UnitSystem.aGallon() + " of it down her gullet. Once you’re almost done, as ever you spurt the last few creamy ropes across her face and clothes");
				outputText(".");
		...
		private function cockOralTrainingStageTwo():void
		{
			...
			if (!player.hasVagina())
			{
				...
				outputText("\n\n");
				if (player.balls > 0) outputText("\n\nShe begins as you’ve already bid her, bending in to lap at your [balls], silently sending her warm, wet tongue rolling and questing around your gonads, polishing every " + UnitSystem.literalInch() + " of them, taking each into her mouth intermittently to bathe them in close, sucking attention. ");
			...
			else if (player.hasVagina())
			{
				...
				if (player.balls > 0) outputText("\n\nShe begins as you have bidden her, bending in to lap at your [balls], silently sending her warm, wet tongue rolling and questing around your gonads, polishing every " + UnitSystem.literalInch() + " of them, taking each into her mouth intermittently to bathe them in close, sucking attention.");
		...
		private function cockOralTrainingMaxed():void
		{
			...
			if (!player.hasVagina())
			{
				...
				if (player.balls > 0) outputText("You sigh blissfully as her plump lips push into your [balls] before the flat, warm flannel-like tongue spreads itself across them, covering every " + UnitSystem.literalInch() + ", each sensitive orb first sensuously kissed and then taken into your slave’s mouth to be suckled gently until they are thrumming and bulging with packed heat. The loving attention laved on them is made all the better by the soft, lustful moans turning into outright panting sobs of pleasure drifting up from between your legs as she obsequiously polishes them.");
			...
			else if (player.hasVagina())
			{
				...
				if (player.balls > 0) outputText("\n\nYou sigh blissfully as her plump lips push into your [balls] before the flat, warm flannel-like tongue spreads itself across them, covering every " + UnitSystem.literalInch() + ", each sensitive orb first sensuously kissed and then taken into your slave’s mouth to be suckled gently until they are thrumming and bulging with packed heat, the loving attention laved on them made all the better by the soft, lustful moans turning into outright panting sobs of pleasure drifting up from between your legs as she obsequiously polishes them.");
		...
		private function firstVaginaOralTraining():void
		{
			...
			outputText("\n\nYou sigh at the delicious sensation, letting her know exactly what pleases you as she runs her wet, warm muscle across every " + UnitSystem.literalInch() + " she can reach. It’s clumsy, she doesn’t seem to be able to find your [clit]");
		...
		private function firstVaginaOralTrainingStageTwo():void
		{
			...
			outputText(", kneading them gently and bathing them in saliva. Given her initial awkwardness at cunnilingus it’s remarkable how good she is at this. “<i>Lick every " + UnitSystem.literalInch() + "... that’s good. Suckle on them a bit... very good!</i>” You gasp a bit as she envelopes one of your nipples and");
			...
			if (player.wetness() >= 5) outputText(" which is no mean feat, given it feels like you gutter what feels like " + UnitSystem.aGallon() + " down her gullet. Once you’re almost done, as ever you get up and spurt the last of it on her hair and clothes");
			outputText(".");
		...
		private function vaginaOralTrainingStageTwo():void
		{
			...
			outputText("\n\nShe begins as you already bid her, hugging your waist as she laps at your [chest], eyes closed as she silently sends her warm, wet tongue rolling and questing across your softness, varnishing every " + UnitSystem.literalInch() + " of them with saliva before taking each of your [nipples] into her mouth to bathe them in close, sucking attention. It’s a process which is beautifully sensuous");
		...
		private function firstVaginaOralTrainingStageThree():void
		{
			...
			outputText("\n\nOnce you have settled yourself down the dog woman immediately sends her hand burying into her underwear, her heavy breath catching in her throat as she stares at you. It only takes a few seconds of urgent jerking before she spasms forward, her tongue out and eager to begin. She radiates heat as she pushes into your abdomen, pressing her mouth into your [chest]. Eyes closed, she silently sends her warm, flannel-like tongue rolling and questing across your softness, varnishing every " + UnitSystem.literalInch() + " of them with saliva, catching your skin gently here and there in her teeth, making the blood rise to the surface just so you can enjoy her licking all the more;");
		...
		private function vaginaOralTrainingStageThree():void
		{
			...
			outputText("\n\nShe radiates heat as she pushes into your abdomen, pressing her mouth into your [chest]. Eyes closed, she silently sends her warm, flannel-like tongue rolling and questing across your softness, varnishing every " + UnitSystem.literalInch() + " of them with saliva, catching your skin gently here and there in her teeth, making the blood rise to the surface just so you can enjoy her licking all the more;");
			if (!player.hasFuckableNipples()) outputText(" she takes each of your [nipples] into her mouth to bathe them in close, sucking attention");
			else outputText(" she sends her tongue lapping into each of your cunt nipples, curling at their sensitive pink until they are wet with need");
		...
		private function vaginaOralTrainingMaxed():void
		{
			...
			outputText("\n\nShe radiates heat as she pushes into your abdomen, pressing her mouth into your [chest]. Eyes closed, she silently pushes her plump lips into your softness before she sends her warm, flannel-like tongue rolling and questing across your skin, varnishing every " + UnitSystem.literalInch() + " of them with clinging saliva, catching your skin gently here and there in her teeth, making the blood rise to the surface just so you can enjoy her licking all the more;");
		...
		public function whitneyDomRide():void
		{
			...
			if (tooBig)
			{
				...
				outputText("\n\nYou groan as with a laugh she pulls away from your crown, shifts herself around, and rubs at the top side of your cock instead. She seems intent on masturbating herself on every " + UnitSystem.literalInch() + " of your dick, frosting every " + UnitSystem.literalInch() + " with her femjizz... and she has a lot of ground to cover.");
			...
			{
				outputText("\n\nYour mouth opens as she begins to revolve her supple hips, sliding her wet opening onto your [cock " + cockI + "], easily swallowing it whole before withdrawing and coming back, teasing you with her wet warmth. Your cock is forcibly hardened and sensitized to the point that you can feel every " + UnitSystem.literalInch() + " of her lips parting around your small cock, her tiny clit pushing into the bulging head. You can’t help but try and thrust your way into that tantalizingly warm, wet hole; you groan as with a laugh she pulls away from your crown, shifts herself around, and envelopes you from the other side. She seems intent on masturbating herself on you every way she can.");
		...
		private function orgyRoomTalk():void
		{
			...
			outputText("You might be able to recognize those but you have no idea what the final object you can make out in the room’s dusky gloom is, stood against the far wall. It’s at least " + UnitSystem.displayFootEstimateWithHyphenTextually(4) + " tall and looks like an ornate stone urn, with a round bottom, a thin body, some sort of square contraption at the top, and a series of long tubes emerging from its stem. There’s a very small brazier next to it, with a few pebbles of charcoal huffing feebly at the bottom.");
		...
		private function subHappyEndingMale():void
		{
			...
			{
				outputText("\n\nShe gasps as you push open her lips and spear into her depths with one thrust. Her pussy is used to your [cock " + cockThatFits + "] now, still deliciously tight and clenching but welcoming as well, perfectly designed to holster and squeeze every " + UnitSystem.literalInch() + " of your modestly sized prick with wet pleasure. Within a few moments your hips are touching hers, taking your cock down to the hilt. Her thighs tighten around your frame and you begin to lose yourself in the soft, slow rhythm.");
			}
