...
public function keltAppearance():void {
	...
	outputText("Kelt is a " + UnitSystem.displayHeight2WithHyphen(8) + " tall centaur with a muscular and well trained body.");
...
private function finalKeltBreaking():void {
	...
	outputText("Her hunger for your meaty junk seems to be insatiable, for after moments of dick kissing and licking, she decides to take the entirety of your length.  Her eyes are voracious as her fat lips swallow " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of dick-flesh.");
...
private function kellyAppearance():void {
	...
	outputText("\n\nShe sports a pair of soft DD-cup breasts.  Each one is ornate with a " + UnitSystem.displayInchWithHyphen(0.5, 1) + " nipple, often rock-hard in arousal.");
...
private function giveKellyEquinum():void {
	...
	outputText("\n\n\"<i>Hush pet, I'm just finishing what I started.  Soon you'll have a cunt fit for dumping " + UnitSystem.literalGallons() + " of jizz into, just like you wanted.</i>\"");
...
private function kellyTitJob():void {
	...
	if (player.cocks[x].cockLength <= 18) {
		...
		//[Kelly has four tits:
		if (flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0) {
			outputText("\n\nYour [hips] press upon the softness of her lower pair of tits; it dimly occurs to you what a fine idea growing a few extra " + UnitSystem.literalInches() + " of dickmeat to take full advantage of the shape of your centauress slave might be.");
		}
...
private function giveKellyAppleSauce():void {
	...
	if (flags[kFLAGS.KELLY_TIMES_APPLESAUCED] == 0) {
		...
		outputText("\n\n\"<i>You will?  I- well, thank you so much [Master], but you'll be careful, won't you?</i>\" she says fretfully, still wringing her hands.  You go into her barn, grab a metal bowl and then stride off gallantly, as if setting off to take on Lethice herself, when in fact your epic quest involves jumping over a fence and walking 200 " + UnitSystem.literalYards() + " through some light woodland.");
...
private function kellyBJsAhoy():void {
	...
	if (!player.isTaur()) {
		...
		if (player.balls > 0 && player.hasVagina()) {
			outputText("\n\nKelly brushes your [balls] out of the way as she burrows deep into your groin, her hot tongue finally pressing against your [vagina], oozing already in sympathy to the lust which has gripped your male sex.  She is a bit of a stranger to your female anatomy but she's a quick and eager learner, tracing your entrance with the tip of her tongue before pushing her plush lips into your opening, covering your outer lips and your clit in shifting softness as she burrows into your tunnel with her tongue, curling deep into you as she worships every " + UnitSystem.literalInch() + " she can reach with her flexible mouth muscle, lapping up every trace of sweet moisture she finds with vocal pleasure.");
			outputText("\n\nYou close your eyes and lose yourself for a while, very gently thrusting your [hips] into her hot mouth as she makes your [vagina] glow with pleasure, sending small spasms of ecstasy shooting through your core, keeping your [cock biggest] straining.  It'd be so easy to ride her face to orgasm... but no, you signed up for the whole ten " + UnitSystem.literalYards() + " here and she isn't even close to being finished.  With a bit of encouragement with your hips, you get her to pull away from your beading muff and move on to your balls.  She sighs as she begins to lavish them with worshipful attention.");
			//[Normal balls:
		...
		//Vagina:
			...
			outputText("\n\nYou close your eyes and lose yourself for a while, very gently thrusting your [hips] into her hot mouth as she makes your [vagina] glow with pleasure, sending small spasms of ecstasy shooting through your core, keeping your [cock biggest] straining.  It'd be so easy to ride her face to orgasm, but no, you signed up for the whole ten " + UnitSystem.literalYards() + " here and she isn't close to being finished.  With a bit of encouragement with your hips, you get her to pull away from your beading muff and move up to your cock.");
		}
		//Balls:
	...
	//Centaur:
		...
		//Vagina: 
			...
			outputText("\n\nKelly's hot tongue presses against your [vagina], oozing already in sympathy to the lust which has gripped your male sex.  She is a bit of a stranger to your female anatomy but she's a quick and eager learner, tracing your entrance with the tip of her tongue before pushing her plush lips into your opening. She covers your outer lips and your clit in shifting softness as she burrows into your tunnel with her tongue, curling deep into you as she worships every " + UnitSystem.literalInch() + " she can reach with her flexible mouth muscle.  Lapping up every trace of sweet moisture she finds, Kelly hums with vocal pleasure.");
