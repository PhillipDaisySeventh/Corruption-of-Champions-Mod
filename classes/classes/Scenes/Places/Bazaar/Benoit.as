		...
		*/
		...
		private function eggySuggest():void {
			...
			if (player.isTaur()) {
				...
				//[Small capacity: 
				if (player.vaginalCapacity() <= 30) outputText("\n\nYou slide back down onto " + benoitMF("him","her") + ", cooing this time as you feel " + benoitMF("him","her") + " bottom out with several " + UnitSystem.literalInches() + " of " + benoitMF("him","her") + " still outside of you. " + benoitMF("His","Her") + " thin, long length could not be more perfect for your tight sex; " + benoitMF("he","she") + " rubs your walls up and down as you dreamily thrust in and out of " + benoitMF("his","her") + " body, sending waves of pleasure flowing through you.");
				//Large capacity: 
			...
			//[Demon: 
				...
				if (player.vaginalCapacity() < 15) outputText("\n\nYou slide back down onto " + benoitMF("him","her") + ", cooing this time as you feel " + benoitMF("him","her") + " bottom out with several " + UnitSystem.literalInches() + " still outside. " + benoitMF("His","Her") + " thin member could not be more perfect for your tight sex; " + benoitMF("he","she") + " rubs your walls up and down as you dreamily thrust in and out of " + benoitMF("his","her") + " body, sending waves of pleasure washing through you.");
