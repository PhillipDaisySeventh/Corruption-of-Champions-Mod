package classes.Scenes.Places.Bazaar 
{
	...
	public class BlackCock extends BazaarAbstractContent
	{
		...
		private function eatFoodNomNom(foodName:String, foodEatDesc:String):void {
			...
			switch(foodName) {
				case "Rhino Steak":
					consumables.RHINOST.useItem();
					break;
				case "Echidna Cake":
					consumables.ECHIDCK.useItem();
					break;
				case "Giant Burger":
					player.refillHunger(70);
					if (flags[kFLAGS.HUNGER_ENABLED] == 0) player.modThickness(100, 4);
					if (rand(3) == 0 && player.hair.length < 16) player.hair.length += 0.5;
					break;
				case "P. Potatoes":
					player.refillHunger(70);
					if (flags[kFLAGS.HUNGER_ENABLED] == 0) player.modThickness(100, 2);
					if (flags[kFLAGS.HUNGER_ENABLED] == 0 || (rand(2) == 0 && player.hunger100 >= 80)) player.butt.rating++;
					break;
				case "Spicy Chilli":
		...
		private function grabAndysDongAfterSmoking():void {
			clearOutput();
			outputText("Feeling adventurous you wrap a hand around the " + UnitSystem.footCompound() + "-long doggy dong standing at attention next to you. Andy gives a soft gasp as you squeeze his hot dick. After giving it a few pumps he gently tugs your hand off of his leaking dog cock.");
			...
			if (player.hasCock()) { //Male/herm
				...
				outputText("\n\nYou reach out and grab the tall standing doggy dick. He gives you a firm tug and you do the same, drawing a soft chuckle from his lips. He's big, about a " + UnitSystem.footCompound() + "-long and a few " + UnitSystem.literalInches() + " thick. There's a knot at base of his cock, just where it exits the sheath.");
		...
		private function fuckAndyTheSatyr():void {
			...
			if (player.isTaur()) {
				...
				if (player.biggestCockLength() < 12) {
					...
					outputText("\n\nAs you push into the satyr’s fuzzy little tight ass he grunts, shifting slightly as he bites his lip and looks up at you with a cocky, daring look. He reaches up and pulls your [face] into his without warning, kissing you deeply as you work your [cock] into him. Once you’ve pushed " + UnitSystem.aFoot() + " of your [cock] into him he jerks away and releases a whoosh of air, his breath smelling like fine wine. You feel the light hair on his arm tickling your back as he holds you close, grunting as you work your full length into him until you’ve fully hilted the little guy.");
		...
		private function haveAndyFuckYou(isVaginal:Boolean):void {
			...
			if (player.isTaur()) { //Tauric lower body
				outputText("\n\nAndy’s soft hands glide down your sides to your lower back. You begin to tickle his other nipple with your head, tweaking it and gently pulling the bubblegum pink pierced flesh. As you do so you turn your head so you can see his " + UnitSystem.footCompound() + "-long dog cock as it juts out from his body like an extra limb. When you’re finished with this foreplay you tell Andy how badly you want him inside of you.");
				...
				outputText("\n\nOnce he’s down you can plainly see his tall standing erection. You guess his knotted dog dick to be a " + UnitSystem.footCompound() + "-long. The guy is leaking like a sieve. Just looking at the tall standing canine cock makes your " + (vagOrAss(isVaginal)) + " yearn to be filled. Andy is obviously as hungry for your " + (vagOrAss(isVaginal)) + " as you are for his dog cock, you can tell by the way he palms your tender flesh. With a smile you lower yourself, reaching down to tug his knotted shaft towards your waiting " + (vagOrAss(isVaginal)) + ".");
				//Looseness check
				if ((player.hasVagina() && player.vaginas[0].vaginalLooseness < 2 && isVaginal) || (!player.hasVagina() && player.ass.analLooseness < 2)) {
					outputText("\n\nThe bullet shaped head of Andy’s dog prick stretches your " + (vagOrAss(isVaginal)) + " to the max. The girth of it alone is almost enough to make you hop off and leave him there. Yet looking down at him, the way his eyes widen as he feels your tightness enveloping his cock, gives you the strength to continue. After dropping a line about what you’ll do to him should he move you slowly sink down onto the " + UnitSystem.footCompound() + "-long member, your teeth clenched and you descend. ");
					if (isVaginal) player.cuntChange(ANDY_COCK_AREA, true);
					else player.buttChange(ANDY_COCK_AREA, true);
