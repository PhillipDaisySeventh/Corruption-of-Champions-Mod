package classes.Scenes.Places.Bazaar
{
	...
	public class Lilium extends BazaarAbstractContent
	{
		...
		private function approachLilium():void {
			...
			menu();
			if (player.gems < 50) {
				outputText("<b>You remember that you haven't got the 50 gems for her services right now. Maybe next time.</b>");
		...
		private function buttFuckTongueJeorb():void {
			...
			if (player.biggestTitSize() >= 1) {
				outputText(" A tingle emanates from your " + player.nippleDescript(0) + "s as your " + player.allBreastsDescript() + " slide across her sweat-slicked back with every thrust.");
			...
			//(If naga body)
			if (player.isNaga()) outputText("As you both stand there, reeling in the wake of your ecstasy, she leans back against you causing you to flop onto your " + player.buttDescript() + " with the demon girl on top of you; you haven't the strength to remain standing.");
			//(else) 
			else outputText("As you both stand there, reeling in the wake of your ecstasy, she leans back against you causing you to flop onto your " + player.buttDescript() + " with the demon girl on top of you; your wobbling legs have temporarily lost the strength to keep you both upright.");
			outputText(" Lilium lets out a laugh and soon you find yourself laughing with her.\n\n");
			
			outputText("After you both recover, you get up to don your " + player.armorName + ", thanking Lilium and beginning the trip back to camp. Maybe you'll take a bath too...");
		...
		private function liliumDickRidah():void {
			...
			//(if player has breasts)
			if (player.biggestTitSize() >= 1) {
				outputText("You turn your attention to your own " + player.allBreastsDescript() + " and how they bounce from the force of your vigorous fucking, supporting the weight of your " + player.breastDescript(0) + " with your hands as you continue to ride Lilium's cock.");
				//(if demonic tongue)
				if (player.hasLongTongue()) outputText(" Letting your long tongue extend out from between your lips, you wrap it around one " + player.nippleDescript(0) + " and gently squeeze, sending an electric thrill that flows to your core and back out to the tips of your fingers.");
				//(else if no demonic tongue)
				else outputText(" You begin to squeeze your " + player.nippleDescript(0) + " between two fingers, sending an electric thrill that flows to your core and back out to the tips of your fingers.");
				...
				else if (player.biggestLactation() > 2) outputText(" A powerful stream of milk fires out of your " + player.nippleDescript(0) + ", coating Lilium's flat stomach.");
				outputText("\n\n");
			}
			...
			//(else if big clit)
			else outputText("Tenderly grasping it between your fingers you begin to rub your " + player.clitDescript() + " from base to tip, each stroke adding a wave of pleasure to that of the tongue treatment your " + player.vaginaDescript(0) + " is receiving.");
		...
		private function liliumNippleFuck():void {
			...
			//(else)
			else outputText("As her tongue reaches the end of its journey she gives the head of your " + player.cockDescript(x) + " a little flick with the tip of her tongue. ");
