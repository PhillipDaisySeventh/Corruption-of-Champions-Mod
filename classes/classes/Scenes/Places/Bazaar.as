package classes.Scenes.Places
{
	...
	public class Bazaar extends BaseContent 
	{
		...
		public var gretasGarments:GretasGarments = new GretasGarments();
		public var slipperySqueeze:SlipperySqueeze = new SlipperySqueeze();
		...
		private function collectSomeButtSmex():void {
			...
			outputText(" expression as the satyr's hand strokes over his hard length. It looks at least " + UnitSystem.displayInchesEstimateTextually(8) + " long, smooth like a human's cock and protruding from a forest of curly, brown fur. The satyr lines himself up and rubs his stiff cockhead over your " + player.assholeDescript()  + ".");
			...
			outputText("\n\nAll of this transpires as your " + player.buttDescript()  + " is slapped over and over by the low-hanging satyr balls. The satyr lets out a pleased groan every now and then as your body shivers and trembles from his length hilting in you over and over and over. He doesn't look like he'll stop anytime soon, though. You turn your head to see the tiger's barbed, " + UnitSystem.displayInchWithHyphenTextually(9) + " cock. The stubby barbs make your skin tingle with each graze across your cheek. On the other hand, the bear's cock looks shorter, about " + UnitSystem.displayInchesEstimateTextually(7) + " though by far the thickest meat in the bunch. The massive girth would most likely hurt your jaw if you tried to wrap your mouth around it. What do you do?");
