	...
	{	
		...
		public function prisonCaptorPunishmentBJTrainerDescribeStatus(verbose:Boolean = false):void
		{
			...
			if (verbose)
			{
				...
				{
					outputText(" Your face, " + player.allChestDesc() + ", knees, and indeed practically your whole body are coated in a sticky residue from wallowing back and forth in the lake of cum that has formed between the cask and the basin. ");
				}
				else
				{
					outputText(" " + UnitSystem.literalInches() + " away from being full enough for you to reach the key. ");
