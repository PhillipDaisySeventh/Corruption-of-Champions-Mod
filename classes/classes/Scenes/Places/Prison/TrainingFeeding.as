package classes.Scenes.Places.Prison 
{
	...
	public class TrainingFeeding extends BaseContent
	{
		...
		public function prisonCaptorFeedingOrgasmTrainingAccept(branchChoice:String = "choose"):void
		{
			...
			outputText("Wave after wave, you tremble and shudder before her, watching through your bleary, jizz shuttered eyes as her hands continue to pump down her shaft, delivering load after load until there is hardly " + UnitSystem.literalAnInch() + " of your body that isn't dripping with her sticky warmth. As her orgasm abates, her final voluminous salvo hits you across your neck and collarbone, generating an avalanche of cum ");
		...
		{
			clearOutput();
			outputText("(Placeholder) You let yourself go and give her an excellent BJ while masturbating furiously, and orgasm prodigiously when told to. She is quite pleased, and rewards you with an untainted meal.\n\n");
			if (prison.prisonIsRestrained())
			{
				outputText("As the door closes behind her, your restraints reappear.\n\n");
			}
		...
		{
			clearOutput();
			outputText("(Placeholder) You let yourself go and plow yourself unthinkingly onto her cock, spasming with pleasure the moment you feel your ass inflate with her seed. You then greedily lick every bit of cum from her dick, and for an encore lick the pools of cum off the floor that dripped from your ass. She is quite pleased, and rewards you with an untainted meal.\n\n");
			if (prison.prisonIsRestrained())
			{
				outputText("As the door closes behind her, your restraints reappear.\n\n");
			}
		...
		public function prisonCaptorFeedingTrainingRefuse():void
		{
			...
			if (player.will < prison.prisonWillCost(5))
			{
				...
				{
					outputText(" In fact, while a second ago you thought you had the desire to refuse, now the thought of debasing yourself for her approval is filling you with an overwhelming desire to do the exact opposite and put all your heart into doing as you gave been told.\n\n");
					prison.changeEsteem(2,prison.inPrison);
					outputText("\n\n");
					switch(player.statusEffectv1(StatusEffects.PrisonCaptorEllyStatus))
					{
			...
			else
			{
				...
				outputText("Your stomach fills with lead as you watch her look of stern disappointment harden on her face. \"<i>Apology or not, you've disobeyed me. I am glad to see that you have a desire to please me, but desire alone does not earn you the privilege of being fed. But I am not heartless -- quite to the contrary, I think you are coming to understand just how much I want to help you. And so now I'm going to help you embrace your desire to please me by showing you what happens when you do not.</i>\"\n\n");
				prison.changeEsteem(3,prison.inPrison);
		...
		public function prisonCaptorFeedingBJTrainingAccept(branchChoice:String = "choose"):void
		{
			...
			if (branchChoice == "choose")
			{
				...
				if (player.esteem < 15)
				{
					outputText("When you arrive at her feet, though, you freeze up again and find yourself dumbly staring at her boots, mind blank and unsure what to do next. Mistress Elly responds to your hesitation by sliding one foot forward a few " + UnitSystem.literalInches() + " and clearing her throat. In a confused panic you make a guess at what she wants and lean down to kiss her toe. She chuckles, hooks her toe under your chin, and guides you upwards. You shift about awkwardly, and find yourself sitting back on your ass with your legs folded on either side of you.\n\n");
				}
				else
				{
				...
				outputText(". Making use of her new handles, she begins to gently pull your [face] toward her. With meticulous care she pushes her rod into your mouth " + UnitSystem.display("a quarter of an inch", "one millimeter") + " at a time, backing off the moment even the slightest bit of discomfort shows on your face. \n\n");
		...
		public function prisonCaptorFeedingBJTrainingPerform(branchChoice:String = "choose"):void
		{
			...
			if (branchChoice == "choose")
			{
				...
				if (player.cor < 30)
				{
					...
					{
						outputText("but while you can endure the play-acting, you still hesitate, knowing every weapon in her arsenal is made to wring more out of you. You have your merits and virtues, but you tense with the knowledge of the tendency of demons to bind their victims with every " + UnitSystem.literalInch() + " they're given. You open your eyes to less of a demon, though. Small horns and human features... no eldritch organs or feeling of irrevocable taint with her every touch. There's no doubting her nature, but she's certainly a different manifestation of it, maybe even one you can handle. As if responding to your appraisal, she tilts her head and raises an inviting eyebrow: a taunt -- perhaps a challenge -- but one you're ready to meet. ");
					}
		...
		public function prisonCaptorFeedingOrgasmTraining():void
		{
			...
			if (flags[kFLAGS.PRISON_TRAINING_LEVEL] == 0)
			{
				...
				outputText("This lighthearted ease quickly dissipates upon arriving in her shadow, though. Thinking of what comes next, you find yourself once again harried by the specters of hesitation[if (corruption < 20) , pious outrage,] and self loathing. ");
				if (player.esteem < 40)
				{
		...
		public function prisonCaptorFeedingQuestTraining():void
		{
			...
			player.buttChange(32,true,true,false);
			outputText("\n\n");
			outputText("(Placeholder) Now, though, she wants you to show your devotion by completing a humiliating quest.\n\n");
