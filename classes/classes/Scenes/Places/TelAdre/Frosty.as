...
public function frostysHandsAreColdHolyShitWhyDontYouWarmTHoseMitsUp():void
{
	...
	else if (player.hasVagina() && !player.hasCock())
	{
		...
		outputText("\n\nShe moves her finger in tiny circles, sending electric waves of pleasure through your cunt. You groan and moan as you press your [clit] against her finger. She pushes back against you, forcing the erect clit slightly back into your body and then takes her finger back. The sticky syrup on your clit and her finger causes your sensitive bud to be pulled back with her finger. Every little " + UnitSystem.literalInch() + " makes you squeal and pant in a mix of pain and pleasure.");
...
public function cunnilingateFrosty():void 
{
	...
	outputText("\n\nYou pull your mouth off her sloppy cunt and look down at your work. Frosty is laying on the counter, her head hanging off on the cashier side while her legs are spread out and her cunt all horny and exposed on the customer side. You’re pushed aside by a minotaur with a " + UnitSystem.displayFootEstimateWithHyphenTextually(5) + " hard-on. He lines his flared cock head to Frosty’s now red hole, rubbing the head over the lips to get a “taste”  of what he’s about to indulge in. However, before he impales her on his meat-stick, Frosty springs back to life. She slides her body under the counter, and her hand reaches up to search for her bikini bottom.");
