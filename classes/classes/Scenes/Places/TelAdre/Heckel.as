...
private function heckelTraining():void {
	...
	if (flags[kFLAGS.TIMES_FUCKED_HECKEL_BLOWJOB] + flags[kFLAGS.TIMES_FUCKED_HECKEL_ANAL] == 0) {
		...
		outputText("She walks past you with a sway in her step and sits on a bench behind you.  With a shrug of her shoulders, she lets the towel fall down and reveal her body fully.  She doesn't seem as tall sitting down, but you'd still guess that she's a bit over " + UnitSystem.displayHeight2EstimateTextually(6) + ".  Her brown fur is mottled with black all over her body, except for a white square above and between her breasts.  Her breasts themselves are large B-cups, with black areolas surrounding pert nipples.  She leans back and spreads her legs, revealing her equipment fully.\n\n");
	
		outputText("A black cock hangs half erect between her legs, a pair of fist-sized testes underneath.  Fully erect, you estimate her dong would be around " + UnitSystem.displayInchesEstimateTextually(10) + " long; large, but fitting for her lithe body.  It grows a little stiffer as you stare down at it, and it isn't until Heckel starts cackling that you realize how long you've been staring.\n\n");
...
private function heckelOrallyFixated():void {
	...
	//Repeat
		...
		outputText("You lick your lips as you eye her swelling member. It pulses softly with her heartbeat, each jump leaving it slightly bigger than it was before. As you watch, it slowly stands to attention at around " + UnitSystem.displayInchesEstimateTextually(10) + " in length, Heckel's heavy balls drawing up beneath it. Her canine dick almost looks shiny with the skin taut like this, though it might also be the moisture from her shower. You make up your mind when you see a dribble of pre form at the tip, and you bend over to lick it up before it can drip down and escape.\n\n");
		...
		outputText("\"<i>I don't know if I told you last time,</i>\" Heckel pants above you, \"<i>but you're really good at this.</i>\" You take a strange sense of pride in that and eagerly work your throat down to the halfway point on her dick, realizing that it has grown considerably in the last few minutes. What was once " + UnitSystem.displayInchesTextually(10) + " is now closer to " + num2Text(UnitSystem.lengthInInches(13)) + ", but it's still nothing you can't handle. With practiced patience, you take more and more of her dick down your throat with every bob, keeping your hand working in counterpoint on her firm shaft.\n\n");
...
private function heckelLovesDaAnal(loss:Boolean = false):void {
	...
	outputText("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your " + player.buttDescript() + " as she lets out a low growl.");
	//[<IF TONE OVER 80>
	if (player.tone >= 80) outputText("  \"<i>Damn " + player.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"");
	//[<IF TONE BETWEEN 60-79>
	else if (player.tone >= 60) outputText("  \"<i>Mmm, not bad " + player.short + ", not perfect, but not bad.</i>\"");
	outputText("\n\n");
	...
	//[<IF PC HAS VAGOO>
	else if (player.hasVagina()) outputText("Your snatch starts to ache while moisture runs down your groin, and you groan at the lack of attention it's receiving. If Heckel notices, she doesn't react and keeps swirling her tongue around your hole. You push weakly backwards, hoping to make her drop her tongue down a few " + UnitSystem.literalInches() + ", but she instead takes this as an opportunity to bury her snout fully between your ass cheecks, her tongue slipping inside you deeper than before.\n\n");

	outputText("Even with only a few " + UnitSystem.literalInches() + " inside your ass, her tongue makes you moan almost immediately. She rolls in back and forth, then side to side, then pushes it in and out before starting the cycle over. The teasing becomes more and more unbearable until you're ready to abandon caution and begin masturbating, but just as you tense to change position she stops and pulls her tongue out suddenly.\n\n");
	//NEXT
...
private function heckelLovesAnal2():void {
	...
	outputText("You open your mouth to gasp as she slides into you, but no sounds come out. You can feel " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " penetrate you, your asshole slowly stretching to accommodate her increasing thickness. She pushes as much as she can into you before pulling back slightly, then humping lightly as she works the rest in little by little.");
	player.buttChange(28,true,true,false);
	outputText("\n\n");

	outputText("As more and more doggie dick is pushed into your ass, you find your estimations of her size more and more ridiculous. There has to be an entire " + UnitSystem.foot() + " of cock in you already, but she's still going! When she does finally bottom out, your mind reels at the impossibility. Her dick must grow the longer she stays aroused, because she's at least " + UnitSystem.displayInchesEstimate(15) + " right now! The base of her dick stretches your ass painfully open, and she gives you a moment to adjust to it.");
	player.buttChange(35,true,true,false);
	outputText("\n\n");
	
	outputText("Just as the sting begins to fade, she draws herself out to the tip in one motion. You bite your lip in anticipation, but you still moan like a whore when she slams all " + UnitSystem.displayInches(15) + " back into you. She draws back before pounding your " + player.assholeDescript() + " again, making your " + player.buttDescript() + " shake with the impact.\n\n");
...
private function dominateHeckelConclusion():void {
	...
	if (player.cumQ() > 500) {
		...
		if (player.cumQ() >= 3000) {
			...
			if (player.cumQ() >= 4000) {
				outputText(" at least ");
				if (player.cumQ() < 10000) outputText(UnitSystem.aFoot() + " deep");
