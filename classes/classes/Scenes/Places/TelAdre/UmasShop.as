package classes.Scenes.Places.TelAdre
{
	...
	public class UmasShop extends TelAdreAbstractContent
	{
		...
		public function firstVisitPart1():void
		{
			...
			outputText("Before you can think to respond to her, the beads part and a new figure emerges.  She's one of the many anthropomorphs who inhabit this city, a bipedal humanoid horse with unmistakable human features.  She's huge, easily " + UnitSystem.displayHeight2EstimateTextually(7) + " tall, certainly far bigger than the half-horse who brought you here, with full, round breasts and wide womanly hips clearly delineated by the strange dress that she wears, a rich blue with a pattern of white snowflakes on it.  She looks "); 
		...
		public function enterClinic(returnedTo:Boolean = false):void
		{
			...
			if (flags[kFLAGS.LOPPE_PC_MET_UMA] == 0) {
				...
				outputText("A bipedal humanoid horse with unmistakable human features walks over to greet you. She's huge, easily " + UnitSystem.displayHeight2EstimateTextually(7) + " tall, certainly far bigger than the half-horse who brought you here, with full, round breasts and wide womanly hips clearly delineated by the strange dress that she wears, a rich blue with a pattern of white snowflakes on it.  She looks "); 
				// Assuming Uma is ~7' tall == 84". 6" leeway for the variants or more? PAGING FENOXO!
				if (player.tallness < 78)
					outputText("down at you ");
				else if (player.tallness < 90)
	...
	public static const MAX_MASSAGE_BONUS_DURATION:int = 24;			// Duration of the bonus
		...
		public function talkSexuality():void
		{
			...
			outputText("Uma giggles before replying, \"<i>Not at all.  I find that women in general tend to care more for 'natural medicine' than men... usually when men have chronic back pain, most of them would rather drink some kind of alchemic concoction to make it better, and to be honest it does work well. But the truth is that ingesting too many alchemical ingredients might lead to even more problems later; not to mention the chemical dependency.  Since my pins are a one-time thing, and there's no dependency, I get many visits from the more health conscious populace.  And let's just face it, [name].  Women are just that much more concerned about natural medicine than men... especially when it involves a " + UnitSystem.displayHeight2EstimateWithHyphen(7) + " horse-woman poking needles in their bodies.</i>\"  Uma giggles once more.\n\n");
		...
		public function talkLoppesFirstGirlPart2():void
		{
			...
			outputText("Puff sighed.  Yep, ol' thrusty was going to see some action today.  She was about to turn and head home when a sudden gust of wind hit her right in the face with a stray piece of paper.  Struggling to remove the offending litter with a growl, she saw... it was as if Marae herself had answered her pleas.  " + capitalizeFirstLetter(UnitSystem.displayInchesTextually(14)) + " of equine deliciousness, with a pair of heavy, cum churning balls swinging under it, it was enough to make her lick her lips with a wolfish smile, and who was it attached to?  Slowly looking up - what the? - That was the young bunny girl she saw browsing the bakery earlier! The young bunny quickly used her hands to push her short robes down and hide her package, looking left and right to see if anyone had spotted her, then sighing with relief. That must have been embarrassing... But luckily someone did spot her!\n\n");
		...
		public function talkLoppesFirstBoyfriendPart2():void
		{
			...
			outputText("The rabbit-horse moans softly as it swells to all " + UnitSystem.displayInchesTextually(14) + " of mottled pink horse-dick, jutting erect and proud, defiant of its mistress.\n\n");
		...
		*/
		...
		private function sexGetABJFromDisMilfyLesboSlut():void
		{
			...
			outputText("\n\nYou ");
			if (player.lust100 >= 75) outputText("eagerly ");
			...
			outputText("\n\nIt's immediately apparent how her longer, equine-style face affords many advantages when it comes to oral pleasure.  Her capacitive mouth takes " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + ", long past when you would be normally threatening a gag-reflex, sliding you along her long, flat tongue as she goes.  Her efforts are far from expert, and you can tell that her heart isn't truly in this.  She stops her ministrations, adjusting her hair and saying, \"<i>Sorry dear.  I haven't gotten much practice at these.  They're not really my thing, normally");
