...
public class VictoriaTailorShop extends Shop {
	...
	protected override function confirmBuy(itype:ItemType = null, priceOverride:int = -1, keyItem:String = ""):void {
		...
		if (player.biggestCockArea() > 30 || player.totalCocks() > 1) {
