		...
		if (flags[kFLAGS.LOTTIE_ENCOUNTER_COUNTER] == 0) {
			...
			if (display) {
				...
				//[REPEAT INTROS]
					...
					if (flags[kFLAGS.LOTTIE_FIGURE] <= 33) outputText("voluptuous");
					else if (flags[kFLAGS.LOTTIE_FIGURE] <= 66) outputText("plump");
					...
					if (flags[kFLAGS.LOTTIE_FIGURE] <= 33) outputText("bountiful");
					else if (flags[kFLAGS.LOTTIE_FIGURE] <= 66) outputText("chubby");
					...
					if (flags[kFLAGS.LOTTIE_FIGURE] <= 33) outputText("voluminous");
					else if (flags[kFLAGS.LOTTIE_FIGURE] <= 66) outputText("chubby");
					else outputText("cute");
					outputText(" rump.");
				}
...
public function encounterLottie(charge:Boolean = false):void {
	...
	//[REPEAT ENCOUNTER]
		...
		if (flags[kFLAGS.LOTTIE_FIGURE] <= 50) outputText("plump");
		else outputText("curvy");
		outputText(" figure.  ");
		if (flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) outputText("Lightly sipping");
		else outputText("Slurping down");
		outputText(" what appears to be ");
		if (flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) outputText("some juice");
		...
		//[Second Encounter, If fucked Lottie]
			...
			outputText("\"<i>Hey, " + player.short + "! I...I really enjoyed what we did. God, if that's what it takes to get healthy I wouldn't mind! I think I'm falling in love with you already, haha!</i>\" She forces a giggle at her last sentence, albeit rather nervously. You raise an eyebrow, but decide not to push the issue further.");
		}
		...
		//[Fourth Encounter, If didn't take Lust Draft]
			...
			//[Sex][Buddies]
			menu();
			addButton(0, "Sex", fourthMeetingChooseSexWithLottie);
			addButton(1, "Buddies", stayLottieBuds4Evah);
			return;
		}
		...
		//[Encouragement moved from 79 to 80, first time]
			...
			//[Encouragement moved from 79 to 80, regular]
				...
				outputText("\"<i>Hey, " + player.short + ".Thanks for being... nicer, again. Sometimes I really worry about you, but... well; I'm fine with putting that behind us. I'm glad, y'know?</i>\" She throws you a smile, confident that you won't mistreat her again. You smile back, silently assuring her that you won't, today.");
			}
		}
		//[Normal Encounter, Encouragement 60 - 100]
		else if (flags[kFLAGS.LOTTIE_CONFIDENCE] >= 60) {
			//[Figure 0 – 20]
			if (flags[kFLAGS.LOTTIE_FIGURE] <= 20 && flags[kFLAGS.LOTTIE_LOVES_HER_BODY] == 0) outputText("\"<i>Oh, " + player.short + "! Let's do our best today, I really wanna lose those " + UnitSystem.literalPounds() + "! I know I can do my best when I'm with you!</i>\" Lottie beams, her massive tits pushed against the table. She seems to be excited for what you've got in store today.");
			...
			else if (flags[kFLAGS.LOTTIE_FIGURE] <= 40) outputText("\"<i>Hey, " + player.mf("stud","cutie") + "! You shouldn't keep me waiting; the only thing I'm losing right now is my patience!</i>\" Lottie grins and punches your arm playfully, squealing when you try to get her back. She seems to be excited for what you've got in store today.");
			//[Figure 40 - 60]
			...
			//[Figure 60 - 80]
			else if (flags[kFLAGS.LOTTIE_FIGURE] <= 80) outputText("\"<i>Yo, " + player.mf("big guy","babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
			//[Figure 80 - 100]
		...
		//[Normal Encounter, Encouragement 30 - 60]
			...
			//[Figure 0 - 20]
			if (flags[kFLAGS.LOTTIE_FIGURE] <= 20) outputText("\"<i>Oh, " + player.short + ", hey. I think we should try and get into it today. I don't think I tried hard enough last time, y'know?</i>\" Lottie leans over to grab her beverage, her massive tits pushed against the table. She seems to be intent on trying her best today.");
			//[Figure 20 - 40]
			...
			//[Figure 60 - 80]
			else outputText("\"<i>Hello " + player.short + "! I've... I've been waiting for you, so you better be ready, hey! Don't hold back!</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.");
		}
	...
	addButton(3, "Give Item", giveLottieAnItem);
	if (player.lust >= 33) {
		addButton(4, "Sex", lottieFuck);
	} else {
...
private function acceptBeingLottiesHamSandwich():void {
	...
	outputText("You take this opportunity to get a good look at Lottie. She stands at around " + UnitSystem.displayHeight2Short2(4, 8) + "</i>\", considerably shorter than average, ");
	...
	//[Water][Shake]
	menu();
	addButton(0, "Water", drinkWaterWithYourHamhock);
	addButton(1, "Shake", drinkLustWithYourHamhock);
}
...
private function gotInShapeAcceptTrainingOffer():void {
	...
	outputText("You take this opportunity to get a good look at Lottie. She stands at around " + UnitSystem.displayHeight2Short2(4, 8) + "</i>\", considerably short on average, ");
	if (player.tallness > 60) outputText("and shorter than you");
	else if (player.tallness > 53) outputText("but you can't judge, being roughly the same height");
	else outputText("taller than you");
...
public function analLottieMilkshake():void {
	...
	var x:Number = player.cockThatFits(40);
	if (x < 0) x = 0;
	outputText("You brush her grip off of " + player.oMultiCockDesc() + ", only to turn her around and fit your girth between her large cheeks");
	...
	outputText("\"<i>A-aa-ah, I-I... AHH!</i>\" Lottie oinks noisily, her eyes rolling to the back of her head and her large thighs slapping against your own, pulling your " + player.cockDescript(x) + " further in. She shudders in orgasm");
	...
	if (player.balls > 0) outputText("Your " + player.sackDescript() + " begins to swell");
...
public function getSuckedOffByAHamSandwich():void {
	...
	//[If the player has a cock between 5' – 12']
		...
		outputText("She stares intently at your " + player.cockDescript(x) + " with hunger in her eyes. A small amount of drool escapes her luscious lips as she moves forward, kissing your ");
		if (player.cockTotal() > 1) outputText(" biggest head lightly");
		else outputText(" head lightly");
		outputText(".  Her saliva leaks onto your " + player.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your shaft");
		if (player.cockTotal() > 1) outputText(", jerking off your " + player.cockDescript(player.biggestCockIndex2()) + " with both hands");
	...
	//[If the player has a cock equal to or over 13']
		...
		outputText("She gasps as you lift your " + player.cockDescript(x) + " and slap her face. \"<i>It's... wow, " + player.short + "!</i>\" You grin before poking her pudgy cheek with the tip of your ");
	...
	//[if Multi]
	if (player.cockTotal() > 1) outputText(" stops rubbing your " + player.cockDescript(x) + " to ");
	//(Otherwise)
	...
	outputText(". Lottie wraps her tits around your length and begins working at pleasuring your every " + UnitSystem.literalInch() + ".\n\n");
...
private function lotteryAppearance():void {
	...
	if (lottieTone() <= 20) {
		outputText("She stands at around " + UnitSystem.displayHeight2Short2(4, 8) + "</i>\", considerably short on average, ");
		if (player.tallness > 60) outputText("and shorter than you");
		else if (player.tallness > 53) outputText("but you can't judge, being roughly the same height");
		else outputText("taller than you");
	...
	//[If Figure between 40 - 60]
		...
		outputText("She stands at around " + UnitSystem.displayHeight2Short2(4, 8) + "</i>\", short on average, ");
		if (player.tallness > 60) outputText("and shorter than you");
		else if (player.tallness > 53) outputText("but you can't judge, being roughly the same height");
		else outputText("taller than you");
		outputText(". Physique-wise, Lottie is definitely a bit chubbier than most girls, though you couldn't call her fat - of the few pig people you have seen around Tel'Adre, she's definitely the 'thinnest'. The majority of her weight is focused in her cushiony breasts, ample thighs and large ass, though her stomach is rounded nicely to support the weight of her upper body. Her heart-shaped face is complimented by her button nose and soft lips, framed by her pink-gray hair, which ends in small curls. A small, coiled tail rests above her rump.");
...
private function talkToPigSlut():void {
	...
	if (flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] == 1) {
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", firstOralReactionChooseEncourage);
		addButton(1, "Abuse", firstOralReactionChooseAbuse);
	}
	//[If 1st Time Anal]
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", firstAnalReactionChooseEncourage)
		addButton(1, "Abuse", firstAnalReactionChooseAbuse);
	}
	//FATNESS
	//[If Gained Weight since Last Encounter, Encouragement 0 - 30]
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", lottieLowMoraleWeightGainEncourage);
		addButton(1, "Abuse", lottieLowMorealeWeightGainAbuse);
	}
	//[If Gained Weight since Last Encounter, Encouragement 30 - 70]
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", lottieMediumMoraleWeightGainEncourage);
		addButton(1, "Abuse", lottieMediumMorealeWeightGainAbuse);
	}
	//[If Gained Weight since Last Encounter, Encouragement 70 – 100, convinced 'Bigger is Better']
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", lottieHighMoraleWeightGainFATTYLOVESIT);
		addButton(1, "Abuse", lottieHighMoraleWeightGainFATTYLOVESABUSE);
	}
	//[If Gained Weight since Last Encounter, Encouragement 70 - 100]
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", lottieHighMoraleWeightGainEncourage);
		addButton(1, "Abuse", lottieHighMoraleWeightGainAbuse);
	}
	//DEFATNESS
	//[If Lost Weight since Last Encounter, Encouragement 0 - 30]
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", lottieLowMoraleWeightLossEncourage);
		addButton(1, "Abuse", lottieLowMoraleWeightLossAbuse);
	}
	//[If Lost Weight since Last Encounter, Encouragement 30 - 70]
		...
		//[Encourage][Abuse]
		menu();
		addButton(0, "Encourage", lottieMediumMoraleWeightLossEncourage);
		addButton(1, "Abuse", lottieMediumMoraleWeightLossAbuse);
	}
	//[If Lost Weight since Last Encounter, Encouragement 70 – 100, convinced 'Bigger is Better']
		...
		menu();
		addButton(0, "Encourage", lottieHighMoraleWeightLossFATTYLOVESIT);
		addButton(1, "Abuse", lottieHighMoraleWeightLossFATTYLOVESABUSE);
	}
	//[If Lost Weight since Last Encounter, Encouragement 70 - 100]
	else if (flags[kFLAGS.LOTTIE_WEIGHT_CONCLUSION] < lottieTone() - 5) {
		outputText("Her ears perk up at your eagerness to talk; she seems to be pretty excited about something. You ask her what's on her mind.  \"<i>That obvious, huh?</i>\" Lottie looks up at you and grins. \"<i>Y'see babe, since the last time we met, I've actually – I've lost weight!</i>\" She stands up, pumping her fist in the air and wiggling her plump ass. \"<i>I mean, I know it's not a big difference, but it's still a result! This is amazing!</i>\" She's clearly pleased with herself. You place a hand on her shoulder, and she beams at you. Do you encourage her, or break the bad news?\n\n");
		menu();
		addButton(0, "Encourage", lottieHighMoraleWeightLossEncourage);
		addButton(1, "Abuse", lottieHighMoraleWeightLossAbuse);
	}
	//[If Encouragement = 0, Figure = 0, first time]
		...
		menu();
		addButton(0, "To Fuck", lottieFatLoserCulminationFuckChoice);
		addButton(1, "To Humiliate", lottieFatLoserCulminationHumiliationChoice);
		if (silly()) {
			addButton(2, "To Leave", lottieFatLoserCulminationLeaveComedyChoice);
		} // silly mode - no disabled button
	}
	//[If Encouragement =100, Figure =0, first time]
		...
		menu();
		addButton(0, "Love Self", lottieHighMoraleFatLoveSelfOneTimeEvent);
		addButton(1, "StickWithIt", lottieHighMoraleFatYoullGetThereOneTimeEvent);
		if (silly()) {
			addButton(2, "EwLottieNo", ewLottieNo);
		} // silly mode - no disabled button
	}
	//[If Encouragement = 0, Figure = 100, first time]
		...
		menu();
		addButton(0, "Threesome", lottieElleThreesomeFirstTime);
		addButton(1, "Just Elle", fuckElleInsteadOfThatFatSlutFirstTime);
		if (silly()) {
			addButton(2, "Oh,IGetIt!", charlottesWebComedyBullshit);
		} // silly mode - no disabled button
	}
	...
	//[If Neither, Encouragement 70 - 100]
		...
		outputText("<b>SHIT BUGGED OUT SON.</b>");
		doNext(camp.returnToCampUseOneHour);
	}
...
private function lottieHighMoraleWeightGainAbuse():void {
	...
	outputText("Deciding you're done here, you return back to camp – strangely satisfied.");
	lottieMorale(-10);
	doNext(camp.returnToCampUseOneHour);
}
...
private function fuckElleInsteadOfThatFatSlutFirstTime():void {
	...
	if (player.cockTotal() == 1) {
		outputText("begins to caress your " + player.cockDescript(x) + " with two of her hands, while the other sets to work on ");
	...
	else outputText("uses all four of her hands to handle your " + player.multiCockDescriptLight() + ", jerking each one with ease");
...
private function lottieSuccessOneShot():void {
	...
	if (player.tone > 30 || player.thickness < 70) {
		...
		outputText("Inevitably, you can feel your release approaching, and with one final push you grab a hold of the pig-girl's tight ass, slamming against her and pumping your spunk directly into her clenched pussy, your " + player.cockDescript(x) + " twitching as ropes of cum coat her insides. Lottie yelps, collapsing on the floor and full of your hot seed. You wipe your cock along her ass cleavage, leaving her as a sweaty, cum-filled mess on the floor. Walking out, you make sure to grab a ");
		if (silly()) outputText("bacon ");
...
private function lottieExercise():void {
	...
	menu();
	addButton(0, "Weights", lottieWeights);
	addButton(1, "Jogging", goJoggingWithLottie);
	addButton(2, "Yoga", lottieYoga);
	addButton(3, "Pool", lottiePool);
}
...
private function lottieWeights():void {
	...
	if (lottieTone() <= 70) {
		...
		//[Boast][Train]
		menu();
		addButton(0, "Boast", boastAtLottie);
		addButton(1, "Train", trainWithLottie);
		if (lottieMorale() <= 30 && flags[kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] > 0 && player.str >= 75 && player.tone >= 60 && player.cumQ() >= 1000) {
			addButton(2, "NTR Lift", ifrisAndLottieGetsNTRedLiftingWeights);
		} else {
			addDisabledButton(2, "NTR Lift");
		}
	}
	//[If Figure 70 - 100]
	else {
		...
		//[Boast][Train]
		menu();
		addButton(0, "Boast", boastAtFitLottie);
		addButton(1, "Train", trainWithFitLottie);
	}
}
...
private function goJoggingWithLottie():void {
	...
	if (lottieTone() <= 70) {
		...
		//[Sprint][Jog]
		menu();
		addButton(0, "Sprint", sprintAndLeaveLottieBehind);
		addButton(1, "Jog", jogWithLottie);
	}
	//[If Figure 70 - 100]
	else {
		...
		//[Sprint][Run]
		menu();
		addButton(0, "Sprint", sprintAndLeaveFitLottieBehind);
		addButton(1, "Jog", jogWithFitLottie);
	}
}
//[Sprint]
...
private function lottieYoga():void {
	...
	//[Alone] [Together]
	menu();
	addButton(0, "Alone", lottieYogaAlone);
	addButton(1, "Together", togetherLottieYoga);
}
...
private function lottieYogaAlone():void {
	spriteSelect(SpriteDb.s_lottie);
	clearOutput();
	outputText("Taking your mat, you walk over towards the four-armed yoga trainer, sitting down only " + UnitSystem.aFewFeet() + " away from her tanned, muscular body. In the corner of your eye, you can see Lottie visibly disheartened as she watches you gazing at the fit, caramel-colored woman in front of you. As you take your position, the intense smell of coffee and desert flowers hits you as the instructor lays on her back and pulls both of her legs up, giving you a clear view of her large thighs and puffy mound. You swear you can see her smiling as the other surrounding members begin to imitate her position. Not wanting to disappoint, you lie on your rear and tilt your head backwards, confronted by another pair of legs lifted into the air. You can see Lottie attempting the same position, only to lean to her right and fall over, earning an annoyed stare from the person next to her.\n\n");
...
private function lottiePool():void {
	...
	//[Jump][Wait]
	menu();
	addButton(0, "Jump", jumpInPoolBeforeLottieSeesYourWingWang);
	addButton(1, "Wait", waitAndShowLottieYourPoolBoner);
}
...
private function waitAndShowLottieYourPoolBoner():void {
	spriteSelect(SpriteDb.s_lottie);
	clearOutput();
	outputText("You figure it can't do much harm to let " + player.sMultiCockDesc() + " fly, so you decide to leave it be, even leaning back so as to accentuate the hardening length. It doesn't take long for Lottie to notice, letting out a little gasp as she observes your ");
...
public function giveLottieAnItem():void {
	...
	clearOutput();
	menu();
	addDisabledButton(0, "Cafe");
	if (player.hasItem(consumables.LABOVA_)) {
		addButton(1, "LaBova", feedLottieLaBova);
	} else {
		addDisabledButton(1, "LaBova");
	}
	if (player.hasItem(consumables.GROPLUS) && flags[kFLAGS.FACTORY_SHUTDOWN] > 0) {
		addButton(2, "Gro Plus", giveLottieGroPlus);
	} else {
		addDisabledButton(2, "Gro Plus");
	}
	if (player.hasItem(consumables.REDUCTO)) {
		addButton(3, "Reducto", giveLottieReducto);
	} else {
		addDisabledButton(3, "Reducto");
	}
	addButton(14, "Back", encounterLottie);
	...
	//[Give Item – Repeat Encounter]
		...
		addButton(0, "Cafe", feedLottieAWholeCafe);
		if (silly()) {
			addButton(4, "HamSandwich", hamSammitchTimeBIATCH);
		} // silly mode scene - no disabled button
	}
}
//[If Cafe]
...
public function lottieFuck():void {
	...
	if (lottieMorale() <= 40) {
		...
		if (player.countCocksOfType(CockTypesEnum.TENTACLE) > 0 && flags[kFLAGS.LOTTIE_NEEDS_TO_TALK_ORAL] == 2) {
			addButton(2, "Tentacle", tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK);
		} else {
			addDisabledButton(2, "Tentacle");
		}
		if (flags[kFLAGS.LOTTIE_DOGGYSTYLE_UNLOCKED] > 0)  {
			addButton(5, "Doggystyle", lottieRepeatDoggieStyle);
		} else {
			addDisabledButton(5, "Doggystyle");
		}
		if (flags[kFLAGS.LOTTIE_WALKIE_UNLOCKED] > 0) {
			addButton(6, "Walkies", lottieRepeatWalkies);
		} else {
			addDisabledButton(6, "Walkies");
		}
		if (flags[kFLAGS.LOTTIE_THREESOME_UNLOCKED] > 0) {
			addButton(7, "Threesome", lottieRepeatThreesome);
		} else {
			addDisabledButton(7, "Threesome");
		}
		if (flags[kFLAGS.LOTTIE_ELLE_NTR_UNLOCKED] > 0) {
			addButton(8, "Netorare", lottieRepeatSUPERNEATORARES);
		} else {
			addDisabledButton(8, "Netorare");
		}
		if (silly() && player.hasCock()) {
			addButton(9, "30Minute", lottiesThirtyMinutePigGasm);
		} // silly mode scene - no disabled button
	}
	//[If Encouragement 30 – 60]
		...
		if (player.cockTotal() > 1) outputText("s");
		outputText(". \"<i>I... oh.</i>\" Taking Lottie's hand, you quickly lead her out of the cafe and into the pool area, looking for an empty sauna to sneak into. Considering that the gym's pool is only used by a few semi-aquatic humanoids and the odd ");
		...
		if (silly() && player.hasCock()) {
			addButton(3, "30Minute", lottiesThirtyMinutePigGasm);
		} // silly mode scene - no disabled button
	}
	//[If Encouragement 60 – 100]
		...
		if (flags[kFLAGS.LOTTIE_QUICKIE_UNLOCKED] > 0 ) {
			addButton(3, "Quickie", lottieRepeatQuickie);
		} else {
			addDisabledButton(3, "Quickie");
		}
		if (flags[kFLAGS.LOTTIE_COWGIRL_UNLOCKED] > 0) {
			addButton(4, "Cowgirl", lottieRepeatCowGirl);
		} else {
			addDisabledButton(4, "Cowgirl");
		}
		if (flags[kFLAGS.LOTTIE_REVERSE_COWGIRL_UNLOCKED] > 0) {
			addButton(5, "R.Cowgirl", lottieRepeatBackwardsAssCowgirl);
		} else {
			addDisabledButton(5, "R.Cowgirl");
		}
		if (flags[kFLAGS.LOTTIE_FEMDOM_UNLOCKED] > 0) {
			addButton(6, "Femdom", lottieRepeatFEMDOMFEMFDOM);
		} else {
			addDisabledButton(6, "Femdom");
		}
		if (silly() && player.hasCock()) {
			addButton(7, "30Minute", lottiesThirtyMinutePigGasm);
		} // silly mode scene - no disabled button
	}
	dynStats("lus", 50);
}
...
public function lottieRepeatSUPERNEATORARES():void {
	...
	if (player.cockTotal() == 1) {
		outputText("begins to caress your " + player.cockDescript(x) + " with two of her hands, while the other sets to work on massaging your ");
		if (player.balls > 0) outputText("balls");
		else if (player.hasVagina()) outputText("pussy");
		else outputText("ass");
	}
	else  outputText("uses all four of her hands to handle " + player.sMultiCockDesc() + ", jerking each one with ease");
	...
	outputText("  Elle follows suit, groaning in pleasure as she reaches her own peak, her hole tightening around your length and trapping the rest of your spunk inside. The spinnerets upon her shoulder pulse in orgasm, spurting sticky globs of what appears to be thread up into the air and back down onto the pig, spunk pooling around her cleavage. You both relax, letting the spider-girl down off of you to collapse on the floor. You bend down, looking at Lottie before shoving your " + player.cockDescript(x) + " inside of her and letting one final spurt of your seed fill her up. \"<i>Satisfactory.</i>\" You mumble, redressing and heading out the door, making sure to grab a ");
	if (silly()) outputText("bacon ");
	outputText("shake on the way out.");
	if (silly()) outputText("  You only need one of those to satisfy you.");
	player.orgasm('Dick');
...
public function lottieRepeatFEMDOMFEMFDOM():void {
	...
	outputText("\n\nYou wake up dazed, your forehead throbbing – you're also completely naked, but unharmed otherwise. When you try to move, however, you find yourself unable to shift from your position – you seem to be tied to a chair, your hands behind your back while your legs are bound to those of the seat. You observe your surroundings, noticing the recognizable brick walls and stocked shelves of the gym's equipment shed. The familiarity of the location leaves you somewhat relieved – at least you know where you are.");
	outputText("\n\nA quick slap to the face brings your attention to the lean pig-girl in front of you. Her figure is somewhat obscured by the lack of sunlight inside the room, though you can tell she's mostly nude, other than a small black g-string obscuring her nether regions. She also appears to be sporting black thigh-high boots, along with similarly colored gloves that reach her arm pits. Her expression is one of immense desire, smiling wryly as she examines your form. \"<i>You've gotten bigger.</i>\" She smiles, leaning on top of you and letting her heavy breasts smother your face. You take a lick at one of her nipples before she jerks back and hits you again. \"<i>Hahaha, not today, pig. All this extra weight is because you can't keep your mouth closed.</i>\" She spits, grabbing at the soft flesh of your ");
	if (player.biggestTitSize() >= 2) outputText("tits");
	else outputText("belly");
	outputText(" and squeezing, as if she was playing with putty. \"<i>I've reached my goal, but it seems you need a bit of help reaching yours. If you don't mind, I think I'll be your personal trainer for today.</i>\" The horny pig-slut grabs a hold of your " + player.cockDescript(x) + ", keeping a firm grip on your member as she effortlessly jerks you off. \"<i>I think I'll release all of that thick, sticky spunk you've got hidden inside of your fat cock.</i>\"");
	outputText("\n\nThe velvet of her gloved hands sends small bouts of pleasure through your body, her technique clumsy but efficient. Lottie begins playing with her juicy nipples, twisting and rubbing them while she toys with your length. You shudder, looking down to find her mouth only " + UnitSystem.literalInches() + " away from your " + player.cockDescript(x) + ", her hot breath surrounding your tip. She takes one lick of your cockhead, and already you feel a tingling sensation as you start to orgasm – did she take something to cause this? Regardless, you pump mindlessly through her hands, looking for release, when Lottie grabs hard at your cock, plugging your cum and causing you to grunt in denial.\n\n");
...
public function tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK():void {
	...
	if (player.countCocksOfType(CockTypesEnum.TENTACLE) > 1) outputText("first ");
	...
	if (y >= 0) {
		...
		else outputText("as many " + UnitSystem.literalInches() + " of your " + player.cockDescript(y));
				...
				if (zzz >= 0) {
					...
					if (zzzz >= 0) {
						...
						if (zzzzz >= 0) {
							...
							if (zzzzzz >= 0) outputText("  Seeing the effect your junk had on her, you move your " + player.cockDescript(zzzzzz) + " to her remaining hand and she grips it likewise.");
