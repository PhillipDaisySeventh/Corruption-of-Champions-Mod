...
public function repeatChooseShower():void {
	...
	if (getGame().time.hours < 16 || getGame().time.hours > 18 || player.tone < 30) {
...
public function talkWithBrookeAboutWorkingOut():void {
	...
	outputText("\n\nShe turns her face to the showerhead while she explains.  <i>\"First, nothing involving hands.  Dumbbells, barbells, bench-presses, squats, deadlifts – all out, even with a spotter.  If it weighs more than just a few " + UnitSystem.literalPounds() + " or so, I can't lift it with one hand.  Working biceps and forearms was a bit of a hurdle, but with some experimentation, I found a way around my... 'condition.'");
	...
	if (brookeAffection() <= 39) outputText("\n\nSharing a shower with a naked girl just " + UnitSystem.aFewFeet() + " away is an unusual experience.  Of course, though, you're certainly not complaining – Brooke's an interesting girl, and she takes very good care of herself physically.  You enjoy her company.");
...
public function talkToBrookeAboutGymFolks():void {
	...
	//[if {Brooke's Affection <= 39}]
	if (brookeAffection() <= 39) outputText("\n\nSharing a shower with a naked girl just " + UnitSystem.aFewFeet() + " away is a little unusual.  Of course, though, you're certainly not complaining – Brooke's an interesting girl, and she takes very good care of herself physically.  You enjoy her company.");
...
public function gropeDatBrooke():void {
	...
	//[if (hasCock = true)]
	if (player.hasCock()) outputText("  You can only imagine what it could feel like to drive your [cock] between those cheeks, just " + UnitSystem.literalInches() + " away from you.  The thought makes [eachCock] rouse.");
...
public function goDownOnBrooke():void {
	...
	outputText("  You tease her entrance by barely slipping your finger in, just " + UnitSystem.literalAnInch() + " or so; she responds by tensing when you enter and groaning when you leave.  Your other hand lowers, dropping to her stomach and kneading at her muscles there instead, knowing how much she loves it when her 'hard work' gets appreciated.");
	...
	outputText("\n\nYour tongue has had enough of a break.  It darts forward, splitting into her quickly, and you're suddenly assaulted with her taste, coating every " + UnitSystem.literalInch() + " and nuance of your tongue.  Her pussy clenches on your invading muscle, imprinting itself and its taste on your tongue, while Brooke gasps above you and her fingers tighten on your scalp.  It takes some effort to free yourself from her cunt, but you manage.");
...
public function doubleDicked():void {
	...
	outputText(" and for every " + UnitSystem.literalInch() + " her ass takes, another simultaneously slides into her pussy, stuffing her fuller than she's ever felt.");
...
public function submitHeckelXBrookeThreesome():void {
	...
	outputText("\n\n<i>\"Take off her shorts for me, [name].  Slowly.\"</i>  You do so, gripping onto the hem of Brooke's shorts and slowly pulling them down from her waist.  The juices from her puffed cunt drip down with the cloth, and immediately the heady smell of her arousal assaults your nostrils.  Heckel takes a long drag of the smell herself, even from where she's sitting.  <i>\"That's what I like,\"</i> she says lowly, and you can see Heckel's cock bulge even longer and thicker, with the pole reaching a good " + UnitSystem.footAndAHalf() + " and the knot billowing to the size of a melon.  <i>\"On all fours, bitch,\"</i> she commands, pointing to the floor, <i>\"and [name], you sit on the bench.\"</i>");
...
public function brookeVHeckelBrookeWins2():void {
	...
	outputText("\n\nThe familiar smell of her musk, amplified now that she hasn't had a chance to shower, draws you in, and before you really realize it, you've taken her dick into your mouth and you've gone about " + UnitSystem.displayInchesEstimateTextually(4) + " down her " + UnitSystem.displayInchesTextually(10) + " already.  You take it slowly, sucking in only a little bit at a time, and you keep your tongue still – you don't want to overstimulate her too quickly.");
	...
	if (x >= 0) {
		...
		outputText("\n\nWell, whatever the case,\"</i> she says, draping her legs around Heckel's waist, straddling her, keeping the head of her dog dick just lightly scratching against her eager entrance.  <i>\"You're getting Brooke.  Every " + UnitSystem.literalInch() + ", every little bit, of her.\"</i>  She leans in close, their noses touching, their lips just " + UnitSystem.literalInches() + " apart.  <i>\"But you're getting every " + UnitSystem.literalInch() + " of [name], too, you bottom bitch.\"</i>  Deviously, she flutters her eyes to yours, grinning.  <i>\"Fuck her hard.\"</i>  With that, you thrust forward, driving your " + player.cockDescript(x) + " into Heckel's tight hot tunnel while Brooke simultaneously slams down, shoving every " + UnitSystem.literalInch() + " of Heckel's cock before her knot into her pussy.");
		...
		if (player.hasKnot(x)) outputText("  Likewise with Brooke, you pound your knot against Heckel's quim again and again, refusing to be denied entry, and with your orgasm, her pussy relents, taking in every " + UnitSystem.literalInch() + " of your " + player.cockDescript(x) + " with you.");
	...
	//{Females only}
		...
		outputText("\n\nWell, whatever the case,\"</i> she says, dragging her tongue over Heckel's nipple once, eliciting a sharp whine.  Brooke lowers her hips just a little, just touching the lips of her vagina on Heckel's hard meat.  <i>\"You're getting Brooke.  Every " + UnitSystem.literalInch() + ", every little bit of her.\"</i>  She sits back up, smiling deviously down at her submissive conquest.  <i>\"But you're getting every " + UnitSystem.literalInch() + " of [name], too, you bottom bitch.  You've got a tongue – you damn well better put it to some use.\"</i>  At that, Brooke slams down, shoving every " + UnitSystem.literalInch() + " of Heckel's cock before her knot into her pussy, and you take that as your cue to do the same to her face, pressing your [vagina] onto her waiting lips.");
