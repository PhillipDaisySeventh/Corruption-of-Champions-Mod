package classes.Scenes.Places.TelAdre 
{
	...
	public class PabloScene extends TelAdreAbstractContent
	{
		...
		public function pabloSecret():void {
			...
			outputText("\n\nBetween his legs is a generous human cock, at least for someone of his stature. You estimate it to be about " + UnitSystem.displayInchesEstimateTextually(6) + " in length and " + UnitSystem.display("one and a half inches", UnitSystem.displayInchesEstimateTextually(1.5)) + " in width. His balls, the average, each about " + UnitSystem.anInch() + " across. He turns to the stall, giving you a full glimpse of his backside as he flaps his wings, lifting himself in the air to grab his towel which hung over the door. You can now see the small slit which would otherwise be hidden by his balls. He’s a herm!");
