...
private function fellatrixSexWarmup():void {
	...
	//(If breasts)
	if (player.biggestTitSize() >= 1) outputText("They briefly run down to the top of your " + player.breastDescript(0) + " before returning to your collar.  ");
	//First time
...
private function acceptFellatrixOral():void {
	...
	//[If \"<i>Yes</i>\" and penis small enough to suck]
		...
		//Human/fallback wang
			...
			//[Follow-up Sex, player has penis]
				...
				outputText("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck your " + player.cockDescript(x) + ". She removes the bottom of your " + player.armorName + " and kneels in front of you. Taking your " + player.cockDescript(x) + " into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. \"<i>Mmm, give me all your cum,</i>\" she purrs, giving the top of your " + player.cockDescript(x) + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every " + UnitSystem.literalInch() + " of your " + player.cockDescript(x) + " before engulfing the sweaty meat.\n\n");
				outputText("She forces your legs open and holds your hands at your side so that she can have free reign over your thrust-out shaft, hardly submissive even as she takes you in her mouth. Her lips twist from side to side as she pushes your head into every bit of her mouth, bulging out her cheeks and rubbing the roof of her mouth. Spit drips down your " + player.cockDescript(x) + ", and deep satisfied gulping noises arise from between your legs. Every " + UnitSystem.literalInch() + " of her mouth is warm and soft, but her plump lips close around you like a seal, letting you know that you can only leave her mouth when she is ready. The friction is electric, and you drool pre-cum into her mouth. All of it is slurped down into her waiting throat, and soon your prick follows as she begins to deepthroat you.\n\n");
	...
	//[If \"<i>Yes</i>\" and penis too big to suck]
		...
		if (flags[kFLAGS.DOMINIKA_SUCKED_OFF_SMALL_COCKS] == 0) {
			...
			outputText("Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck on your " + player.cockDescript(x) + ". She removes the bottom of your " + player.armorName + " and kneels in front of you. Taking your " + player.cockDescript(x) + " into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. \"<i>Mmm, give me all your cum,</i>\" she purrs, giving the top of your " + player.cockDescript(x) + " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every " + UnitSystem.literalInch() + " of your " + player.cockDescript(x) + " before messily pressing to the top in a wide O.\n\n");
...
private function dominikaBlowjobs2():void {
	...
	if (flags[kFLAGS.DOMINIKA_SPECIAL_FOLLOWUP] == 1 || flags[kFLAGS.DOMINIKA_SPECIAL_FOLLOWUP] == 4) outputText("At the same time, you get the sense that perhaps it's for the best you did so.");
