...
public function birfSandTarps():void {
	spriteSelect(SpriteDb.s_sandtrap);
	outputText(images.showImage("birth-sandtrap"));
...
private function useSandTarpsHands():void {
	...
	if (player.gender == 1) {
		...
		outputText(images.showImage("sandtrap-desert-male-win-get-hj"));
		...
		//Cock 6-16 inches: 
			...
			//Balls:
			else outputText("\n\nThe sandtrap glides its hand up and down your " + player.cockDescript(0) + ", picking up a warm smooth rhythm as it gently cups your [balls] with its free hand.]  It slows down intermittently to move its palm around your length, letting every " + UnitSystem.literalInch() + " of your dick feel the tips of its delicate fingers.");
		}
		//Cock more than 16 inches:
		else outputText("\n\nThe sandtrap quickly comes to the realisation it needs both hands for this.  Still cupping your behind, it moves one oily hand up the top end of your massive shaft, while the other works the other half.  You sigh with deep satisfaction, enjoying the all-too-rare sensation of having every " + UnitSystem.literalInch() + " of your " + player.cockDescript(0) + " immersed in pleasure.  The creature screws its face up and looks away in distaste at the size of your straining dick, which is in danger of poking it in the nose.  As you enjoy the warm, slippery sensation inundating you, you find you couldn't care less what it thinks.");
		//number of cock fork
		//One cock: 
	...
	//Female: 
		...
		outputText(images.showImage("sandtrap-desert-female-win-get-fingering"));
	...
	//Herm: 
		...
		outputText(images.showImage("sandtrap-desert-herm-win-get-hj"));
		...
		//Cock 6-16 inches: 
			...
			if (player.balls == 0) outputText("\n\nThe sandtrap glides its hand up and down your " + player.cockDescript(0) + ", picking up a warm smooth rhythm.");
			else outputText("\n\nThe sandtrap glides its hand up and down your " + player.cockDescript(0) + ", picking up a warm smooth rhythm as it gently cups your [balls] with its free hand.]  It slows down intermittently to move its fingers around your length, letting every " + UnitSystem.literalInch() + " of your dick feel the tips of its delicate fingers.");
		}
		else {
			outputText("\n\nThe sandtrap quickly comes to the realisation it needs both hands for this.  Still cupping your behind, it moves one oily hand up the top end of your massive shaft, whilst the other works the other half.  You sigh with deep satisfaction, enjoying the all-too-rare sensation of having every " + UnitSystem.literalInch() + " of your " + player.cockDescript(0) + " immersed in pleasure.  The creature screws its face up and looks away in distaste at the size of your straining dick, which is in danger of poking it in the nose.  As you enjoy the warm, slippery sensation inundating you, you find you couldn't care less what it thinks.");
		}
		//One cock: 
		if (player.cockTotal() == 1) {
...
private function rideDatSandTarpLikeIts1999():void {
	...
	outputText(images.showImage("sandtrap-win"));
...
private function stickWangInSandgina():void {
	...
	outputText(images.showImage("sandtrap-desert-male-win-vag-sex"));
...
private function nagaThreesomeWithSandTrap():void {
	...
	//Male/Herm: 
	if (player.hasCock()) {
		outputText(images.showImage("sandtrap-desert-male-win-naga-3some"));
	...
	//Female: 
		...
		outputText(images.showImage("sandtrap-desert-female-win-naga-3some"));
...
private function sandTrapBadEndFinale():void {
	spriteSelect(SpriteDb.s_sandtrap);
	outputText(images.showImage("sandtrap-desert-badend"));
	...
	outputText("\n\nHis expression only changes when his cloven hoof sinks " + UnitSystem.displayInchesEstimateTextually(10) + " into the sand, and he lets out a deliciously despairing wail as the desert floor collapses all around him and drags him down into the waiting arms of a Sandtrap.  The androgyne smiles up at you perched upon the lip of its nest as it pushes the incubus down into the sandy mire, and you feel incredible euphoria.  Approval soaks into you from the sky above and the mere fact that you have fulfilled your purpose, that the dominant caste are pleased with you, has you kneeling upon the sand, stroking your [nipple]");
