...
internal function oasisSexing():void {
	...
	if (player.cocks.length > 0) {
		...
		outputText("your " + player.multiCockDescriptLight() + " and begin to slide up and down before another demon pushes them out of the way and you ");
		if (player.cocks[0].cockLength > 25) outputText("feel your " + player.cockDescript(0) + " slide into a hell-girl's sloppy cunt. The demoness moans and pants in pleasure as your " + player.cockDescript(0) + " bottoms out in her gaping pussy and she begins to ride you like the motionless whore you momentarily are, her gigantic breasts threatening to concuss you as she slides the huge distance up and down your cock in her thirst to fill her cavelike cunt.  ");
			...
			outputText("see a smaller and younger demon lowering her very tight pussy onto your " + player.cockDescript(0) + ". It's a tight fit, but her almost-virginal pussy is dripping wet. She bottoms her pussy out ");
			if (player.cocks[0].cockLength > 17) outputText("with hardly any of you inside her ");
			else if (player.cocks[0].cockLength > 12) outputText("about halfway down your " + player.cockDescript(0) + " ");
			else if (player.cocks[0].cockLength > 6) outputText("with almost all of you inside of her ");
			else if (player.cocks[0].cockLength <= 6) outputText("as her pussy lips touch the base of your " + player.cockDescript(0) + " ");
			...
			if (player.cocks[0].cockLength > 6) {
				outputText("The realisation that her pussy is slowly stretching over your " + player.cockDescript(0) + " gives you a thrill that can only be described as positively evil.  ");
				dynStats("cor", 1);
			}
			outputText("Soon the slender cock-whore begins to cum and she starts on what is about to be the first of several shuddering orgasms. You smile evilly as she cums around your " + player.cockDescript(0) + " and when her eyes roll back to the front of her head you know that there is more to come.  ");
		}
		//Orgasmzzzzzzz
		...
		if (player.cocks.length > 1) {
			...
			if (player.cocks.length == 2) outputText(player.cockDescript(1) + " is");
	...
	if (player.vaginas.length > 0) outputText("You feel the cocks in your ass and pussy rubbing into each other as your lower body becomes a temple of friction. The feeling of so much demon stuffing you as full as possible is almost unbearable, and you are " + UnitSystem.literalInches() + " away from blacking out as you come again.  ");
