package classes.Scenes.Areas.Lake {
	...
	public function execEncounter():void {
			...
			//Repeats
				...
				outputText(images.showImage("callu-repeat"));
		...
		private function ottergirlLikesDongs():void {
			...
			outputText("\n\nLikewise, her tongue and lips dance over your " + player.cockDescript(x) + " like a trio of dancers. They spin, twist, hop and tease, ensuring that no " + UnitSystem.literalInch() + " is left untouched.");
			...
			outputText("\n\nIt doesn't have to suffer long, at least, as Callu casts a new line and positions herself over your cock once more. " + capitalizeFirstLetter(UnitSystem.literalInch()) + " by delicious " + UnitSystem.literalInch() + " sinks into her, making you shiver all over.  However, this time she doesn't sit all the way down.  Instead she straddles your waist, standing on the balls of her feet.  The now-familiar pulsing returns, but in addition she gyrates her hips, circling them around and around.  With each rotation it feels as though your cock is being squeezed tighter and tighter, but this time you can't simply relax and close your eyes, not with that captivating bubble butt swaying in front of your face.");
		...
		private function ottersForGals():void {
			...
			outputText("\n\nLikewise, her tongue and lips dance across your flesh like a trio of dancers.  They twirl, spin, hop and tease.  Not one " + UnitSystem.literalInch() + " is left untouched.  From your ");
		...
		private function avoidZeOtterPussy():void {
			clearOutput();
			outputText(images.showImage("callu-avoid"));
		...
		private function gainFishFillet():void {
			clearOutput();
			outputText(images.showImage("item-fishFillet"));
