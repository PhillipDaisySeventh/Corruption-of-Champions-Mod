		...
		public function zealotLossRape():void
		{
			...
			if (broseph == "dude") {
				...
				if (player.cockTotal() > 0) {
					outputText(player.multiCockDescriptLight() + ".  You feel yourself grow hard ");
					if (player.hasVagina()) {
						outputText("and wet ");
					}
				...
				if (player.cockTotal() > 0) {
					outputText(", and your " + player.multiCockDescriptLight() + " start");
			...
			if (broseph == "dude") {
				...
				if (player.gender != 0) {
					...
					if (player.hasVagina()) outputText("You slip one of your fingers inside your " + player.vaginaDescript(0) + ", wishing that it could get some attention, but this lesson is about pleasing <i>men</i>.  ");
					...
					if (player.totalCocks() == 1) {
						outputText("You piston your hands on your " + player.cockDescript(0) + ", ");
					}
					//nope two
					else if (player.totalCocks() == 2) {
						outputText("With one hand on each of your " + player.multiCockDescriptLight() + ", you piston them like mad, ");
					}
					//oh no, is more than that
					else {
						outputText("Rapidly moving your hands between each rod in your " + player.multiCockDescriptLight() + ", you manage to piston each of them at an incredible rate, ");
					}
				...
				if (player.gender != 0) {
					...
					outputText("You take a hold of his nicely sized balls in one hand and the base of his cock in the other.  You give the tip a few licks before running your tongue down its length,  making sure to coat every bit of it in your saliva along the way.  His aroused groans let you know that you are giving a good demonstration.  You give his balls a soft rub as you stick the end inside your mouth and run your tongue around it; the taste of his pre is almost like candy to you.\n\n");
					//cunalinguss
					outputText("You stand up and indicate that it is now his turn, and while he is disappointed that the blowjob ended before he came, he still eagerly kneels down in front of your " + player.vaginaDescript(0) + ".  You gingerly lift up your skirt ");
					if (player.balls > 0) {
						outputText("and move your " + player.ballsDescriptLight() + " out of the way ");
					}
					outputText("so he has access to your " + player.vaginaDescript(0) + ".  He sets to work, and you give him careful instructions on where to lick, how hard, and such.  He easily catches on, and soon he is probing all the right places, and giving the right amount of attention to every part of you.  ");
					if (player.cockTotal() > 0) {
						outputText("You give your " + player.multiCockDescriptLight() + " a few gentle strokes, wishing he would give that a little attention too, but this is a lesson on how to please a <i>woman</i>.  ");
					}
					outputText("You feel yourself getting close to the edge and tell him to stop.  He looks up at you uncertain for a moment, and you tell him \"<i>It's time for the main event.</i>\"\n\n");
					//prick in the twat
					...
					if (player.cockTotal() > 0) {
						outputText("Your " + player.multiCockDescriptLight() + " spasms and covers you with a liberal amount of your own fluids.  ");
					}
			...
			if (player.armor == armors.C_CLOTH) {
				outputText("\n\nYou notice that you still have the " + player.armorName + " from the fantasy that your mind was trapped in, with no sign of your original clothes.");
			}
			//If armour is not replaced
			else {
				outputText("\n\nYou find that your " + player.armorName + " are back to normal, and there is no sign of the strange clothes you were wearing before.");
			}
