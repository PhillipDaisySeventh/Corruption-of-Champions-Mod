...
package classes.Scenes.Areas.GlacialRift 
{
	...
	public class YetiScene extends BaseContent
	{
		...
		private function fuckYetiInTheAss():void {
			...
			outputText("The yeti strokes his giant red prick as you fuck him, guttural moans escaping his maw as he lays still and lets you dominate his rear. Your hands grip his furred hips, clenching down tight as you pick up the pace. \n\n");
			if (player.biggestCockArea() >= 20) outputText("You shove as much into the beast as you can, taking what warmth you can get and moving one hand from the yeti’s hips to stroke along the " + UnitSystem.literalInches() + " of your length that simply won’t fit. \n\n");
