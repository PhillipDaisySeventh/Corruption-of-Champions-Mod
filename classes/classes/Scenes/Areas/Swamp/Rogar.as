...
public function encounterRogarSwamp():void {
	...
	if (flags[kFLAGS.ROGAR_PHASE] == 0) {
		...
		//((Corruption 70 or more))
			...
			if (player.isNaga() || player.tail.type > Tail.NONE) outputText("  Your tail flicks about happily.");
		...
		if (player.biggestTitSize() >= 2 && player.lib >= 50) {
			...
			if (player.inte <= 30) {
				...
				if (player.hasVagina()) outputText("  When you witnessed him make that other beast submit with strength alone it created a demanding need in your " + player.vaginaDescript() + " during the match, and the memory is doing much the same now.");
				//((if player has cock(s))
				if (player.hasCock()) outputText("  You feel " + player.sMultiCockDesc() + " shift as you remember how hard you got from behind the tree, finding yourself absent mindedly stroking yourself with an open palm as pre-cum soaks through your clothing.");
...
private function waitForChunkyOrcLoe():void {
	...
	if (flags[kFLAGS.ROGAR_PHASE] == 0) {
		...
		//((If libido is 50 or more))
			...
			if (player.hasVagina()) {
				outputText("  Your " + player.vaginaDescript(0) + " starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your " + player.nippleDescript(0) + "s becoming stiff under his rubbing.");
				outputText("  Even your " + player.feet() + " and fingers curl as you smell the sweat and musk of Ro'gar's closeness, the animalistic scent arousing you.");
			}
			else if (player.hasCock()) outputText("  " + player.SMultiCockDesc() + " stirs to life, making it obvious how much you are enjoying the rub down, then begins to drool with lust.  Through lidded eyes you faintly make out Ro'gar's toothy smirk becoming a hungry grin.");
...
private function okayBroLetsHaveAGayCarwash():void {
	...
	outputText("You set the towel down with Ro'gar's clean, slick body in front of you.  As you watch the droplets of water travel over his sculpted body, you lean your head down to get a better look.  Up close, his pores can be seen secreting an oil-like liquid over his skin.  Licking your lips, you give his green skin a perfunctory kiss.  His musk is strong, only serving to excite you further as your tongue glides over his flesh, tasting the pheromone-laden oil.  Your eyes widen as the heat hits your mouth, making you pant; you feel your skin tingle and your hair stand on end.  Soon, it hits your loins and you can feel yourself growing painfully aroused" + (player.armorDescript() != "gear" ? " beneath your clothes" : "") + ".  Ro'gar gives you a knowing grin.  \"<i>Go on, there's plenty more where that came from.</i>\"  Arching his back to brush his stomach more over your " + player.faceDescript() + ", the slime clings to your skin and causes it to flush with heat.  You let out a moan, feeling its effect and uncontrollably shuddering at the increased sensations across your body.  All of this stirs a hunger deep inside as you lean over to lick your tongue over his abs, coaxing low groans from the orc above.  Your lips caress and kiss over his slick skin, your tongue tracing each twitching muscle.  You know no boundary, tongue digging between each hard bulge.  Your hands reach over to press against his skin, feeling the heat under your fingertips as you rub his built body.  Saliva gleams across his skin in the trails your tongue leaves behind, sliding along his core and toward his pecs.  You lick with hunger between his flexing breasts, hands cupping each one as you massage them under your fingers.  Ro'gar urges you on with deep, guttural moans as you kiss along each twitching mound of muscle.  You suckle and lick over his nipple, causing it to stiffen under your attention.  \"<i>F-fuck yeah. Make it shine, filthy bitch,</i>\" Ro'gar growls as you glance over to notice the swelling bulge in his shorts.  You alternate between lapping at one nipple and flicking and pinching the other with your fingers, driving the orc under you wild.  Looking up at his lust-ridden face makes you smirk.  Spying his exposed arms and pits thrills you further, and you crawl over to dip your face into his armpit and begin to lick around.  Ro'gar gives a surprised gasp, and soon his lips curl into a wicked grin. \"<i>Nasty piggy, give my sweaty pit a big ol' tongue bath.</i>\"  Each breath is a moan into his pit, your mouth and tongue tending to Ro'gar's body dutifully, licking off all of the salty sweat and slime you can find.  Ro'gar's hands slide from behind his head and grip onto the back of yours, nestling into your " + player.hairDescript() + ".\n\n");
 
	outputText("\"<i>Ya missed a spot.</i>\"  He shoves your head down to rub your " + player.faceDescript() + " over his groin, his tented shorts pressed against your cheek as you moan and lick over the bulge.  Every lick brings another needy groan from Ro'gar, until finally his patience wears thin.  \"<i>Time to get you dirty, pig.</i>\"  He snarls as his free hand yanks down his shorts, kicking them off and exposing himself.  His massive green girth slaps against your " + player.faceDescript() + ".  The fat member is thick and easily " + UnitSystem.displayInchesEstimateTextually(10) + " long.  He grips the hilt of his gigantic shaft and begins to slap your cheeks with his erection.  \"<i>Piggy's not doing his job.  Gotta clean every last " + UnitSystem.literalInch() + " of me,</i>\" he teases, smearing his drooling cockhead over your cheeks as your tongue sticks out to catch the dripping length.  You can't help but feel like a hungry whore as you chase Ro'gar's orc cock.");
	//[(if player has tail) 
...
public function rogarThirdPhase():void {
	...
	//((androgynous or masculine and breasts <= A-cup))
		...
		if (player.skin.tone == "green") outputText("  \"<i>Hey... Have y'ever had somebody randomly run up an' ask ya ta 'Waaagh!'?</i>\" he mutters quietly.  You give him a perplexed look.  The orc laughs off your confusion dismissively.  \"<i>Nothin', nothin'.</i>\"");
		outputText("\n\n");
		...
		//(else if Dirt Mc Girt = 2)
			...
			if (player.gender == 2 || player.gender == 0) {
				...
				outputText("  " + player.SMultiCockDesc() + " gets a caress from him as he explores, arousing it to mild stiffness.  \"<i>" + player.short + ",</i>\" he grunts.  \"<i>Ah hope ah'll be seein' more of ya.</i>\"  Ro'gar breaks the contact and tips back the remains of his drink while you ");
...
public function rogarPhaseFour():void {
	unlockCodexEntry("Orcs", kFLAGS.CODEX_ENTRY_ORCS); //Text will get cleared but force unlock anyway.
	clearOutput();
	spriteSelect(SpriteDb.s_rogar);
	...
	//(andro or masculine with tits <= A)
		...
		outputText("Ro'gar is tipping his drink back when he catches sight of you, and waves you over.  \"<i>Ah, good ta see ya, " + player.short + "!");
		//[(Ro'roh Raggy = 1)
		if (flags[kFLAGS.ROGAR_WARNING] == 1) {
		...
		if (player.gender == 2 || player.gender == 0) {
			...
			outputText("  " + player.SMultiCockDesc() + " trembles under his strong touch, as he increases the pressure and looks into your eyes meaningfully.  ");
...
private function loseButtGinity():void {
	...
	if (player.ass.analLooseness == 0) {
		...
		//(if player has balls) 
		if (player.balls > 0) outputText("  Ro'gar's dark green cockhead rubs over your " + player.ballsDescriptLight() + " and coats the plump sack in his musky goo, like an alpha male marking his territory.");
		outputText("\n\n");
		...
		outputText("  Fingers and " + player.feet() + " curl in pleasure as your previously untouched boycunt is forced open by Ro'gar's steady coaxing.");
		...
		outputText("Your mind races with Ro'gar's words as they seemed to be coming true.  You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your tight ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to break in your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + player.multiCockDescriptLight() + " and glaze your belly with pre-cum.");
	...
	//(([Get Anal] Scenario 1b: Get fucked (normal)))
		...
		if ((player.thickness >= 75 && player.tone < 33) || player.tone >= 75) {
			...
			if (player.balls > 0) outputText(" and your " + player.ballsDescriptLight() + " clench tight as you feel your limit reached");
			outputText(".");
			//[(if player has toes)
			outputText("  You curl your fingers and " + player.feet() + " in ecstasy as Ro'gar drives you over the edge.");
		...
		//(else)
			...
			outputText("\"<i>Enough horsin' around.</i>\"  Ro'gar snarls as his arms quickly yank back, sneaking under your legs and hoisting you up as he gets to his feet.  You grip Ro'gar's shoulders tight as he lifts you with a strained grunt.  You delight with sharp little moans as he begins to fuck you skyward, bouncing you off of his hips with each slam of his cock into you.  Slowly Ro'gar steps towards a wall, taking his time to be sure not to drop you, and you soon feel the cool surface pressed to your back.  Caught between a cock and a hard place, you stare into Ro'gar's predatory gaze as he holds you hoisted in the air and pinned, making you feel vulnerable.  The orc takes advantage of you and begins to abuse your " + player.assholeDescript() + ", making your head tilt back to moan out helplessly.");
			outputText("  " +  player.SMultiCockDesc() + " lays out over your chest, dribbling pre-cum on your skin as you make a mess of your torso in lust.");
			//[(if player has tail) 
			...
			//[(If player has balls) 
			if (player.balls > 0) outputText("  You feel your " + player.ballsDescriptLight() + " pull up tight in your sack as your labored breath comes out in pants.");
...
private function fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim():void {
	...
	//((else If smallest cock is over 18 inches))
		...
		//[(If multiple cock)
		if (player.cockTotal() > 1) outputText(player.SMultiCockDesc() + " grinds over every " + UnitSystem.literalInch() + " of Ro'gar's front, and his dark olive skin soaks in your glistening fluids.  Ro'gar's length is lost in the forest of your meat.  With his green monster assaulted by multiple angles and dwarfed in size he whimpers softly.  \"<i>Ain't never felt nothin' like this.  Almost like fuckin' a dick.</i>\"");
		//(else If single cock)
	...
	//((If cock is between 18 and 4 inches))
		...
		//[(if multiple cock)
		if (player.cockTotal() > 1) outputText("  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your " + player.multiCockDescriptLight() + ".");
		outputText("\n\n");
	}
	//end right fit path
...
private function frotWithRogar():void {
	...
	//(If single cock)
		...
		outputText("Your cock presses tight against Ro'gar's fat orc cock. He growls low as he grinds himself over you, his thick, globbing pre-cum drooling onto your " + player.multiCockDescriptLight() + ".  Muffled groans escape Ro'gar's mouth as you kiss him roughly, tongues locked all the while in writhing combat.  ");
		//[(If player has balls)
		if (player.balls > 0) outputText("Your " + player.ballsDescriptLight() + " slap audibly against Ro'gar's heavy green sack.  ");
...
private function kinkyWithDaOrc():void {
	...
	outputText("  Fingers and " + player.feet() + " curl in pleasure as your boycunt is forced open by Ro'gar's steady coaxing.");
	...
	outputText("You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to pound your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + player.multiCockDescriptLight() + " and glaze your belly with pre-cum.");
	if (player.hasLongTail() > 0 || player.isNaga()) outputText("  Your tail, still gripping Ro'gar's arm, squeezes tight.");
	//(If player has balls) 
