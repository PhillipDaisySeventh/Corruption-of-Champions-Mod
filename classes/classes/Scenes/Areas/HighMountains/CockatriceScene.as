...
package classes.Scenes.Areas.HighMountains {
	...
	public class CockatriceScene extends BaseContent {
		...
		public function defeatCockatrice():void {
			...
			if (player.lust >= 33) {
				...
				if (!player.isTaur() && !player.isDrider()) {
					if (player.hasVagina()) addButton(0, "Ride Him Vag", cockatriceRideHimVag).hint("Let him fuck your pussy.");
					addButton(1, "Ride Him Anal", cockatriceRideHimAnal).hint("Let him fuck your butt.");
					if (player.cockThatFits(monster.analCapacity()) >= 0) addButton(2, "Buttfuck", cockatriceButtfuck).hint("Fuck the cockatrices's ass!");
					...
					if (player.isTaur() && (player.hasVagina() || player.hasCock())) addButton(5, "Taur sex", cockatriceTaurButtFuck).hint("Let him fuck your tauric butt!");
					if (player.isDrider() && (player.hasVagina() || player.hasCock())) addButton(5, "Drider sex", cockatriceDriderButtFuck).hint("Let him fuck your drider butt!");
				}
		...
		private function cockatriceRideHimAnal():void {
			...
			outputText("\"P…please…\" he hisses, a somewhat melodic nature to his husky voice as you feel his thick cock pressing against your entrance with a little more pressure. "
		...
		private function cockatriceButtfuck():void {
			...
			outputText("Now, you can't be having that, such a naughty tail getting in your way. You tell him to raise his tail as you get down on "
			          +"[if (isNaga)your coils|[if (isGoo)the ground|your knees]] behind him, cooing about what what a good boy he is as you cup his cheeks affectionately, your thumbs pressing in lightly. "
			          +"Once his tail is moved to the side you can get get a good look at him, the raised base making his cheeks spread a little.\n\n");
			outputText("As you follow his slightly wide hips with your finger tips and trace over his fluffy rear, you gently tease his cheeks apart so you can see what you have to work with. "
		...
		private function cockatriceOralCock():void {
			...
			outputText("He definitely know what you expect of him, which makes this a lot easier.\n"
		...
		private function cockatriceOralVag():void {
			...
			outputText("He definitely know what you expect of him, which makes this a lot easier.\n");
			outputText("\"Time for a little fun.\" you smile as you stand over him and cup his fluffy cheek, guiding him towards your slit [if (player.balls > 0)as you move your balls out of the way]. "
		...
		private function cockatriceTaurButtFuck():void {
			...
			outputText("\"P-please…\" he hisses as his claws dig into your flesh, his round pupils making his begging cute but pitiful. "
		...
		private function cockatriceDriderButtFuck():void {
			...
			outputText("\"I’m gonna fuck you nice and hard.\" you smile as you back up, positioning your abdomen below him so his thighs rest either side of it, like some kind of parody of him riding you. "
			...
			outputText("You slowly move away and blush as your pucker feels cold, no doubt from the absence of his girthy member. "
			          +"Turning as you try to retain your composure while seed slowly drips down your cheeks, you untie the cockatrice and help him to the ground, rubbing his shoulders for a while as you both enjoy the afterglow in each others company."
		...
		private function rideCockatriceForeplay():void {
			...
			switch (chooser) {
				...
				case FOREPLAY_BLOWJOB:
					...
					outputText("With a slowness that seems unnatural for a creature that was moments ago bouncing around like a ferret hopped up on sugar, he licks tentatively at your hardening [cock], his forked tongue slowly flicking across the tip."
					...
					if (cockLength <= 5) {
						outputText("As the wet heat of his mouth and the gentle suction tease your [cock] you can’t help but force your length deeper into his mouth, your hips pumping gently. "
						...
						outputText("As the wet heat of his mouth and the gentle suction tease your [cock] you can’t help but force your length deeper into his mouth, your hips pumping gently. "
						          +"With some difficulty he manages to take your length, your [cock] entering his throat with each stroke. "
				...
				default:
					outputText("With a slowness that seems unnatural for a creature that was moments ago bouncing around like a ferret hopped up on sugar, he examines you with a curious look. "
					          +"Your lack of genitals seems to have stumped him. "
		...
		public function cockatriceBirth():void {
			...
			dynStats("sen", 3);
			//(eggCounter)
			outputText("When you find yourself able to stand, you examine what it is you have birthed; " + outputText(num2Text(Math.floor(player.totalFertility() / 7))) + " medium, white eggs, the unmistakable shape of hen eggs. "
			...
			outputText("They seem to quickly adapt to where they have found themselves, running around each other with increasing confidence, and you can see even in the short time you have been watching they have grown, their tender feathers hardening as the sun and air beats down on them. "
					  ...
					  +"The only evidence you have left of what just happened is a slimy pile of discarded egg shells.\n\n");
