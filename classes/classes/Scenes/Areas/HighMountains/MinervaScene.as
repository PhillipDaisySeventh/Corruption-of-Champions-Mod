...
//-Tainted Minerva anal capacity: 100
	...
	public function minervaSparIntensity():int {
		var amount:int = Math.max(0, flags[kFLAGS.MINERVA_SPAR_VICTORIES]);
...
private function takeMinervasPath():void {
	...
	outputText("\n\nShe analyzes you and your words, her bright electric blue eyes scrutinizing every " + UnitSystem.literalInch() + " of you. \"<i>I sense no lies in your voice, but make no mistake, I don't trust you yet,</i>\" the strange harpy says, setting you back down on the relative safety of the rocky edge.");
	//High corruption:
...
private function minervaLapSex():void {
	...
	outputText("\n\nThough infertile to someone like you, Minerva's seed fills you quite full, swelling your belly with what has to be a good " + UnitSystem.liter() + " or two of her thick, musky cream.");
...
private function pcGetsEatenOutByMinerva():void {
	...
	outputText("\n\nWith your pleasure so clear and easy to read, it's easy for Minerva to tell that you're enjoying the skills she has to offer. Wanting to experience more of your pleasure, and force you to reach greater heights of toe-curling, mind-melting rapture, she digs right in. Her tongue lashes out and licks every " + UnitSystem.literalInch() + " of your sopping snatch, eagerly licking up every drop of your succulent feminine fluids.");
...
internal function beatUpDatSharpie():void {
	clearOutput();
	minervaSprite();
	flags[kFLAGS.MINERVA_SPAR_VICTORIES]++;
	//Win by damage
	if (monster.HP < 1) {
