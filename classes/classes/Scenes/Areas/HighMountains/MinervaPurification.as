	...
	public class MinervaPurification extends BaseContent
	{
		...
		private function minervaRelaxing():void {
			if (flags[kFLAGS.MINERVA_TOWER_TREE] > 0) {
				...
				outputText("\n\nWith devilish intent you creep up on the sleeping siren, her shapely shark tail twitching gently as she naps. You sneak closer and closer until you are right by her and as soon as you can you grab her tail and pull. Unsurprisingly, and likely your intent, Minerva is jolted away by the touch and jumped what seemed to be " + UnitSystem.literalFeet() + " in the air. Her four wings fluffing up and spreading out in surprise. The broodmother's golden eyes widen as she looks around for what pulled her tail, as soon as she sees you, though, she visibly calms down. Pouting, she punches you gently in the shoulder, a deep blush on her cheeks. \"<i>Hey! Why did you do that? Scaring me like that... you're a mean lover, you know that?</i>\"");
		...
		private function minervaBabiesMeet():void {
			...
			switch(temp) {
				case 0: //Flying lessons
					...
					outputText("\n\nMinerva chuckles and sashays over to the pile of sirens. Even from here you can clearly see her wide broodmotherly hips swaying back and forth with her new natural walk. \"<i>They missed you so much; they always say how they want to see you and how they miss you when you aren't here. I should really bring them down to see you at your camp,</i>\" she says as she crouches down and smiles at you. \"<i>Alright girls, come on, let your " + playerParentDesc(false) + " up, you do want to play don't you?</i>\" She asks her rhetorical question, the young sirens all getting up off of you before helping you up. As you thank them and look down at your daughters you can't help but noticed how quickly they grew up. Though they are not even close to Minerva's impressive " + UnitSystem.displayHeight2Short2(8, 5) + ", they grew to roughly " + UnitSystem.displayHeight2Estimate(4) + " tall very quickly, though it seems to have slowed a great deal. Your young daughters have already started developing the telltale signs of hips and breasts that will firmly take after Minerva's.");
		...
		private function pureMinervaAppearance():void {
			...
			outputText("\n\nBetween Minerva's lightly toned legs rests all of her sexual organs; a normal vagina, and an unusually thick, " + UnitSystem.displayInchWithHyphenTextually(16) + " long anemone-like penis. The glans of that yellow and white shaft is ringed by small aphrodisiac-filled tentacles, while the base is surrounded by long tentacles as thick as fingers. Nestled against her soft thighs is a scrotum with cantaloupe-sized balls. She has a tight asshole, placed between her shapely buttcheeks, where it belongs.");
			outputText("\n\nMinerva has large demonic feet, each toe double-jointed and tipped with a large, black talon. Similar to her feet, her tongue also has a demonic quality, being " + UnitSystem.displayFootEstimateWithHyphenTextually(2) + " long and fully prehensile.");
		...
		private function talkToMinervaAboutSpring():void {
			...
			outputText("\n\nThinking about it you decide there would be nothing wrong with going for a dip with the curvaceous golden siren. Getting up from the ground you quickly strip off your " + player.armorName + " and jump into the pool. Seeing how eager you are brings a bring toothy smile to Minerva's slightly angular face, the purified herm jumping up and eagerly stripping as well, freeing her big bountiful breasts, before hopping into the water with an energetic splash.");
			outputText("\n\nThough the water isn't all that deep, only about " + UnitSystem.displayFeetEstimateTextually(4) + " deep you splash around and swim with the shark-like harpy. Minerva playfully splashing water at you with her tail, laughing as you play and swim, you can't help but look the very curvy siren over, your eyes instinctively falling on her big G-cup breasts, her wide broodmother hips and ass as well as her thick tentacled dick.");
		...
		private function talkToMinervaAboutMotherhood():void {
			...
			if (player.hasCock()) {outputText(" And so you begin weaving a story of how you fought six minotaurs at the same time, each of them " + UnitSystem.displayHeight2EstimateTextually(12) + " tall and carrying huge axes. It was a hard fight, most of your clothes were shredded from the fierce battle, your body glistening with sweat as you stood over your fallen beastial foes.");
		...
		private function sleepWithMinervaPostBirthing():void {
			...
			outputText("You wake up, feeling refreshed. You take a good look at your newborn sirenic daughters. Already, they have grown quite a bit! They're now " + UnitSystem.displayHeight2EstimateTextually(4) + " tall. You thank Minerva for letting you sleep with her and you hug her. Next, you pick up the sirenic daughters and give them a playful hug.\n\n");
		...
		private function fuckMinervaWithHerHandsBehindHerBack():void {
			...
			outputText("\n\nWith her posing like this, it's easy to get a good look at the teasing siren. Wanting to get a closer look, you start to walk around her, your eyes running over every " + UnitSystem.literalInch() + " of her, inspecting her form. Finally, your eyes come to a rest on Minerva's full, perky rump and the tight pink pussy that rests between her legs. Licking your lips, you approach her from behind, your hands grabbing handfuls of her tight, short-clad rump and squeeze, drawing a sharp gasp and small jump from Minerva before she looks back at you with a blush. \"<i>Getting a bit grabby, are we? Well, guess someone knows what they want,</i>\" she says with a grin before pushing her butt back at you and grinding it against your hands.");
			...
			outputText("\n\nDespite your brutal thrust, you slide in with ease, Minerva's tight walls so slickened with her arousal. You squeeze into the deliciously tight herm like butter, easily ramming every " + UnitSystem.literalInch() + " of your " + player.cockDescript(x) + " into her with only a few hard, deep thrusts. With your hips pressed against Minerva's accepting body, you grind against her, making sure she can feel every " + UnitSystem.literalInch() + " moving inside her clinging cunt.");
			//If balls: 
			...
			//Holy shit!:
				...
				outputText("\n\nYour inhuman load fills the siren's accepting belly with what can only be described as a flood, as " + UnitSystem.literalGallons() + " of your hot spooge instantly bloat her belly, swelling her womb like a balloon of raw fertility.");
		...
		private function minervaLapSex():void {
			...
			outputText("\n\nMinerva's seed fills you quite full, swelling your belly with what has to be a good " + UnitSystem.liter() + " or two of her thick, musky cream. You have a good feeling you might be pregnant.");
		...
		private function getButtFuckedYouSlut():void {
			...
			outputText("\n\nMinerva's seed fills you quite full, swelling your belly with what has to be a good " + UnitSystem.liter() + " or two of her thick, musky cream.");
		...
		private function letMinervaSuckYouOff():void {
			...
			//If cockarea 50+:
			if (player.cockArea(x) >= 50) outputText(", your huge cock deep inside her mouth, and soon far down her throat. With some difficulty, her slightly angular nose presses down against your crotch, every " + UnitSystem.literalInch() + " of your " + player.cockDescript(x) + " trapped inside her cool, wet mouth and throat");
			outputText(".");
		...
		public function pregnancyStage3(repeat:Boolean = false):void {
			...
			if (!repeat) {
				...
				outputText("\n\nWith her huge round tummy bloated with your babies, and now what has to be a good few " + UnitSystem.liters() + " of thick ball batter, you would think she would have trouble moving but the happy pleasure filled herm bounces up and down over your engorged prick like no tomorrow. The sirens lyrical moans and cries soon fill the air, mixing with the wet slurping her slippery pussy makes each time she slams her hips down upon you over and over, the sound combining to make a beautiful perverted symphony of lust and need, the erotic sounds only serving to flare your lust even more.");
