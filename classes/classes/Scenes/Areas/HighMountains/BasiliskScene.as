...
package classes.Scenes.Areas.HighMountains
{
	...
	public class BasiliskScene extends BaseContent
	{
		...
		public function defeatBasilisk():void {
			...
			//Player HP victory: 
			if (monster.HP < 1) outputText("Unable to stand anymore, the basilisk shakily sinks down on one knee, drops his head and looks at the ground, evidently demonstrating submission.");
			//Player Lust victory: 
			else outputText("No longer able to control his raging erection, the basilisk closes his eyes and sinks to one knee. He would probably be attempting to signal his submission to you if he weren't furiously masturbating his long, purple cock, which has emerged straining from the creature's genital slit.");
		...
		private function defeatBasiliskAndAnal(corrupt:Boolean):void {
			...
			if (corrupt) {
				...
				if (player.cocks[x].cockLength <= 13) {
					outputText("Soon your " + player.hipDescript() + " are clapping a staccato rhythm against his warm, muscly butt,");
					if (player.balls > 0) outputText(" your " + player.ballsDescriptLight() + " slapping against him,");
					outputText(" the creature taking every " + UnitSystem.literalInch() + " of your length before you pull out and thrust all the way in again, forcing ragged gasps from the reptile's still throat.\n\n");
				}
				//(More than 13 inches:)
				else {
					...
					//[(if balls)
					if (player.balls > 0) outputText("Your " + player.ballsDescriptLight() + " swing heavily underneath your shaft, swelling as your rhythm picks up. ");
				...
				//<(13 inches or less:) 
				if (player.cocks[x].cockLength <= 13) outputText("gripping his hips and pushing every " + UnitSystem.literalInch() + " of yourself in and reaching a glorious, skin tingling peak.");
				//(More than 13 inches:)
				else outputText("gripping his hips and pushing as much of your huge, bulging cock into him as you can, his stomach bulging as you reach a glorious, skin tingling peak.");
			...
			//Low Corruption:
				...
				//(More than 13 inches:)
					...
					outputText("You force as much of your huge member as you can into the creature's anus, clutching onto the creature's warm, muscly butt as you pull out and thrust yourself in again, comfortably driving a bit more of yourself in each time, forcing ragged gasps from the reptile's still throat. ");
					//[(if balls)
					if (player.balls > 0) outputText("Your " + player.ballsDescriptLight() + " swing heavily underneath your shaft, swelling as your rhythm picks up. ");
		...
		private function basiliskHasVagEggStuff():void {
			...
			outputText("Once it has you pinioned, the uncontrollable rut your body has instilled in the basilisk really takes hold and it begins thrusting against you with abandon, his long, thin reptilian cock sliding in and out of your eager, slavering cunt, his hot breath pushing against your face and shoulders. ");
			//<(Tight: 
			if (player.looseness() < 4) outputText("Though it is not girthy, it is a perfect fit for your tight hole, and his long length coupled with your drawn up position has you panting as he touches your deepest, most sensitive depths.");
			//(Loose: 
		...
		private function basiliskAdvantageGoblin():void {
			...
			if (player.hasCock()) {
				...
				else outputText("Her wet warmth swallows more and more of your member until, with a satisfied sigh, her plump thighs bump into your crotch. With your sensitised cock you can feel every " + UnitSystem.literalInch() + " of her, and when she starts to slide up and down the sucking, kneading sensation is unbearable.");
			...
			//Female: 
				...
				outputText("\"<i>Get caught with our pants down by a basilisk, did we slut?</i>\" she purrs. \"<i>Well, not to worry. I'll take good care of you.</i>\" You somehow doubt her good intentions, and your suspicions are confirmed when, after completing her sauntering circumference of you, she shoves your bottom half as hard as she can. You fall slowly like a wooden board; being unable to brace yourself, the sensation of dropping is horrible, and, once your skull connects with the ground, painful. Before you can clear your swimming vision you feel the goblin's soft, dense weight on your chest, and then her eager lips upon yours, sucking and tonguing every " + UnitSystem.literalInch() + " of your frozen mouth that she can reach. A tingling sensation spreads from your mouth downwards as her pheromone-laced lipstick takes effect. By the time she has finished with your mouth and worked her way downwards, your paralyzed body feels warm and receptive, and your " + player.vaginaDescript(0) + " is wet with need. You feel small fingers caressing your mons before slipping their way inside, circling your " + player.clitDescript() + " before testing your depths. You wish you could cringe away or even thrust yourself forward to try and make the goblin better address your growing need, but that is impossible; you stare in front of you, petrified, as the fingers continue their lazy tour of your sex until your juices are running like a river in spring.\n\n"); 
		
				outputText("\"<i>You are well up for this, aren't you hun?</i>\" coos the goblin as she begins to flick your sopping clit, sounding delighted with the involuntary heat she has stoked within you. \"<i>It's such a shame that I don't have the big cock you obviously want and need. Don't worry though; I've got the next best thing!</i>\" You hear her rummage around in her satchel, which is followed by the sounds of her wetly sucking on something with obvious enthusiasm. You shrink inwardly as you make a strong guess as to what she's holding and what she intends to do with it. Sure enough, a moment later you feel a dildo pushing unceremoniously into your " + player.vaginaDescript(0) + ".");
