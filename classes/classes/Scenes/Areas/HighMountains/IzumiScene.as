package classes.Scenes.Areas.HighMountains 
{
	...
	public class IzumiScene extends BaseContent
	{
		...
		protected function enterFirstTime():void
		{
			...
			if (player.tallness < 108)
			{
				outputText("  For a moment, you’re stunned into silence; the figure looks completely human, aside from two important factors.  The first, her size; she looks as though someone had tried to build a human but got the scale wrong.  By the looks of her, if she was standing upright she would tower at least around " + UnitSystem.displayFeetEstimateRangeTextually(8, " or ", 9) + " in height, and she looks broad enough to carry a horse on her back.");
			}
			else
			{
		...
		protected function enterFirstTimePartII():void
		{
			...
			outputText("“<i>Oh, so you’re the heroic type, yeah?  So, I guess it’s my turn now, huh?</i>” She sighs and closes her eyes, reclining and crossing her legs.  You can’t help but notice the way her kimono slithers around her legs, mere " + UnitSystem.literalInches() + " from becoming truly indecent, nor the way her breasts threaten to burst free of their confinement as she stretches.\n\n");
		...
		protected function surrenderFemaleLookitYouTheCenterOfAttentionYouSlut():void
		{
			...
			outputText(", pulling aside his loincloth to reveal his raging erection.  It bobs up and down, the bulbous head mere " + UnitSystem.literalInches() + " from your face.  “<i>Well?</i>”  Izumi asks.  “<i>What are you waiting for?  Get started, slut!</i>”\n\n");
		...
		public function fuckedUpByAFuckhugeOni(titLoss:Boolean = false):void
		{
			...
			outputText("“<i>So, it’s my win!</i>”  She announces, gleefully.  “<i>And you know what that means, right? It’s </i>playtime....”  The enormous woman looms over you, and you suddenly find yourself feeling distinctly nervous...  without warning, Izumi drops to her hands and knees and leans forwards, her leering face " + UnitSystem.literalInches() + " from your own.  With her arms on either side of you and her face filling your vision, you can’t help but feel a little enclosed. “<i>Let’s have sex!</i>”  She cries, then looks down towards your crotch, raising a hand threateningly.\n\n");
		...
		protected function gonnaGetMeSomeRevengeButtsexin():void
		{
			...
			else
			{
				...
				outputText("“<i>O-Okay, now just... just wait a second,</i>”  Izumi pants, then yelps in surprise as you immediately begin to push in even deeper.  “<i>Hey, wait, wait I said!  I-It’s big, okay?!  I n-need time to get u-used to thiiiee!</i>”  Her protest trails off into a strangled squeak as another " + UnitSystem.literalInch() + " of your titanic member forces itself into her backside, followed by another, and another, and another.  Soon, you’ve actually gotten your entire length buried inside Izumi’s plump ass, panting with exertion and luxuriating in the sensation as you’re surrounded on all sides by the burning heat and vice-like tightness, the big woman’s anus gripping at you so hard that it’s actually quite a struggle when you finally begin to draw back and pull out again.\n\n");
		...
		protected function sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt():void
		{
			...
			outputText("You direct her to kneel down with a growl.  Izumi opens her mouth to argue, then thinks better of it.  “<i>Okay! Okay, look, I’m cooperating.  Ha ha, you sure showed me, boy is my face re-Oh.</i>” She stops, eyes widening a little as you use your free hand to pull out [oneCock], stroking it towards hardness mere " + UnitSystem.literalInches() + " from her face.  She stares, mesmerized, as your hand rolls up and down your stiffening erection right in front of her.  \n\n");
