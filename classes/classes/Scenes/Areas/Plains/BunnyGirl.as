...
public function bunnbunbunMeet():void {
	...
	//Met her
		...
		outputText("While exploring the plains, you spy the familiar ears of a bunny-girl bobbing up and down behind a particularly tall patch of grasses.  You peek over the top of the grasses to find the dusky-skinned rabbit-girl playing with herself.  Both of her dainty, dextrous hands are clamped tightly around the wet, dripping length of her " + UnitSystem.displayInchWithHyphen(14) + " cock as she hammers at the ground with her feet and humps away at her tightly-balled fists.\n\n");
		outputText("You lean forwards for a better look, dislodging a small pebble with your " + player.foot() + " while shifting position.  The bunny-girl leaps to her feet in a panic until her terrified irises lock onto your " + player.faceDescript() + ".  Her panic turns to embarrassment and in a flash every " + UnitSystem.literalInch() + " of her tanned skin is colored red.  She asks, \"<i>Ummm, since I'm still in s-season, c-could we b-breed or something?  Maybe just a little fuck?</i>\"\n\n");
...
private function talkToBunnyBunBun():void {
	...
	outputText("Rose color erupts on her face as she drops her basket and covers her mouth, \"<i>Did I just say fuck!? EEP!</i>\"  With her basket no longer in hand, her groin is revealed!  A mammoth, " + UnitSystem.displayInchWithHyphen(14) + " dong bounces proudly between her legs.  It's veiny and tipped with a narrow head while a pair of egg-shaped orbs bounce in the sack underneath it.  She jumps and tries to cover it up again, but all she succeeds in doing is accidentally giving it a stroke.  A dollop of pre-cum squirts onto her hand as she moans without thinking, \"<i>Ooooh damn I need to breed.</i>\"\n\n");
...
private function rapeBunBun():void {
	...
	//[Rape Her Faster]
		...
		outputText("Your belly feels warm and wet, and as you pull back to examine the bunny, the source of the moisture is revealed.  The girl isn't a girl at all!  She's got a hard " + UnitSystem.displayInchWithHyphen(14) + " dick and a pair of bouncing, egg-sized balls that are working quite hard to leak bunny-cum onto you.  You reach down underneath the orbs and thankfully find another source of wetness.  At least you weren't completely wrong!  You're dealing with a hermaphrodite, and a horny one at that.  Why would she bother resisting when her body is so thrilled to be so close to you?\n\n");
...
private function bunbunFucksYourVag():void {
	...
	if (player.vaginalCapacity() < 20) outputText("By the time you're getting close to the bottom you have to work to encompass her length and girth within your velvet folds and grunt with discomfort from each new " + UnitSystem.literalInch() + " of throbbing fuck-stick, but you take it all.  ");
	...
	else outputText("It doesn't take long to slide down the more-than-" + UnitSystem.footCompound() + "-long meat-pole, and to be honest you wish she was a bit bigger.  Your " + player.vaginaDescript(0) + " is so ready for big dicks that this disproportionate member is average at best.  Still, you clench your thigh muscles to wring it a little tighter, and swoon from the feeling of warm maleness filling your loins.  ");
	player.cuntChange(35, true);
	outputText("\n\n");
	
	outputText("While the bunny was content to remain passive up until this point, a fire lights in her eyes now that she's had a taste of pussy.  Her petite hands grab hold of your " + player.assDescript() + " while she pulls her powerful, oddly-jointed legs underneath of her.  A split second later she pushes up with enough force to bounce you a few " + UnitSystem.literalInches() + " into the air before you drop down on top of her.  ");
	...
	outputText("You reach down and grab the bunny's hips for support as she bounces you again, higher this time.  A solid " + UnitSystem.displayInchesRangeTextually(5, " or ", 6) + " of her length slide in and out of your " + player.vaginaDescript(0) + " before you slap into her, and a split second later, you're airborne again.  She bounces you harder and harder until each thrust of her muscled thighs is launching you nearly " + UnitSystem.aFoot() + " off her loins and letting gravity guide you back down her shaft.");
	if (player.getClitLength() >= 4) outputText("  Your " + player.clitDescript() + " bounces on her belly, tingling like mad every time it slaps into her tanned, sweat-slicked skin.");
	...
	outputText("The girl underneath you is thrashing and moaning, chanting, \"<i>Yes... eggs eggs EGGS! YES!</i>\" while her ovipositor-like cock robs you of your strength and slides egg-shaped bulges inside you.  Amazingly, your " + player.vaginaDescript(0) + " is awash with pleasure, and you reach down to ");
	if (player.getClitLength() >= 4) outputText("fondle your " + player.clitDescript() + " a moment before wrapping your hand around it and stroking the girl-cock excitedly.");
	else outputText("caress your " + player.clitDescript() + " a moment before you start to circle it with a finger, teasing it expertly.");
	if (player.cockTotal() > 0) {
		outputText("  " + player.SMultiCockDesc() + " twitches and drools ");
	...
	if (player.cockTotal() > 0) {
		outputText("  At last, " + player.sMultiCockDesc() + " blasts sticky ropes of seed everywhere, cumming with you as your body slides sideways off the exhausted bunny into the dirt.  A few thick strands hit her tits and face, but judging by her half-closed eye-lids and questing tongue, she doesn't mind.");
		if (player.cumQ() > 500) outputText("  Not content with that, " + player.sMultiCockDesc() + " continues to pump until the bunny is coated with a generous layer of seed");
...
private function bunbunFucksPCInAss():void {
	spriteSelect(SpriteDb.s_easter_bunneh);
	clearOutput();
	outputText("You get a very naughty idea and silently discard your " + player.armorName + ", tossing it aside as you turn around and present your " + player.assDescript() + " to the bunny-girl.  With a lewd shake, you tease her and give her a good view of your " + player.assholeDescript() + " while it lowers closer and closer to the turgid bunny-cock, just " + UnitSystem.literalInches() + " away.  Drops of clear pre-cum roll down her shaft as it twitches eagerly, and the girl watches you through a gleam of sexual excitement while her shaft gets closer and closer to your rear entrance.  You let your " + player.legs() + " relax a little until it's pressing tightly against your sphincter, feeling it slather pre-cum in preparation for the coming penetration.\n\n");
	...
	else if (player.analCapacity() < 40) outputText("you have to keep pausing as you slide down to let more of her pre-cum bubble out and lubricate the " + UnitSystem.displayInchWithHyphenTextually(14) + " shaft.  It fills you nicely, pressing on your innards in all the right ways as you slowly engulf the bunny-cock with your " + player.assholeDescript() + ".  After bottoming out, your nervous lover's prick pulsates happily inside you, but you're just getting started.");
	else {
		outputText("you wish it was a bit bigger.  A few seconds is all it takes to get her thick shaft completely inside your " + player.assholeDescript() + ".  You clench and squeeze your muscles around it as you sit on the bunny-");
	...
	if (player.totalCocks() > 0) outputText("Each time she bumps and slides past your prostate a dollop of your pre-cum spurts from " + player.sMultiCockDesc() + " onto the ground, and you have a hard time not using your new lover like an anal toy and masturbating yourself.  ");
	...
	if (player.cockTotal() > 0) {
		outputText(", and " + player.sMultiCockDesc() + " pouring incredibly sticky pre-cum each time she squeezes your prostate");
	}
	else if (player.hasVagina()) outputText(", and your " + player.vaginaDescript(0) + " clenching and dripping on the verge of orgasm");
	outputText(".");
	if (player.biggestLactation() >= 1) {
		outputText("  Milk ");
		...
		outputText(" from your " + player.nippleDescript(0) + "s, turning your front to a leaky mess as you ride the very edge of pleasure.");
	}
	outputText("\n\n");
	...
	if (player.cockTotal() > 0) {
		outputText("and as it squeezes past your prostate, " + player.sMultiCockDesc() + " spurts thick cum on the ground, though you don't QUITE orgasm.");
	}
	...
	if (player.cockTotal() > 0) {
		outputText("  " + player.SMultiCockDesc() + " erupts in truth, spraying and splattering white goop over the grass and ground.");
	...
	if (player.hasVagina()) outputText("  Your " + player.vaginaDescript(0) + " clenches, empty, drooling, and neglected, wishing it something inside it.");
	outputText("\n\n");
...
private function bunbunGetsFucked():void {
	...
	if (player.cumQ() >= 1500) outputText("  Somehow her womb never seems to fill or bulge, even though you must be pumpings " + UnitSystem.literalGallons() + " of fertile baby-batter into her cunt.  By the time your orgasm winds down, you feel a little confused by it all, but sated.");
	outputText("\n\n");
...
private function bunbun69():void {
	...
	if (player.cockTotal() > 0) {
		...
		if (isEaster()) {
			...
			outputText("In turn, you suck all the harder on the bunny-girl's cock, swallowing a few " + UnitSystem.literalInches() + " at a time until your mouth feels full of the chocolate girl's erection. Around your head, she's drawn her knees up and braces her legs on the balls of her feet. Her lower body vibrates with the bouncing excitement of her twitching calves and it makes the prick in your mouth quiver like hot jelly. Her sac rolls this way and that in front of you, oval-shaped balls bouncing in eager appreciation and you can't help but wrap your hand around them, feeling the radiating heat pouring from the scrotum in the palm of your hand. Gently rolling them in your hand, you can feel the weight of the rapidly filling pouch in your palm. With your thumb, you stroke her bronzed nuts up to the tip of her vagina. The bunny's clit is as hard and large as a jelly bean and you circle it with the tips of your fingers, almost as if trying to tease it out of its dark chocolate-colored fleshy hood.\n\n");
			...
			outputText("Her second egg forces its way down your throat with gushing shudders and you can feel your hips straining against the weight of your overburdened stomach. You're a little afraid of what the second one will do to you as it slides out of the flared tip of the bunny's " + UnitSystem.displayInchesTextually(14) + ". Maybe it's the milking motion of the bunny's head bobbing in happy hops on your cock or maybe it's the swelling of the second egg, but your body begins to feel hot and your flesh tingles at your scalp and butt. You clench your eyes, willing yourself to digest the bunny's candy eggs and, to your surprise, your belly slows its expansion, gradually shrinking as the eggs burst in your stomach, unloading their gooey candy filling.");
		...
		//REGULAR SHOW
			...
			outputText("In turn, you suck all the harder on the bunny-girl's cock, swallowing a few " + UnitSystem.literalInches() + " at a time until your mouth feels full of the chocolate girl's erection. Around your head, she's drawn her knees up and braces her legs on the balls of her feet. Her lower body vibrates with the bouncing excitement of her twitching calves and it makes the prick in your mouth quiver with a breeder's anticipation. Her sac rolls this way and that in front of you, oval-shaped balls bouncing in eager appreciation and you can't help but wrap your hand around them, feeling the radiating heat pouring from the scrotum in the palm of your hand. Gently rolling them in your hand, you can feel the weight of the rapidly filling pouch in your palm. With your thumb, you stroke her bronzed nuts up to the tip of her vagina. The bunny's clit is as hard and large as the tip of your pinkie and you circle it with your fingers, trying to tease it out of its pink, fleshy hood.\n\n");
	...
	//CUNTS
		...
		outputText("Her second egg forces its way down your throat with pulsing shudders and you can feel your hips straining against the weight of your overburdened stomach. You're a little afraid of what the second one will do to you as it slides out of the flared tip of the bunny's " + UnitSystem.displayInchesTextually(14) + ". Maybe it's the milking motion of the bunny's head bobbing in happy hops on your clit or maybe it's the swelling numbness of the eggs, but your body begins to feel hot and your flesh tingles at your scalp and butt. You clench your eyes, grunting through the heat of the bunny's eggs and, to your surprise, your belly begins to feel like it's emptying.");
		if (player.tail.type != Tail.RABBIT) {
			//[No Tail: 
			if (player.tail.type == Tail.NONE) outputText("  The heat around your lower back clutches at your tail bone and you feel a fluffy explosion swell around your butt cheeks as a fluffy bunny's tail pops out of your back, twitching excitedly!");
			//Existing tail: 
...
public function ovipositBunnyEaster():void {
	...
	outputText("\n\n\"<i>Oh?  Where's that?</i>\" she responds, both her floppy ears standing up stock-straight and quivering with excitement.  She hops over to you, unconsciously letting her dripping phallus bob ponderously with each jump, the inertia turning it into a sexual pendulum of ridiculous, " + UnitSystem.displayInchWithHyphenTextually(14) + " proportions.  \"<i>Are they behind you?</i>\"");
...
private function freeHerOhGodWhyDidYouDoThis():void {
	...
	outputText(", her urgent lust pulsing in every " + UnitSystem.literalInch() + " of her ");
	...
	outputText("\n\nBefore the cock ring even lands, she's sunk to her knees, both hands pumping her length feverishly, coaxing her pent-up reservoirs to sweet release.  The behemoth balls next to you churn and gurgle in sympathetic fervor, trembling at the intensity of her passion.  A thick bulb forms at the base of her member, the pliant flesh distending to twice its normal girth.  Slowly, achingly, the protuberance is forced up her " + UnitSystem.displayInchWithHyphenTextually(14) + " rod, the tip of her cockhead dilating like a gaping mouth.  Then, with a loud, gushing pop, the first egg spurts from her breeding pole, shooting through the air at the head of a tremendous fountain of ");
	if (!isEaster()) outputText("splattering spoo");
	else outputText("climaxing cream");
	outputText(".  The showering spray continues in an unbroken outpouring, a river of alabaster arcing and gushing in a throbbing surge that white-washes everything within " + UnitSystem.displayFeetEstimateTextually(10) + " of her frontal arc.  Countless ");
...
private function fuckTheEggBoundBun():void {
	...
	else outputText("growing larger and larger as cum splatters in thick streams from her saturated pussy. Your seemingly endless " + UnitSystem.literalGallons() + " of flooding cum wash the remnants of her previous partners away, immersing the caramel woman in the fluid wealth of your liquid possession.");
...
private function getEggflated():void {
	...
	outputText("\n\nAtop your perch, bound to the lapin by " + UnitSystem.displayInchesTextually(14) + " of caramel-colored flesh, you take a moment to rock back and forth atop the girl.  Merely being mounted has taken every ounce of her restraint, but you can tell it's a matter of seconds before her resolve crumbles.  Positioned perfectly to take the full geyser of her ");
