package classes.Scenes.Areas.Forest
{
	...
	public function encounterAiko():void 
	{
		...
		if (flags[kFLAGS.AIKO_TIMES_MET] == 1) {
			...
			else if (player.tail.type == Tail.FOX && player.tail.venom == 9) {
		...
		// Third encounter with Aiko
			...
			if (flags[kFLAGS.AIKO_AFFECTION] >= 50)	{
				...
				if (flags[kFLAGS.AIKO_RAPE] < 1) {
					...
					+"<i>“You… you’re not gonna try to rape me again, are you?”</i> she says, looking at you hopefully. [if (player.isPureEnough(50))Her question stings your conscience a little, and it’s made only worse by her innocent expression. She dearly wants to like you—you can see it in her eyes.]\n\n"
			...
			if (flags[kFLAGS.AIKO_BOSS_INTRO] > 0) {
				...
				+"<i>“It’s a huge deal!”</i> she says, almost slipping into hysterics again, biting her lip and squeezing a few more tears out before calming down. <i>“She was exiled from the village years ago... but... I never expected... PlayerName, she’s been corrupted!”</i>\n\n"
	...
	private function aikoRequestsBallAfterLose():void
	{
		...
		+"[if (player.isCorruptEnough(40))You angrily swat her hand away, glaring at the impertinent girl.] Your hand moves instinctively to the pouch where you stowed the white ball you found earlier. She seems to be truly desperate to get it back... Will you give it to her?");
	...
	private function  talkArchery():void
	{
		...
		if (player.hasKeyItem("Bow") >= 0 || player.hasKeyItem("Kelt's Bow") >= 0) {
			...
			if (player.statusEffectv1(StatusEffects.Kelt) > 75) {
	...
	public function pcWinsDomFight():void
	{
		...
		if (flags[kFLAGS.AIKO_CORRUPTION] < 50 && flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] > 0) {
			...
			+"That’s a good question. She’s at your mercy now, so you could do just about whatever you want to her. [if (player.isCorruptEnough(40)) An evil smirk crosses your face as you think about teaching this little bitch a lesson for crossing you.] Will you rape her, and if so what will you do?");
		}
		aikoRapeSex();
	}
	...
	private function aikoRapeFuckAss():void
	{
		...
		+"<i>“Please be gentle…”</i> she says as the tight ring of flesh begins to expand around your tip. Her face turns a deep crimson as you sink the first " + UnitSystem.literalInch() + " inside her, squeezing her ample cheeks around your [cock"+(x+1)+"] and moaning needily.\n\n"
		+"[if (player.cockArea("+x+") >= 40)<i>“AH! N..no, no more, it’s not going to…iieah!”</i> She cuts off mid sentence as you easily sink another " + UnitSystem.displayInchesTextually(4) + " into her. Not fit? Hardly, you tell her, giving her a firm spank. Her slutty asshole begs to differ, you say—it’s practically swallowing your dick!\n\n]"
	...
	private function aikoSexDoggy():void
	{
		...
		+"With a grin, you lower yourself down, placing your palms on the exotic spiral tattoos that adorn her heavy, jiggling butt cheeks and positioning yourself behind her. The tip of your [cock "+(x+1)+"] gently brushes up against her lady lips, and you can feel a veritable fountain of juices spilling out over it. You can see Aiko blush in embarrassment from how wet she is already, but she quickly deflects your attention back to her loins as she backs up onto your shaft a few " + UnitSystem.literalInches() + ", letting out a lewd moan.\n\n"
		+"The wonderful warmth of her insides wraps around you like a glove, and your hips fall forward involuntarily, "+(player.hasKnot(x)?"driving the full length of your shaft up till the knot":"driving every last " + UnitSystem.literalInch() + " of your shaft")+" inside in one stroke. Aiko’s mouth opens wide in a powerful moan, and she begins to rock her hips back and forth, slamming her bountiful bottom against your "+(player.hasKnot(x)?"knot":"hips")+" over and over again.\n\n"
	...
	private function aikoWhipping():void
	{
		...
		if (rand(4)==0) {
			...
			+"Your raucous moans die out suddenly as the glorious torment ceases, and you shiver with unfulfilled desire as the vixen releases you from her grip. Even the tiniest touch would be enough to send you over the edge, but your worn and battered muscles won’t move " + UnitSystem.literalAnInch() + "! You plead with her desperately, your voice growing hoarse, but all she does is push your head back into the dirt with her index finger, whispering, <i>“Not today, my little masochist slut...”</i>"
