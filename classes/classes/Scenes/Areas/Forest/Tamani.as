...
//New Tease option:
		public function tamaniHypnoTease():void {
			...
			var lustDmg:int = rand(player.lib/5) +3+(flags[kFLAGS.TAMANI_TIMES_HYPNOTISED]);
		...
		public function Tamani()
		{
			...
			this.long = "She keeps her arms folded across her " + game.forest.tamaniScene.tamaniChest() + " and glares at you.  The little thing is only about " + UnitSystem.displayHeight2EstimateTextually(4) + " tall, with pink and black dyed hair cut into a cute little 'do.  The greenish-gray skin of her breasts bulges out around her arms, supported by a few leather straps, amplifying her cleavage.  Her cunt lips are pierced multiple times, inflamed, and slightly parted.  There really isn't any clothing on her to hide them, just more of the ever-present straps wrapping around her thighs.";
			this.race = "Goblin";
			// this.plural = false;
