...
private function faerieRAEP():void {
	...
	if (player.isTaur()) {
		...
		if (player.getClitLength() >= 3) {
			outputText("The tiny fae begins jerking your clit like a cock, squeezing her arms tightly around you and sliding in and out of your " + player.vaginaDescript(0) + ". Her motions are frenetic and unpredictable, but incredibly pleasurable.  She starts licking at your " + player.clitDescript() + " as your femcum runs down it, which only serves to make her more excited. She gets so excited that her legs start kicking wildly as she screams \"<i>Swim! Swim! Swim! Swim!</i>\" over and over again.  ");
			//[Small amount of cum:
			if (player.vaginas[0].vaginalWetness <= Vagina.WETNESS_WET) outputText("The fae giggles more and more as the fluid seeps about her and your " + player.vaginaDescript(0) + " ripples. She hugs your " + player.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a small puddle of femcum.\n\n");
			//[Normal amount of cum:
			else if (player.vaginas[0].vaginalWetness <= Vagina.WETNESS_DROOLING) outputText("The fae giggles more and more as the fluid squirts about her and your " + player.vaginaDescript(0) + " ripples. She hugs your " + player.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a puddle of femcum.\n\n");
			//[Huge amount of cum:
		...
		//[All other clits:
			...
			//[Small amount of cum:
			if (player.vaginas[0].vaginalWetness <= Vagina.WETNESS_WET) outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid seeps about her and your " + player.vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a small puddle of femcum.\n\n");
			//[Normal amount of cum:
			else if (player.vaginas[0].vaginalWetness <= Vagina.WETNESS_DROOLING) outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid squirts around her and your " + player.vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a puddle of femcum.\n\n");
			//[Huge amount of cum:
	...
	//Non-Taurs
		...
		outputText("\n\nYou release the lower portion of your " + player.armorName + ", revealing your aroused slit to the faerie.  ");
		...
		if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_SLAVERING) outputText("releasing a tiny squirt");
		else if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_DROOLING) outputText("dribbling juices");
		else if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_WET) outputText("growing so slippery the faerie nearly loses her footing");
...
protected function faerieDoNothing():void {
	...
	if (player.nippleLength >= 1) {
		...
		if (player.hasVagina()) outputText("With your other hand you start diddling your " + player.vaginaDescript(0) + ", adding your own soft moans to hers.  ");
		else if (player.hasCock()) outputText("With your other hand you start jerking your " + player.cockDescript(0) + ", adding your own soft moans to hers.  ");
		outputText("A few blissful moments later, she shudders and you feel her uncontrolled spasms around your nipple.  ");
		if (!player.isGenderless()) outputText("You join her shortly after.  ");
