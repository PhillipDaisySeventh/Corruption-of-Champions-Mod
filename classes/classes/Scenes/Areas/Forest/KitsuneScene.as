...
//fomerly letHer()
		private function kitSuneLetHerMansion(willing:Boolean = true):void
		{
			...
			outputText(" and thrust in, spearing you on " + UnitSystem.displayInchesTextually(12) + " of throbbing futa rod.  Buried to the hilt in your ");
...
//Formerly shoveHer()
		private function kitsuneShoveHerMansion(willing:Boolean = true):void
		{
			...
			if (player.gender == 1 || ((player.gender == 3) && flags[kFLAGS.redheadIsFuta] == 0)) {
				...
				outputText("You feel something brushing against you and look down to find the black-haired girl pressing her face against your [butt], running her hands up and down your " + player.hipDescript() + " and smacking your cheek once lightly for good measure.  An involuntary shudder zigzags up your spine as her slick tongue runs up your crack, lining your [asshole] with saliva.  Her fingertips dig into the flesh of your bottom, the other hand sliding along your " + player.vaginaDescript() + ", pinching and rolling your " + player.clitDescript() + ".  A moment later, you rise " + UnitSystem.anInchOrTwo() + " off the ground as a squirming invader spears your ass.  Her plush lips press against you like soft pillows, a muffled giggle vibrating up her tongue and into your prostate.  Your strength gives out as she prods your prostate, dragging you down with her weight at the same time to impale you on the redhead's cock.");
...
//formerly
		private function kitsuneStillHungryMansion():void
		{
			...
			outputText("The introduction of a spark of blue flame against the base of your cock enforces the request, and you have little choice but to comply.  An unnatural pressure begins to fill your " + ((player.balls > 0) ? player.ballsDescriptLight() : "prostate" ) + ", most certainly a result of the kitsune's prior witchery.  The base of your " + player.cockDescript(player.biggestCockIndex()) + " swells up, the thick bulge slowly working its way up the length of your shaft and forcing past her plump pink lips.  Your mind goes blank, vision popping with white spots as you moan orgasmically into the blonde's salty pussy, your tongue jammed deep into her folds.  " + capitalizeFirstLetter(UnitSystem.liter()) + " after " + UnitSystem.liter() + " of seed, thicker and more virile than you've ever produced, begins to flow down into the black-haired kitsune's gullet, eagerly swallowed without hesitation.  Twin streams burst from her nose as her cheeks bulge with semen, her lips clasped as tight as possible to contain as much as she can, while her belly continues to jiggle with added weight, sloshing and quivering as more and more cum flows down her throat.\n\n");
...
//formerly stillHungry()
		private function genderlessKitsuneStillHungry(willing:Boolean):void
		{
			...
			outputText("The introduction of a spark of blue flame around your breasts enforces the request, and they give you no choice but to comply.  An unnatural pressure begins to fill them again, most certainly a result of the kitsune's prior witchery.  Your nipples puff up, thick, creamy hindmilk slowly working its way to the surface, flowing past her plump pink lips.  Your mind goes blank, vision popping with white spots as you moan orgasmically into the air.  " + capitalizeFirstLetter(UnitSystem.liter()) + " after " + UnitSystem.liter() + " of milk" + ((player.lactationQ() > 0) ? ", the thickest you've ever produced," : "") + " begins to flow down into the black-haired kitsune's gullet, eagerly swallowed without hesitation.  Twin streams burst from her nose as her cheeks bulge with milk, her lips clasped as tight as possible to contain as much as she can, while her belly continues to jiggle with added weight, sloshing and quivering as more and more of it flows down her throat.\n\n");
...
//[Vaginal] - requires cock
		private function fuckAKitsuneVaginally():void
		{
			...
			outputText("You toss away your " + player.armorName + ", dropping to the ground without a second thought, and you carefully lift the hem of the kitsune's robes to inspect her groin." + ((monster.hair.color == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? "  Her throbbing cock rises to attention immediately, precum leaking slowly but constantly from the tip, down the thick shaft and over her glistening nether lips." : "" ) + "  A small tattoo rests on her pubic mound, accentuating her" + ((monster.hair.color == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? " " + UnitSystem.footCompound() + "-long member and" : "" ) + " shaven pussy." + ((monster.hair.color == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? "  You take her pulsing shaft into your hand and begin to pump it strongly, watching her face contort into all manner of pleasured grimaces as your fist slides up and down the pre-soaked pole." : "") + "\n\n");
			...
			outputText("Smirking, you lift her leg onto your shoulder once more and continue sliding your shaft across her groin, letting her get good and wet before you press it up against her.  Strings of sticky lubricant flow down your shaft as you press into her, forcing a moan from her throat as you push the [cockHead biggest] inside, her slick lips parting easily and inviting you inside." + ((player.biggestCockArea() > 50) ? "  The walls of her pussy stretch incredibly, swallowing " + UnitSystem.literalInch() + " after meaty " + UnitSystem.literalInch() + " of your engorged member with no end in sight." : "") + "  Her breasts jiggle lightly when your [hips] bounce up against hers, " + ((monster.hair.color == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? "her cock flopping against her stomach and leaving behind a trail of musky precum, " : "" ) + "the walls of her pussy clamping down against your shaft.\n\n");
...
//[Tribbing] - requires vagina
		private function tribbingWithAKitsune():void
		{
			...
			outputText("\"<i>Haha, what do you think you're doing, you silly mortal...</i>\" she says, chuckling as you position yourself over her, settling your [butt] down on her splayed thighs, your " + player.vaginaDescript() + " meshing seamlessly with hers." + ((player.cocks.length > 0) ? player.sMultiCockDesc() + " drape" + ((player.cocks.length > 1) ? "s" : "" ) + " over the plump round cheeks of her prodigious posterior, leaking strands of precum onto her bundle of luxurious tails" + ((monster.hair.color == "red" && flags[kFLAGS.redheadIsFuta] > 0) ? ", while her own member dangles a few " + UnitSystem.literalInches() + " above her nose." : ".") : "" ) + "  When your slow, measured grinding resumes, you moan with approval, finding this new position to be much more satisfying.\n\n");
...
//[Tentacles] - requires 3+ tentacles of 30" or longer
		private function kitsunesGetBonedBy3PlusTentacles():void
		{
			...
			outputText("You oblige her with a moan, burying " + UnitSystem.aFoot() + " of tentacle into her sloppy snatch with a single thrust.  She groans in approval, her mouth hanging open, and you quickly move one of your squirming tendrils to fill the opening.  Her throat relaxes to accept the intruding member, and before you know it you have her strung up from both ends, driving her mad with pleasure.\n\n");

			outputText("Her fingers and toes curl around different parts of your vinelike shafts, stroking them with an adoring fervor.  Your third tentacle continues to writhe obscenely between her fleshy butt cheeks, spreading slick precum around her rosy anal ring.  Her violation becomes complete as your wriggling tentacle plunges swiftly into her tight rear passage, spearing her rectum on " + UnitSystem.aFoot() + " of your throbbing plant length.  The warm, inviting tunnel ripples around you, strong musculature working to draw more and more of your squirming tendril inside.\n\n");
...
//{all " + player.cockDescript(0) + " calls for this scene should prioritize dog cocks; if PC is in Rut, prioritize other animal dicks second, otherwise use the biggest cock.}
		private function fuckDraftBlond():void
		{
			...
			outputText("You look on with mild amusement as she drags herself one, two, three " + UnitSystem.display("feet", "steps") + " away, and collapses in a shivering wreck, raising her ample rear into the air.  Her hips flex and pump in defiance of her will, all six of her golden tails raised high and fanned out as she claws out of her robes, exposing her drenched fuckhole and gorgeous tattooed ass.\n\n");
...
//[GetBJ] - requires cock 108 area or less
		private function getABJFromAFoxGirl():void
		{
			...
			outputText("Your shaft is swallowed up once more, forced to the back of her throat as she gulps down " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of your throbbing meat.  She pulls back, sucking as though her life depended on it, then dips down again, slurping up your salty precum desperately.  The " + player.cockHead(x) + " of your cock hits the back of her throat again and again, ");
...
//AKA Lose the dick, schweethaat AKA put that thing away
		private function redheadsDontDeserveToHavePenisesBecauseTheyreTooGayForPenisOrSomethingIDontReallyKnowHowThisWorksOrWhyThisFunctionNameIsSoFuckingLong():void
		{
			...
			outputText("Rolling her eyes, she hesitantly complies, a wreath of flame engulfing her mismatched genitals with the crackling snap of a flint being struck.  When the azure blaze dissipates, her " + UnitSystem.footCompound() + "-long cock has regressed into a pert cherry-colored nub.\n\n");
