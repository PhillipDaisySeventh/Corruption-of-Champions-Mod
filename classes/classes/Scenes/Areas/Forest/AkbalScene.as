	...
	public function encounterName():String {
		...
		public function akbalDefeated(hpVictory:Boolean):void{
			...
			} else //[Victory via Lust]
			{
				...
				outputText("You walk around Akbal's lust crazed form with a smile on your face. The demon's growl continues as he awaits your judgment.");
		...
		private function rapeAkbalForcedFemaleOral():void
		{
			...
			if (player.isNaga())
			{
				...
				outputText("As you uncoil you can't help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, allowing you a perfect view of his low hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon's " + UnitSystem.displayInchWithHyphen(15) + " pecker is visible.\n\n");
			...
			else
			{
				...
				outputText("Akbal grunts as you smash his face into the ground.  At your command he raises his hind quarters, allowing you a perfect view of his low-hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon's " + UnitSystem.displayInchWithHyphen(15) + " pecker is visible.\n\n");
			...
			if (player.lowerBody.type == LowerBody.NAGA)
			{
				...
				if (player.totalCocks() > 0)
				{
					...
					else
					{
						...
						outputText("You twist Akbal's tail into your fist and laugh as a scared whimper rises out of the jaguar demon's throat.  You begin to push your huge cock in with one hand as your other pulls Akbal's tail.  The creature wines and howls as you invade its clenching sphincter, forcibly stretching its tight pink hole to a dangerous degree with your " + player.cockDescript(primary) + ".  All too soon you are halted, barely able to fit more than " + UnitSystem.aFoot() + " of your huge cock into Akbal's virginally-tight hole.  Deciding that's good enough you pull out and push forward, meeting the same resistance as before.\n\n");
			...
			else if (player.isTaur())
			{
				...
				if (player.totalCocks() > 0)
				{
					...
					else
					{
						...
						outputText("The demon wines and wraps his arms around your front legs, pulling himself away from the burning pressure of your " + player.cockDescript(primary) + ".  His voice breaks as you invade his clenching sphincter, forcibly stretching Akbal's tight pink hole to a dangerous degree.  All too soon you are halted, barely able to fit more than " + UnitSystem.aFoot() + " of your huge cock into Akbal's virginally-tight hole.  Deciding that's good enough you pull out and push forward, meeting the same resistance as before.\n\n");
		...
		private function girlsRapeAkbal():void
		{
			...
			if (player.isTaur())
			{
				...
				if (player.hasCock())
					outputText(" " + player.sMultiCockDesc() + " hanging beneath, twitching in anticipation");
			...
			else if (player.vaginalCapacity() < monster.cockArea(0))
			{
				...
				//{If Goo}
					...
					outputText("Lifting up your " + player.leg() + ", you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ");
		...
		private function girlsRapeAkbalPart2():void
		{
			...
			if (player.isTaur())
			{
				...
				if (player.hasCock())
					outputText(", " + player.sMultiCockDesc() + " swinging back and forth, occasionally bumping into his bound legs");
			...
			else if (player.vaginalCapacity() < monster.cockArea(0))
			{
				...
				//({If Herm}
				if (player.hasCock())
					outputText(" while you stroke " + player.oMultiCockDesc() + " in time with his thrusts");
				...
				if (player.hasCock())
					outputText(" as " + player.sMultiCockDesc() + " offers up its bounty, spasming and adding to the mess");
				...
				outputText("Your " + player.chestDesc() + " chest heaves as you struggle to gulp air, " + player.legs() + " quivering from the sheer power of the orgasm the cat's tail gave you.  ");
				...
				outputText(" as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your " + player.armorName + " and head out. Perhaps you should look out for the \"<i>God of Terrestrial fire</i>\" again sometime...");
		...
		private function loseToAckballllllz():void
		{
			...
			if (!player.isTaur())
			{
				...
				outputText("You fall to your knees and begin to feverishly masturbate.  Akbal rises onto his two hind legs, his body shifting into a more humanoid form as he stands.  His long cock swings ominously between his legs as he walks towards you.  The first thing he does is pull his massive " + UnitSystem.displayInchWithHyphen(15) + " cock to your lips, slapping the shaft against your chin.\n\n");
		...
		private function akbalSubmit():void
		{
			...
			if (player.lowerBody.type == LowerBody.NAGA)
			{
				...
				else if (player.ass.analLooseness < 5)
				{
					...
					outputText("Akbal's titanic member stretches your " + player.assholeDescript() + " and makes you groan beneath him, reveling in the slick heat and fullness of your bowels. His saliva heats up, creating a steamy,pleasurable warmth inside your body. As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes. Your body begins to act of its own accord, your " + player.buttDescript() + " grinding against his thrusts as his large sex pump slides in with his trunk slamming into your " + player.buttDescript() + " in rhythmic, echoing claps.");
				}
			...
			if (player.isTaur())
			{
				...
				//(No tail)
					...
					outputText("  As he makes his way to your hind quarters he grabs your " + player.buttDescript() + ", groping the mass of flesh with one hand and sliding a finger across your exposed " + player.assholeDescript() + ", making you paw the ground with your hooves.");
				outputText("\n\n");
				//(Transition)
				...
				outputText("Looking back you watch Akbal bend low, losing sight of the jaguar demon as he disappears behind you.  For a moment you wonder what he's doing but soon you feel him shove his face into your " + player.buttDescript() + " with a snarl.  He begins working his slippery wet tongue into your " + player.assholeDescript() + ", greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, suddenly lost in ecstasy.  You are surprised at the strength in the demon's neck as he smashes your body against the tree with nothing but his mouth.  You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.");
				...
				{
					outputText("You feel him poking around your " + player.assholeDescript() + " and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  Yet,  thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your " + player.assholeDescript() + ".\n\n");
					outputText("Akbal's titanic member stretches your " + player.assholeDescript() + " and makes you groan and claw at the tree he has you pressed against, reveling in the slick heat and fullness of your bowels.  His saliva heats up, creating a steamy yet pleasurable warmth inside your body.  As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes.  You lean back into his thrusts as his trunk begins slamming into your " + player.buttDescript() + " in rhythmic claps that echo throughout the forest.");
				}
			...
			if (player.ass.analLooseness < 3)
			{
				outputText("You grit your teeth, expecting pain. However, thanks to the weird saliva he slathered your innards with, you feel none as his gargantuan member forcibly widens your " + player.assholeDescript() + ".");
				player.buttChange(monster.cockArea(0), true);
				outputText("\n\n");
			...
			{
				outputText("Thanks to the weird saliva he slathered your innards with, you feel no pain as his gargantuan member forcibly widens your " + player.assholeDescript() + ".");
				player.buttChange(monster.cockArea(0), true);
				outputText("\n\n");
			...
			outputText("Akbal works his hips fast, piston-pumping his long demon cat-dick in and out of your " + player.assholeDescript() + ".  The rampant babbling coming from your mouth breaks with his every thrust, and your body is racked by orgasm after orgasm. You're soon on your chest and knees ");
