...
private function fuckYoDaughtersHomie():void {
	...
	if (primary >= 0) {
		...
		if (daughters > 10) {
			...
			if (tamaniPresent) {
				outputText("Tamani pushes the slut on your face off and plants herself there, smearing your " + player.faceDescript() + " with a mixture of cum and vaginal wetness.  ");
			...
			outputText("As your ");
			if (player.balls > 0) outputText(player.ballsDescriptLight() + " empty");
	...
	//[DOESNT FIT]
		...
		if (tamaniPresent) {
			...
			if (player.balls > 0) outputText("  Your " + player.ballsDescriptLight() + " ache from the strain, but struggle to churn up more sperm.  ");
		...
		outputText("A third goblin suddenly attacks your taint, licking between your " + player.assholeDescript() + " and ");
...
private function legTamanisDaughtersRAEPYou():void {
	...
	outputText("A slippery gash mounts your " + player.faceDescript() + ", blocking your view of anything but a cute navel as pungent pussy slobbers over your lips.  With a resigned sigh, you open your mouth and bury your tongue into one of your many daughters' snatches.  It's tangy and sweet, and juicier than fresh fruit.   The girlish moans you hear let you know how successful your tongue is, and you work harder than ever to kiss and lick her slippery lips, pausing only to suck the tiny bud of her clit into your mouth.\n\n");
	...
	if (primary >= 0) {
		...
		else if (cocks > 2) outputText("More and more hands latch onto the rest of your " + player.multiCockDescriptLight() + ", guiding each of them into a tight cunt-hole.   If you could see around the tight body of the slut on your face, you're sure the scene on your crotch would push you over the edge.");
		else outputText("You stiffen as a tongue suddenly presses against your " + player.assholeOrPussy() + " sliding inside and intensifying the feelings radiating down your fuck-pole until you're unable to hold on.");
		outputText("\n\n");
		
		outputText("A sudden flow of fluids soaks your " + player.faceDescript() + " and dribbles from your chin.  The face-riding goblin bucks like a bronco, nearly breaking your nose before the strength drains from her body and she slides off into the dirt, panting weakly.   Confronted with the sight of ");
		...
		else outputText("the sultry gaze of Tamani's oldest daughter as she rides your " + player.cockDescript(primary));
		...
		//NO TAMANI:  
			...
			if (daughters < 20) {
				...
				outputText("Amazingly, you orgasm again.  An orgiastic squeal erupts from your " + player.cockDescript(primary) + "'s current owner, breaking off into pants and gasps ");
				...
				outputText("  Disappointed moans rise up from the others as they realize they've lost the cum-lottery.   The winner, patting her belly happily, stands up, filling the air with a loud 'slurrrrrp' as her twat noisily releases your " + player.cockDescript(primary) + ".");
			...
			//(MEDIUM PACK (or bigger))
				...
				outputText("Amazingly, you orgasm again.  An orgiastic squeal erupts from your " + player.cockDescript(0) + "'s current owner, breaking off into pants and gasps ");
				if (player.cumQ() < 100) outputText("as you twitch underneath her, emptying the last of your cum inside her.");
				else if (player.cumQ() < 500) outputText("as you twitch underneath her, pumping her full of cum, thoroughly seeding her womb with spunk.");
				else outputText("as you twitch underneath her in powerful spasms, blasting huge gouts of cum into her waiting body until her belly is bloated with seed and it begins to squirt out around you in time with each eruption of spunk.");
				outputText("  Disappointed moans rise up from the others as they realize they've lost the cum-lottery.   The winner, patting her belly happily, stands up, filling the air with a loud 'slurrrrrp' as her twat noisily releases your " + player.cockDescript(primary) + ".");
				...
				if (daughters < 40) {
					...
					if (player.balls > 0) outputText(player.ballsDescriptLight() + " hurt");
	...
	//[NO FIT]
		...
		if (!tamaniPresent) {
			...
			outputText("Frowning in consternation, she presses it down onto your belly and sits on top, spreading her cunt as wide as she can around the bulge your urethra makes on the underside of your " + player.cockDescript(0) + ".  Though you can't see her, the feeling of her starting to slide along your length is wonderfully pleasurable.  After a few moments you can feel her getting into it, leaning over and pressing her taut body and heavy breasts against you as well.  Incredibly turned on by the mental picture you're forced to form, you attack the cunt riding your " + player.faceDescript() + ", licking it with feverish intensity.\n\n");
			
			outputText("A sudden flow of fluids soaks your " + player.faceDescript() + " and dribbles from your chin.  The face-riding goblin bucks like a bronco, nearly breaking your nose before the strength drains from her body and she slides off into the dirt, panting weakly.  Now freed from your juicy prison, you can see the oldest daughter as she's squeezing on your " + player.cockDescript(0) + ", sliding her gash and ");
			if (daughters < 20) outputText("pert ");
			else if (daughters > 40) outputText("heavy "); 
			outputText("breasts over every part of it.");
			if (cocks == 2) outputText("  Another one of the petite sluts climbs aboard your " + player.cockDescript(1) + ", squealing happily to her sister as she joins her in riding you.");
			if (cocks > 2) {
				outputText("  A third, wearing slutty pink make-up with platinum blonde hair, lays out across your ");
				if (cocks > 3) outputText("remaining " + player.multiCockDescriptLight());
			...
			outputText(", sending a fresh surge of arousal through your " + player.multiCockDescriptLight() + ".   Another one of the girls leans down between your " + player.legs() + " licking your ");
			if (player.balls > 0) outputText("balls");
			...
			//(multiple)
				...
				if (cocks > 2) outputText("They spread out until every one of your " + player.multiCockDescriptLight() + " has at least one goblin hanging off it, stroking and touching you.  ");
				outputText("It feels heavenly, and your " + player.hipDescript() + " pump weakly into the air in an instinctive bid to enhance the sensation.");
			}
			outputText("\n\n");
			
			outputText("The goblin who served between the legs crawls back into position, and you realize she must be the youngest, and therefore the lowest on the goblin totem-pole.  Her eager tongue is just as skilled as it was minutes ago, and between her attentions and the tongues on your " + player.multiCockDescriptLight() + ", you're leaking streamers of liquid lust.  Hands run over your ");
			if (player.biggestTitSize() < 1) outputText("chest");
			else outputText(player.allBreastsDescript());
		...
		//[Tamani is There]
			...
			outputText("Tamani pulls out a ring gag, shoves it into your protesting mouth, and pulls the straps securely around the back of your neck.  She tousles your " + player.hairDescript() + " as you squirm, but the crowd of goblins easily keeps you subdued, assisting their mother now that they know her plans.   You ");
...
private function tamaniDaughtersCombatLossDrain():void {
	...
	if (cocks > 1) outputText("each of ");
	outputText("your " + player.multiCockDescriptLight() + " until it feels much harder and thicker than normal.  You stifle an involuntary groan, but fail to conceal your lust-filled pants from your audience.   A daring girl leaps onto your ");
	if (player.biggestTitSize() < 1) outputText("chest");
	else outputText(player.allBreastsDescript());
	...
	else outputText("Your body feels tight and needy, your gut clenching as your body adjusts to the drugs it's absorbing so readily through your " + player.assholeDescript() + ".");
...
private function tamanisDaughtersFillIndividuallyBADEND():void {
	...
	outputText("your " + player.multiCockDescriptLight() + " rising to full hardness in anticipation.  Your daughter pats ");
...
private function loseToDaughtersWithTamaniThere():void {
	...
	if (player.HP < 1) outputText("Lying in the dirt, too hurt to fight back, you can only tremble in anticipation of what pleasures they're going to force upon you this time.");
		...
		outputText("your trembling " + player.multiCockDescriptLight() + ", feeling it leak pre-cum in anticipation of getting to knock up some of these beautiful curvy women.");
	}
	outputText("  Tamani pushes her way to the front of the pack, her daughters looking disappointed but yielding to their mother's authority for the time being.  She walks over to you, stepping over your fallen form and uncorking a potion.  You grunt as she drops her jiggling ass down on your ");
	if (player.biggestTitSize() < 1) outputText("chest");
	else outputText(player.allBreastsDescript());
	...
	if (player.cockTotal() > 1) outputText("each of ");
	outputText("your " + player.multiCockDescriptLight() + " grows back to full erectness and trembles with desire, ready to seed a womb.  The girls ");
	...
	//(FITS)
		...
		outputText("Thankfully, the hungry goblin twat is able to devour your " + player.cockDescript(0) + " with ease.  Those pliable, fluid-slicked cunt-walls clench ever-so-tightly around you");
