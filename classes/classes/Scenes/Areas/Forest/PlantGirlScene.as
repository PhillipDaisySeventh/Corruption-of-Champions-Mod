	...
	public class PlantGirlScene extends BaseContent
	{
		...
		public function encounterPlantWoman():void {
			...
			if (flags[kFLAGS.TIMES_MET_PLANTGIRL] == 0) {
				...
				if (monster.hasStatusEffect(StatusEffects.happy) >= 0) outputText("\n\nApparently happy to see you, the feminine plant creature slowly walks toward you, assessing your demeanor and intentions.  Her candor as she approaches suggests that perhaps you two could partake in a little debauchery.  She stops " + UnitSystem.aFewFeet() + " away from you and awaits your response.");
		...
		public function plantWomanStruggle():void {
			...
			if (player.str >= 40) {
				...
				outputText("\n\nShe edges closer and stops only a few " + UnitSystem.literalInches() + " from your face, \"innocently\" glancing down at her sex, and then back up at you.  Being non-verbal doesn't hamper her means of subtlety giving you direction, bobbing her head several times towards her pelvis Shooting a sly look at you, she apparently is \"asking\" if you are going to co-operate or if she'll have to take what she wants from you.");
		...
		public function trappedPlantSexBlowMe():void {
			...
			if (player.longestCockLength() < 24) {
				...
				outputText(Appearance.multiCockDescriptLight(player) + " stare");
				if (player.cockTotal() == 1) outputText("s");
