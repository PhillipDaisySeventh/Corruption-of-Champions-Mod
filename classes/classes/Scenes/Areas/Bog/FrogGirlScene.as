...
public function findTheFrogGirl():void {
	...
	if (flags[kFLAGS.TIMES_ENCOUNTERED_FROG] == 0) {
		...
		outputText("\n\nShe smiles, a " + UnitSystem.displayFootEstimateWithHyphenTextually(3) + " tongue uncoiling from her mouth, trailing down over her flat chest, a patina of slime smearing across her torso.  With one upraised hand, she crooks a finger towards you, beckoning you closer to her pool.");
	}
	else {
...
public function analBirth():void {
	...
	outputGui.text("\n\n<b>Later, you wake up to the sound of splashing....</b>\nIn the river are a dozen tiny figures, each no more than " + UnitSystem.aFoot() + " long, and each one a mirror of the frog girl from the waist-up, but oddly featureless from the waist-down. Their lower halves ending in vaguely-finned tails, like tadpoles.");
...
public function vaginalBirth():void {
	...
	outputText("\n\n\"<i>Sorry, did we wake you up?</i>\" queries the voice of the frog girl.  You push yourself up, seeing her floating mid-stream, surrounded by a half-dozen frog girl nymphs. From the waist-up, they’re miniature versions of their mother with varying haircolors, but from the waist down, they resemble large tadpoles.  No more than " + UnitSystem.aFewFeet() + " long, they bob along next to their mother as she conducts their song.");
