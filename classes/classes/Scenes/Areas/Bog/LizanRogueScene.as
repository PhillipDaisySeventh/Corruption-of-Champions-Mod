package classes.Scenes.Areas.Bog 
{
	...
	public class LizanRogueScene extends BaseContent
	{
		...
		public function lizanIntro():void {
			...
			if (!player.isPureEnough(30)) {
				...
				if (flags[kFLAGS.MET_LIZAN_FIRST_TIME] <= 0) {
					...
					outputText("\n\nThis shows off his toned but slim chest, arms and legs covered in " + monster.skin.tone + " scales. ");
		...
		public function consensualButtfuck():void {
			...
			if (player.cocks.length == 1) { //One cock
				if (player.cocks[0].cockLength < 10) {
					...
					outputText("\n\nLike a snake his tongue slithers from his lips and begins to encircle your swollen [cock]. The long saliva dripping muscle covers your [cock] in dripping gobs of spit as it forms coils, slowly pulling your [cock] towards the lizan's obviously experienced mouth. He closes his lips around the first " + UnitSystem.displayInches(10) + " of your [cock], unable to fit anymore into his mouth. He drags his lips across your impressive [cock] with obvious relish, maybe its not often he gets to service a cock as big as yours. The combination of the rapid cooling sensation combined with the awe inspiring suction has you trembling before long.");
			...
			outputText("\n\nYour thrusts are an echoing smack against his " + monster.skin.tone + " ass as you begin fucking him with the entire length of your [cock]. Soon, your abuse of his prostate becomes too much. His rectal passage clenches tightly as his twin shafts burst, spraying dual torrents of pale cream across everywhere as you fuck him through his orgasm. His flexing tail hole and the sight of his exploding lizan dicks push you over the edge.");
		...
		public function consensualGetFucked():void {
			...
			outputText("\n\nFor a second you lie there [fullChest] against his " + monster.skin.tone + " abs. Around the two of you lies the hot glorious mess of your combined sexual fluids. Both of you are panting, both of you are satisfied. Then you push yourself off of him and collect your [armor]. He takes it upon himself to clean your [fullChest] and [vagina] with his long tongue and as soon as he is done, " + player.clothedOrNaked("you pull on your [armor]", "you recollect whatever you had") + ". Before you leave you reward him with a deep kiss, snaking your [tongue] into his mouth before heading back to camp.");
		...
		public function consensualGetButtFucked():void {
			...
			outputText(images.showImage("lizanrogue-getbuttfucked"));
		...
		public function consensualDoublePenetration():void {
			...
			outputText(images.showImage("lizanrogue-win-female"));
			if (player.looseness(false) < 2) {
