...
package classes.Scenes.Areas {
	...
	public class Desert extends BaseContent implements IExplorable {
		...
		public function wstaffEncounter():void {
			...
			outputText("A library is burning up, sending flames " + UnitSystem.dozensOfFeet() + " into the air.  It doesn't look like any of the books will survive, and most of the structure has already been consumed by the hungry flames.  The source of the inferno is curled up next to it.  It's a naga!  She's tall for a naga, at least " + UnitSystem.displayHeight2EstimateTextually(7) + " if she stands at her full height.  Her purplish-blue skin looks quite exotic, and she wears a flower in her hair.  The naga is holding a stick with a potato on the end, trying to roast the spud on the library-fire.  It doesn't seem to be going well, and the potato quickly lights up from the intense heat.\n\n");
