package classes.Scenes 
{
	...
	public class BimboProgression extends BaseContent
	{
		...
		private function debugProgress():void { 
			...
			outputText("<b>Hips</b>: " + player.hipDescript() + ", size: " + player.hips.rating + "\n");
			...
			if (player.hasVagina() ) {
				...
				if (player.hasKeyItem("Deluxe Dildo") >= 0) {
					...
					if (player.hasVirginVagina()) {
						...
						if (rand(10) == 0 || (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_DROOLING && rand(2)==0)) {
				...
				if (useDildo > 0) {
					...
					if (rand(2) == 0 && player.hips.rating < 12) {
					...
					if (rand(3) == 0 && player.hips.rating < 12) {
				...
				if (player.vaginas[0].vaginalWetness == Vagina.WETNESS_SLAVERING && useDildo > 0) {
				...
				if (rand(3) == 0) {
					...
					while (temp > 0) {
						temp--;
						if (player.vaginas[0].vaginalWetness < Vagina.WETNESS_SLAVERING) player.vaginas[temp].vaginalWetness++;
					}
				}
				...
				if (rand(4) == 0 && player.hips.rating < 12) {
