...
private function fuckBuddySheilaMeetingChatKids():void {
	...
	//if 1 < joeycount < 10
		...
		outputText("\n\nShe holds her hands " + UnitSystem.displayInchesEstimateRangeTextually(8, " or ", 10) + " apart.  When your eyebrows register surprise at that, she elaborates.  \"<i>Remember how small they come out, though... only about " + UnitSystem.displayInchesEstimateTextually(4) + " when they're born.  We tuck them in little pouches to keep them warm and up against the teat.</i>\"");
		
		outputText("\n\n" + capitalizeFirstLetter(UnitSystem.displayInchesEstimateTextually(4)) + "?  That explains how she keeps her slim figure");
		if (player.lib > 50) outputText(" and tight, hot cunt");
		outputText(" so well...  \"<i>How long does it take them to grow up?</i>\"");
		
		outputText("\n\n\"<i>Well,</i>\" Sheila says, \"<i>I dunno about yours, but two years or so is enough for purebred kids to be up and helping around the colony - they're about " + UnitSystem.displayFeetEstimateRangeTextually(3, " or ", 4) + " then.  Just basic stuff, like carrying small bags of food home from the storage for their mum or dad.  Two more years and they're basically adults... not as wise as one, of course, but they start perving and pairing off around then, no matter how much their oldies urge them not to.  Magic of hormones, world's your oyster, and all that.</i>\"");
...
private function forcedSheilaOral(dick:Boolean = true):void {
	...
	if (dick) {
		...
		if (izmaFollower() && flags[kFLAGS.IZMA_NO_COCK] == 0) outputText("; I personally know " + UnitSystem.displayInchesTextually(15) + " of fat, orange dick and four heavy balls that'd love to get in at your other end while I ride your face");
		outputText(".</i>\"");
...
private function sheilaForcedOralGeneric():void {
	...
	if (player.tongue.type > Tongue.HUMAN) player.changeFatigue(15);
...
private function normalSheilaPregNotifREPEATEDEDLetHerGo():void {
	...
	outputText("\n\nShe walks slowly with an uncharacteristic stumble; when she reaches about " + UnitSystem.displayFeetEstimateTextually(20) + ", she turns and begins walking back to you.  You stand up, expecting the other shoe to drop, but she merely nods.");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOut():void {
	...
	//(else naga)
		...
		outputText("\n\nThis is more than enough surprise for you, though.  Staring down the animals, you begin to glide slowly toward them.  Sheila tries to grab your hand again, but you're already past her, closing in on the birds even as their bodies relax.  You stop around " + UnitSystem.displayYardsEstimateTextually(15) + " away, and begin undulating your body, shaping patterns even as you hold their eyes with your own.  Your coils shift to circles, then squares, then oozy triangles, over and over, as you compel the prey with your stare.  Unable to stir hand or foot without your permission, the animals come forward as you beckon until they're sitting in front of you.");
...
private function normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE():void {
	...
	//(eight-legged freaks)
		...
		outputText("\n\nSheila nods.  You push her upright and get up, unfolding your legs with little click-clack noises.  Your companion seems alternately alarmed and fascinated as you expel long strings of silk from your abdomen, weaving them into a wide, crude sheet on the grass and gathering up the finished sections with your legs.  Once it's almost " + UnitSystem.displayFeetEstimateTextually(8) + " long, you shake it out.  It's still slightly clingy, but soft; you sit and drape your bodies with it.  \"<i>For you,</i>\" you announce grandly.");
...
private function loseToNormalSheilaAndGetRidden():void {
	...
	outputText("; you can feel every new " + UnitSystem.literalInch() + " of heat as she lowers her body.  The woman moans, gyrating her hips, and " + player.sMultiCockDesc() + " twitches in painful erectness.");
...
private function clitSwellingDemonSheilaClitSoundingAnal():void {
	...
	if (player.getClitLength() > 6) outputText(", taking it several " + UnitSystem.literalInches() + " deep");
	...
	if (player.getClitLength() <= 6) {
		...
		//[(PC corr<50)
		if (player.cor < 50) {
			outputText("her tail quakes and you feel something hot licking at the tip of your clitoris.  The spade pulls back and then sinks down again, and the heat gains several " + UnitSystem.literalInches() + "; she repeats this twice more until you can feel what must be her cum all the way down to her tail-tip, but as she attempts to pull back again and force her climax past the raw, hot skin at the edge, her tail simply jerks at your clit and she falls weakly onto the ground.");
		...
		outputText("\n\nSpent, she leans against you for several minutes, panting, then pushes herself up on wobbly legs.  Gingerly, she tugs her abused tail free of your enormous clit, then winces and puts her hand on her stomach as backed-up fluid oozes heavily from the spade.  \"<i>Ugh, feel like I'm gonna chunder.  Mate, I'll see you later.</i>\"  She turns and departs queasily, leaving a trail of black slime behind her.  As you slip into a doze, you wonder if your slowly dwindling clitoris will have returned to normal by the time you wake up.  For the most part it does, though it maintains at least " + UnitSystem.anInch() + " of the extra length.");
	}
	//(else if clit >6" initially)
	else {
		outputText("\n\nShe pulls her tail free of your clit, watching nervously as the coating of dark oil left behind is absorbed into the skin and it widens another " + UnitSystem.halfInch() + ".  Sheila turns uncertain eyes on you and speaks again.  \"<i>Eh-heh.  Even as a woman, it looks like you're too much of a man for my little hole.</i>\"  She plays with her nipples idly, watching as your breathing causes the abnormally elongated skin to bob in the warm air, then leans down and blows on it with a grin; you squirm, raising a giggle from her.  \"<i>I could just jerk you off like any old cock... would you like that?</i>\"  The demon caresses you with her hand and considers a bit.  \"<i>Ahh, no good.  I'm horny too, after having you inside me.  But this absurd thing... oh, I know.</i>\"");
		//Picture is here
		outputText(images.showImage("sheila-corrupted-anal"));
		outputText("\n\nYou stare at Sheila as she turns around");
		//[(horse)
		if (player.isTaur()) outputText(" and rolls onto her back");
		outputText(", then wraps her tails around your thickened clit.  They twist and pull, sending spirals of pleasure along the numerous nerves, and begin gently but insistently tugging you toward her tan butt.  Sheila directs the tip right between her cheeks, and you can feel her using it to rub the ring around her hole.  \"<i>I think this should be about the right size for you, love,</i>\" she teases, spearing herself on your " + player.clitDescript() + ".  " + capitalizeFirstLetter(UnitSystem.literalInch()) + " after " + UnitSystem.literalInch() + " slides into her slowly, maddening you with warmth, until ");
		...
		outputText("the ground next to your ass, and uses the leverage to begin pumping your clit out of and into her asshole, caressing your " + player.vaginaDescript(0) + " every time she slides home.  \"<i>I could get used to this, love.  What say I keep you dosed up like this and you become my dildo?  I'll ride you with a different hole every time!</i>\"  Your eyes roll back in your head, at least partially from the irregular pace at which she's stroking your clit.  Sheila grabs her breasts as she slows down drastically once again, mashing them with her hands and sinking onto you " + UnitSystem.literalAnInch() + " at a time.  \"<i>Fuck... I love your junk, [name].  Maybe I should catch a goblin, too, and make her tease my pussy while you fill my ass.</i>\"  She raises back up and ");
		//[(clit>12")
...
private function missionaryForThePurposesOfCreatingImpsWithSheila():void {
	...
	outputText("\n\nSheila pulls you down gently and a warmth envelops your [cockHeadFit 56] as it nudges past her inflamed labia.  Her command rings in your ears, and coupled with the sensation, it's as much as you can do to slip in at your own pace and enjoy yourself instead of obeying her every word.  " + capitalizeFirstLetter(UnitSystem.literalInch()) + " by " + UnitSystem.literalInch() + " you slide yourself into her pussy as she bites her lip impatiently.  \"<i>You're such a tease, [name].  You know how much I want you in me, and you make me wait for it every time.</i>\"  You begin pumping her slowly; her back arches ");
	//(sheila corruption >=40)
...
private function bigDickAndThighs():void {
	...
	//(else corr >= 40)
		...
		outputText("\n\nPfft.  You angle your [cock biggest] toward her vagina and thrust, heedless of the woman's pleasure.  She tries to focus and spread her pussy open; indeed you can see it widen several " + UnitSystem.literalInches() + " before you mercilessly slam your [cockHead biggest] into it.  Sheila gasps, then grits her teeth as you batter her entrance, demanding entry but being denied at each push.");
