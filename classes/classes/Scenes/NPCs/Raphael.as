...
private function meetRaphael():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-talk"));
...
private function RaphaelFirstMeetingSLAP():void {
	clearOutput();
	//Picture is here
	outputText(images.showImage("raphael-slap"));
...
private function RaphaelFirstMeetingSWOON():void {
	clearOutput();
	//Picture is here
	outputText(images.showImage("raphael-swoon"));
...
private function rapeRaphael():void {
	...
	//Picture is here
	outputText(images.showImage("raphael"));
	...
	flags[kFLAGS.REJECTED_RAPHAEL] = 1;
	//Picture is here
	outputText(images.showImage("item-rRapier"));
...
private function RaphaelDressPtII():void {
	...
	//Picture is here
	outputText(images.showImage("item-rBdyst"));
...
private function RaphaelEncounterIIDressFollowup():void {
	...
	//({If player does not meet the first encounter requirements:}
		...
		//({If female player has gotten smaller than 4 feet}
		if (player.tallness < 48) outputText("Raphael squints like he has trouble seeing you from there, because of your diminutive size. \"<i>I've dated goblins once... didn't work out.</i>\"\n\n"); 
		//({If player has grown ANY cock and balls}
		...
		outputText("The fox looks disappointed. \"<i>Beauty is in the eye of the beholder, but it certainly isn't gracing mine right now.  señorita... or what remains of you, please clean yourself up. Meanwhile, I just remembered: I have a sick mother to take care of. I hope you'll excuse me!</i>\" he mentions before hopping back of the wall and making a hasty retreat.\n\n");
...
private function RaphaelChooseFrisk():void {
	...
	outputText("Noticing how Raphael leaves more room between his hands and his head than necessary, you reach behind his neck to retrieve the pilfered pendant, but when you do, there is none to be found. It's the only place he could have put it, but it's gone and he isn't using his arms!\n\n");
...
private function RaphaelPicnic():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-picnic"));
...
private function RaphaelPicnicSkill():void {
	...
	if (player.spe < 30 || flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
		...
		//Picture is here
		outputText(images.showImage("raphael-dancin"));
	...
	//{Fencing practice variables: Speed 40-49, Must play out at least once}
		...
		//Picture is here
		outputText(images.showImage("raphael-hug"));
...
private function fenceRaphaelSexily():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-fence"));
...
private function RaphaelPostFenceSex():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-sex-woods"));
...
private function QuiksilverFawkesPtII():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-chase"));
	...
	outputText("Your heart jumps as Hati manages to discover a pile of Raphael's clothes, near the barrel.  It's irrefutable proof.  Raphael must have put them there to throw the wolves off.  Hati gives you a look of disappointment.  <i>\"He's nude. They must have slept together.\"</i>");
...
private function kissRaphaelFirstTimeOrphanage():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-sex-home"));
...
private function cunnilingusWithRaphael():void {
	...
	//Picture is here
	outputText(images.showImage("raphael-sex-cunny"));
	outputText("\n\nWith his paws, Raphael raises up your butt and crotch just a few " + UnitSystem.literalInches() + " into the air, as if elevating it for a special occasion.  It encourages you to bend your knees and spread your legs, opening yourself up and presenting your womanhood fully.  Lacking all shame and still looking you into the eyes, the fox then does the lewdest thing.  Maintaining eye contact and without blinking, he rolls out his long red tongue and brushes it against your " + player.vaginaDescript(0) + ".  The sensation of the bawdy rough thing lapping up your sensitive gash's gathered dew takes you completely by surprise and you let your head fall back and moan.  It feels like he's worshipping you by lapping through the trembling fruit.  At the very zenith of his lashes, he takes extra time to twirl around your " + player.clitDescript() + " in a vortex of swirling tastebuds.");
