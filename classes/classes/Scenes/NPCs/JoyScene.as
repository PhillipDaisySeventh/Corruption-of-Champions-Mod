package classes.Scenes.NPCs 
{
	...
	public class JoyScene extends NPCAwareContent
	{
		...
		private function joysAppearance():void {
			...
			if (joyHasCock() && joySexCounter() > 0) outputText("\n\nFrom previous experience you can estimate she has a " + UnitSystem.displayInches(joyCockLength(), 1) + " long and " + UnitSystem.displayInches(joyCockGirth(), 1) + " thick dick. It looks surprisingly human, right underneath that, she has a pair of gonads that are about " + UnitSystem.displayInchesEstimate(joyBallSize()) + " in diameter each.");
			outputText("\n\nBetween her legs sits a " + joyPussyDescript() + ". Beads of lubricant occasionally form on her pink nether lips.");
			outputText("\n\nBetween her squeezable jiggly bums she has " + joyAssDescript() + ", where it belongs.");
			doNext(genericMenu);
		}
		...
		private function reductoJoysCock():void {
			...
			if (flags[kFLAGS.JOY_COCK_SIZE] < 5.5) {
				...
				outputText("\n\n\Her cock begins to shrink until it has lost " + UnitSystem.anInch() + ". \"<i>My funstick is, like, smaller! Think you can handle my size better?</i>\" Joy asks in a teasing manner.");
		...
		private function frotWithJoy():void {
			...
			outputText("\n\nJoy moans and kisses you again, thrusting her tongue hungrily into your mouth and thrusting her hips strongly, grinding her " + UnitSystem.displayInchWithHyphen(joyCockLength(), 1) + " cock against your own " + player.cockDescript() + ".");
		...
		private function haveJoyStuffYourButthole():void {
			...
			outputText("\n\nJoy almost seems about to faint onto your back, pressing her " + joyBreastDescript() + " heavily against you, but manages to muster the strength to pull out of you and crawl " + UnitSystem.aFoot() + " or so away before collapsing, gasping for breath.");
