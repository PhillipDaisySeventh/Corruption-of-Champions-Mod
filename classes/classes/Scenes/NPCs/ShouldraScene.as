...
//const GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER:int = 510;
		...
		public function timeChange():Boolean
		{
			...
			if (shouldraFollower.followerShouldra()) {
				...
				if (flags[kFLAGS.SHOULDRA_PLOT_COUNTDOWN] > 0 && getGame().time.hours == 3) flags[kFLAGS.SHOULDRA_PLOT_COUNTDOWN]--;
			}
			return needNext;
		}
	
		public function timeChangeLarge():Boolean {
			if (shouldraFollower.followerShouldra() && flags[kFLAGS.SHOULDRA_PLOT_COUNTDOWN] == 0 && getGame().time.hours == 3) {
				flags[kFLAGS.SHOULDRA_PLOT_COUNTDOWN] = -1;
				shouldraFollower.shouldraDream1();
				return true;
			}
			//Ghostgirl recruitment priority
			if (flags[kFLAGS.SHOULDRA_FOLLOWER_STATE] == .5 && getGame().time.hours == 6) {
				getGame().shouldraFollower.morningShouldraAlert();
				return true;
			}
			//Ghostgirl pissed off dreams
			if (shouldraFollower.followerShouldra() && flags[kFLAGS.SHOULDRA_SLEEP_TIMER] <= -236 && getGame().time.hours == 3 && player.gender > 0 && !prison.inPrison) {
				getGame().shouldraFollower.nightTimeShouldraRapesThePC();
				return true;
			}
			//Ghostgirl madness
			if (flags[kFLAGS.SHOULDRA_PALADIN_MAIDEN_COUNTDOWN] > 0) {
				if (player.cockTotal() > 1 || player.face.type != Face.HUMAN || player.lowerBody.type != LowerBody.HUMAN || player.tail.type > Tail.NONE || player.horns.value > 0 || !player.isPureEnough(15) || player.longestCockLength() > 10 || player.tallness < 65 || player.tallness > 78 || player.hasVagina())
...
public function shouldraGreeting():void {
	...
	if (flags[kFLAGS.TIMES_MET_SHOULDRA] < 3) {
		...
		outputText("Finally, she acknowledges your readiness to fight. With a sigh and a shrug, she raises her arms and drops into an orthodox boxing stance. Once again, you heft your " + player.weaponName + ".");
...
private function nowOnVickiLake():void {
	...
	outputText("Which encounter would you wish to seek out?");
	menu();
...
private function sharkbustersVictory():void {
	...
	if (player.biggestTitSize() >= 1) outputText(", " + player.allBreastsDescript() + " squishing and squashing against her own barely-clad bosom");
...
private function sharkyEctoginas():void {
	...
	outputText("You set your jaw and go at your work with fervor, caressing, groping, and licking every " + UnitSystem.literalInch() + " of her that you can reach, taking note of the increased frequency of her gasps and groans. As if to reward your efforts, the girl reaches down and lines up her pinky with your own neglected snatch, and before you know it, you're suddenly being stretched");
...
private function ghostIzmaPenis():void {
	spriteSelect(SpriteDb.s_ghostGirl2);
	clearOutput();
	outputText("You swiftly disrobe and lay your " + player.armorName + " to the side, revealing your stiffening " + player.multiCockDescriptLight() + " in all of its glory. The ghost-girl's eyes brighten at the sight, and she even allows herself a little swoon (which looks absolutely silly, given her current tough shark-like vessel) as she regards your manhood.  ");
	outputText("She staggers forward, dropping to her knees in front of you");
	//[if testicles present] 
	if (player.balls > 0) outputText(" and cradling your " + player.ballsDescriptLight() + " with almost reverent gentleness, running her coarse shark-skinned fingers across your sack as gently as she can manage");
	outputText(".\n\n");
	
	outputText("She lifts her chin and slides her tongue across the bottom of your cockhead, stimulating it wonderfully and making you involuntarily tense in anticipation. With a wide-eyed grin promising nothing but pleasure, she steers you softly towards the boat, and you comply, stepping aboard the beached vessel and stretching yourself across its deck, the shark-ghost in close pursuit. She leans down, thin lips forming an 'O' as she closes in on your cock. Her plans change, however, when she gets poked on the cheek with your head... a tip that's suddenly at least " + UnitSystem.displayInchesEstimateTextually(6) + " farther away from your hips than it should be. You fix a concerned gaze upon the ghost-girl, ");
	//[if first time]
...
private function slimeGinaFlation():void {
	...
	outputText("You continue shaping your creation until finally releasing it and rising to scrutinize your creation. You seem to have successfully molded an " + UnitSystem.displayInchWithHyphenTextually(8) + " long slime protrusion.  Giving it a little flick that sends a shiver through the ghost girl's gooey host, you confirm its solidity with a grin. The ghost girl offers a low moan as you climb up onto the green slime and aim yourself above your phallic creation. Although you think to tease the girl a little bit by hovering over her makeshift phallus, she's clearly not in the mood for foreplay. The quivering mass thrusts itself upwards at you, and you're neatly impaled by all " + UnitSystem.displayInchesTextually(8) + " straight off. Her slime, however, will not stop there, and the goo returns to its semi-solid state... in your " + player.vaginaDescript(0) + ". You bite your lower lip as you feel the ooze pressing tightly against your tunnel. The malleable mush squeezes past your cervix and quickly fills your womb tight. Her redistribution of volume compromises your balance, and you slip. Your " + player.buttDescript() + " slaps against the slime, right above the ghost girl's face; ");
	...
	else outputText("Your frame is jostled about as the slime under you shrinks, your goo-filled gut pushing your " + player.allBreastsDescript() + " up into your overburdened jaw.");
	outputText("\n\n");
	...
	else if (player.tail.type == Tail.NONE) outputText("arms and " + player.legs());
	...
	if (player.biggestTitSize() < 1) outputText("see your " + player.nippleDescript(0) + " wiggling sporadically.");
	else outputText("see your " + player.allBreastsDescript() + " trembling, " + player.nippleDescript(0) + " twitching eagerly.");
...
private function slimeyPenorsAhoy():void {
	...
	if (player.balls > 0) outputText("Your " + player.legs() + " are forced apart by your burgeoning cum-sack");
...
private function penisLossThatIsntALoss():void {
	...
	if (player.inte < 50) outputText("It's not very hard for her to break down your fortifications, and you soon feel yourself being pushed aside by her vast mental capacity.");
		...
		outputText("You don't even give her the chance to act of her own volition, simply reaching out, taking ahold of her head, and slamming her onto your " + player.cockDescript(x) + ".  She takes it surprisingly well, unsurprisingly easily, taking most of the shaft in the first thrust alone.  With not as much as even a sputter, she impatiently double-handedly grabs your " + player.buttDescript() + " and thrusts her head forward.  Before you know it, your entire " + player.cockDescript(x) + " is wrapped in a fleshy tunnel of love.");
...
private function ghostBJFinisher(inside:Boolean):void {
	...
	outputText("Like a backed up geyser, your gigantic testicles push hot, thick strands of seed out of your belaboured " + player.cockDescript(x) + " straight up in the air.  The cum splatters on both you and the ");
...
private function ghostGinaWinSexings():void {
	...
	outputText("You awake some time later in a prodigious puddle of girly spunk. Your attempt to sit up is impeded by a clunk against the ground.  A clunk? You prop yourself up on your elbows and glance down to see a large metal pipe, stuck in your vagina presumably some time during your black-out. Reaching down, you extricate a full " + UnitSystem.displayInchesTextually(10) + " of piping from your cunt, and shake your head at the tenacity of your unworldly bodily invader. You are happy to feel a tightening in your crotch, however, as the magic finally wears off, returning your womanliness to a " + player.vaginaDescript(0) + ". You also note the absence of your gigantic clitoris, and give yourself a little stroke to confirm; it's reverted to normal size as well. All's well that ends well, you suppose.\n\n");
	outputText("Her pleasure dealt with, the ghost girl appears head-first from your belly, flowing out and reconstituting herself into the normal, brown-eyed girl you first encountered.  Almost as an afterthought, she smiles, moving to her clothing and swiftly dressing, then gives you a little wave before wandering away, rounding a corner and disappearing from sight. You resolve to find her again- her magic was pretty fun!");
...
private function hermaphroditeGhostsCumEctoplasm():void {
	...
	if (player.balls > 0) outputText("Stopping her double-handed stroke technique, she slips your hand under your obtrusive " + player.ballsDescriptLight() + " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ");
...
internal function loseToShouldra():void {
	...
	outputText("Wondering what the point of that was, you raise your head and glance up at her face, now at least " + UnitSystem.displayInchesEstimateTextually(4) + " higher that she just was. She reaches down and gives your ");
...
private function ghostGinaLosses():void {
	...
	outputText("Against your will, and against all of your better instincts, the ghost-girl, as aroused as you are uncomfortable, moves both hands to your sex, gripping it and giving it a squeeze. Your entire body locks up, causing you to fall backwards onto the pavement as a devastating orgasm rocks through your system. A strangled cry is the only reaction you can give to the explosive sensations. The ghost-girl, however, not satisfied with the suddenness of the climax, begins feverishly stroking your clitoris with one hand, the other reaching into your love-tunnel and stimulating the rosy flesh inside. You arch your back and attempt to dig small holes into the road with your " + player.feet() + " as shock-waves run through your system over and over, never giving you a chance to recuperate. You hear, as if from a great distance, a mix of frenzied laughter and orgasmic cries of pleasure ringing inside your head. Finally, mercifully, you fade into unconsciousness, leaving the ghost girl to her constant stimulation.\n\n");
	outputText("You awake some time later in a prodigious puddle of girly spunk and attempt to slowly sit up, only to be impeded by a clunk against the ground.  A clunk?  You prop yourself up on your elbows and glance down to see a large metal pipe, stuck in your vagina presumably some time during your black-out. Reaching down, you extricate a full " + UnitSystem.displayInchesTextually(10) + " of piping from your cunt, and shake your head at the tenacity of your unworldly bodily invader. You are happy to feel a tightening in your crotch, however, as the magic finally wears off, returning your womanhood back to a " + player.vaginaDescript(0) + ". You also note the absence of your gigantic clitoris, and give yourself a little stroke to confirm; it's reverted to normal size as well. All's well that ends well, you suppose.\n\n");
...
private function genderlessShouldrasLossRapes():void {
	...
	outputText("when she reaches in and rummages about, producing two " + UnitSystem.displayInchWithHyphenTextually(8) + " vibrators with bumpy demon-shafts. She moves back to the center of the room, launching into a short spell as she goes. She sets the dildos on the same nightstand and opens the carton, pulling out four large white eggs.\n\n");
	...
	else outputText("your " + player.allBreastsDescript() + " swells slightly to make room for a sudden increase in milk production.");
	outputText("  As the ghost continues darting around the room, ");
	if (player.biggestTitSize() <= 8) outputText("your new EE-cup breasts settle");
...
public function paladinModeFollowup():void {
	...
	if (getGame().time.hours < 6 || getGame().time.hours >= 23) outputText("\n\nYou rage fap and consider going back to bed.");
	player.orgasm('Dick');
	doNext(playerMenu);
}
...
private function slimeGhostGalForHerms(clearOut:Boolean = false):void {
	...
	if (getGame().time.hours < 11) outputText("morning");
	else if (getGame().time.hours < 17) outputText("afternoon");
