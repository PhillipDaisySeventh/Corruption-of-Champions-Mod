...
public function urtaFuckHer(afterBefriending:Boolean = false):void {
	...
	if (player.totalCocks() == 0) {
		...
		if (player.tail.type == Tail.HORSE || player.tail.type == Tail.DOG) outputText("swishing your tail across her taut nipples");
...
internal function blowUrtaUnderTable():void {
	...
	outputText(" as it begins to soften.  You wipe as much of her leavings from your " + player.faceDescript() + " as you can, licking the slippery glaze from your lips.  Before you get up, you make sure to give Urta's member a firm squeeze, punishment for forcing you to take her so deep.\n\n");
...
public function eatUrtaOutNomNomPussy():void {
	...
	outputText("Finished at last, Urta's member rapidly deflates, the scent of her cum on your " + player.hairDescript() + " and her juice on your " + player.faceDescript() + " lingers.  You slide up into the booth next to your blissed out lover.");
...
public function blowUrtaUnderTheTableLuv():void {
	...
	outputText(" as it begins to soften.  You wipe as much of her leavings from your " + player.faceDescript() + " as you can, licking the slippery glaze from your lips.  Before you get up, you make sure to give Urta's member a firm squeeze, scolding it for its forceful treatment of your mouth.\n\n");
...
private function rideUrtaInButtAtHomeLove():void {
	...
	outputText("While giving her a knowing smile, you make a conscious attempt to relax your body's surprised rear-entrance.  Almost immediately you feel her slip inside, and then you're sliding down, sinking slowly towards your partner " + UnitSystem.literalAnInch() + " at a time.  The expression on Urta's face is priceless – flitting between ecstasy and confusion as she struggles to deal with being engulfed by your ");
	...
	if (player.gender == 2 || (player.gender == 3 && rand(2) == 0)) {
		...
		if (player.totalCocks() > 0) {
			...
			if (player.cumQ() < 50) outputText("sputtering spunk onto Urta's neck.");
				...
				if (player.cumQ() > 10000) outputText("  The puddle thickens as you cum until it's nearly " + UnitSystem.aFoot() + " deep.");
			}
		}
		outputText("\n\n");
		...
		outputText("The fox giggles and returns to cuddling and licking you.  You rest with a happy smile plastered on your " + player.faceDescript() + " from the experience.  After all the snuggling, you both rise and get dressed.  Urta finds a new dress in the closet and with a long goodbye kiss, you go your separate ways.\n\n");
		doNext(camp.returnToCampUseOneHour);
		player.orgasm('Vaginal');
		dynStats("sen", -1);
		return;
...
private function urtasCoochiNeedsFuckedLove():void {
	...
	outputText(images.showImage("urta-home-male-fuck"));
	outputText("You push forwards, slowly sliding into the moist tunnel, feeling its warmth covering every " + UnitSystem.literalInch() + " of your " + player.cockDescript(largestUsableCockIndex) + ". It caresses and squeezes you, surrounding you in perfect pleasure.  Urta stretches out languidly, her engorged horse-cock flopping down between her sizable breasts as it reaches a twitching, trembling hardness.  You bottom out, feeling the ");
	...
	outputText("Unthinking, your " + player.hipDescript() + " begin to rock back and forth, sawing in and out of the fox's exotic pussy.  She wriggles and moans happily, losing her grip on her weighty balls and letting them slide over the top-side of your pussy-slicked " + getPlayerCockNoun(largestUsableCockIndex) + " with each movement.  You ignore it, increasing the tempo and watching as your lover's jiggling breasts shift and bounce around her flared penis, eliciting uncontrolled gasps of pleasure and causing pre to form a bubble at the tip of her latex cock-sheath.  Every thrust is met by a visible bulging of Urta's urethra and an increase in the size of the balloon hanging from her dick's flare.\n\n");
	...
	if (player.hasKnot(largestUsableCockIndex)) {
		...
		if (player.cumQ() < 250) {}
		...
		else if (player.cumQ() < 1000) outputText("Her belly swells larger and larger as you continue to pump your seemingly endless seed into her.  Urta groans, looking a few months pregnant by the time your overproductive " + getPlayerCockNoun(largestUsableCockIndex) + " stops spewing inside her.  ");
		else {
			...
			if (player.cumQ() < 3000) outputText("By the time you finish, she looks VERY pregnant and is moaning with a mixture of pleasure and discomfort.  ");
				...
				if (player.cumQ() > 5000) outputText("Not content with such an easy release, your " + player.cockDescript(largestUsableCockIndex) + " unloads the last of its cream until the bed and floor are both covered under " + UnitSystem.literalInches() + " of your canine cum.  ");
			}
		}
		outputText("You finally feel your " + getPlayerCockNoun(largestUsableCockIndex) + "'s knot shrinking and pull free with a loud and messy pop.  ");
	...
	//[HORSE]
		...
		if (player.cumQ() < 250) {}
		...
		else if (player.cumQ() < 1000) outputText("Her belly swells larger and larger as you continue to pump your seemingly endless seed into her.  Urta groans, looking a few months pregnant by the time your over-productive " + getPlayerCockNoun(largestUsableCockIndex) + " has finished spewing your seed inside her.  ");
		else {
			...
			if (player.cumQ() > 5000) outputText("Not content with such an easy release, your " + player.cockDescript(largestUsableCockIndex) + " unloads the last of its cream until the bed and floor are covered in several " + UnitSystem.literalInches() + " of thick equine cum.  ");
		}
	...
	//[Everybody Else]
		...
		if (player.cumQ() < 250) {}
			...
			if (player.cumQ() > 5000) outputText("Not content with such an easy release, your " + player.cockDescript(0) + " unloads the last of its cream until the bed and floor are both covered under " + UnitSystem.literalInches() + " of your gooey cum.  ");
		}
		outputText("You finally feel your " + getPlayerCockNoun(largestUsableCockIndex) + " deflating, and you pull free with a messy slurp.  ");
		if (player.cumQ() >= 2000) outputText("Spunk rushes out in a torrent, splattering everywhere.  ");
		outputText("Urta's glazed pussy-lips clench reflexively at their sudden emptiness and you hear a very satisfied sigh from the far end of the bed.\n\n");
	}
	//[RESUME]
	outputText("Urta calms down at last, though her member is still throbbing weakly as she peels her condom off.  The bloated cum-bubble at the tip is the size of a basketball, and she struggles to get it tied off and disposed of.  The fox tosses it into a waste-basket already full of the things and gives you a toothy smile, \"<i>I think somebody's " + getPlayerCockNoun(largestUsableCockIndex) + " loves my pussy almost as much as I love you!</i>\"\n\n");
...
private function fuckUrtaWhileScyllaSucksSober():void {
	...
	outputText("\n\nThe nun jumps up and hugs the exhausted fox tight.  Then, blushing, she quickly changes into a fresh habit and flounces out the door, taking the old, soaked one with her, perhaps for a snack.  Urta grumbles, \"<i>Go on, it's mostly my mess, so I suppose I ought to pay for the clean up.</i>\"  She props herself against a box as her equine member spontaneously gains a few " + UnitSystem.literalInches() + ", dripping fresh drops of pre.  Her balls seem to be back to normal too.");
...
private function dockWithUrtaUnderScyllasSoberSupervision():void {
	...
	outputText("  Scylla's eyes glow black as she reaches for the guardswoman, but she's too far away to even catch the fleeing fox's tail.  An inexplicable black radiance glows from the holy woman-turned-succubus's eyes, and miraculously, Urta is lifted clear of the floor, her legs flailing uselessly.  She flies back to the corner of the room and lands in a confused pile, less than " + UnitSystem.aFoot() + " from your carriage-sized erection.");
	...
	outputText(".  The titanic, room-filling cock lifts up off the ground by a few " + UnitSystem.literalInches() + ", supported by the thick bulge of cum that rushes from ");
	if (player.hasSheath()) outputText("sheath");
	else outputText("base");
...
private function watchTwoHotBitchesAndJerkIt():void {
	...
	outputText("You open your " + player.armorName + " and sit down on a crate no more than " + UnitSystem.aFewFeet() + " away from the orally fixated couple, fishing out " + player.sMultiCockDesc());
	if (player.hasVagina()) outputText(" and exposing your " + player.vaginaDescript(0));
	outputText(".  The nun's trademark demonic stubs commence sprouting, parting her hair until they rise up at least " + UnitSystem.displayInchesEstimateTextually(6) + " from her forehead.  Meanwhile the poor, sexually frustrated vixen's balls are swelling up like balloons in Scylla's hands, growing so large that the fox's sack sags around the larger woman's hands.  The curly-haired oral slut tries to fellate and support Urta's growing size at the same time, and definitely appears to be struggling with it.\n\n");
	...
	if (player.cumQ() >= 1000) {
		...
		if (player.cumQ() >= 2000) outputText(UnitSystem.display("n", "") + " " + UnitSystem.literalInches() + "-deep");
...
private function makeUrtaSitOnYourLapWithScylla():void {
	...
	if (player.lowerBody.type == LowerBody.NAGA) outputText(", snaking your tail around her legs");
	else if (player.lowerBody.type == LowerBody.GOO) outputText(", enveloping her legs with your goo");
...
internal function spankTheShitOutOfUrtaAndMakeHerCreamHerselfFromProstateStimulationAloneLikeTheHornyDrunkenSlutSheReallyIs():void {
	...
	//{PC Don't Got the Dick but Do Got a Tamani Dildo Which is Almost as Good!}
		...
		outputText("\n\n\"<i>Wh-whaaaa!?</i>\" she shrieks, squirming violently - though you can feel her dick start to squirt pre at the merest " + UnitSystem.literalInches() + " in her ass.  Gripping the table, you give her superior posterior another brutal smack, and though Urta yelps and clenches, your pink toy slides right into her in the wake of your spank.  Urta squeals as the dildo sinks further into her butthole, until just the flared back remains, pressed tightly between her reddened cheeks.  You grin as you feel her hard prick tensing more and more with every " + UnitSystem.literalInch() + ", until a large puddle of pre is forming under your [feet].");
		outputText("\n\nNow that you've got something nice and hard wedged up her ass, you rear back and give Urta another series of quick, light spanks, working her ass over a dozen times.  She pants, groaning as her ass clenches hard around the toy inside her, trying desperately to force it out.  You just push it right back in, sinking " + UnitSystem.anInch() + " into her again before giving her one good, hard spank on her swollen asscheeks.  Urta cries out, clenching down so hard she almost pushes the dildo right out - but you catch it, and slide it back in, slowly and surely, making sure to work it into her colon nice and tight.");
...
private function pegUrtasAssMessy():void {
	...
	outputText(player.cockDescript(x) + " down onto the sheets, a scant few " + UnitSystem.literalInches() + " from Urta's puckered asshole.  The fox ");
	...
	outputText(" strokes a padded fingertip down the bulging length of her urethra, shivering when it bumps across the sensitive medial ring.  A few " + UnitSystem.literalInches() + " in, you feel a rounded bulge bump into you, and as soon as you press against it, Urta's cock lifts up and thickens, flooded with blood.  The fox trembles for a second as you glide by the obstruction, and without any warning at all, her shaft belches a thick spurt of clear pre-cum with enough force to glaze the underside of her tits.");
	...
	if (player.cumQ() < 250) outputText(", swallowing with a smile and a wink.");
		...
		if (player.cumQ() > 3000) {
			...
			if (player.cumQ() > 10000) outputText("first few " + UnitSystem.literalFeet() + " of the ");
...
private function fillMeUpPleaseUrta():void {
	...
	outputText("\n\nGingerly holding the beast between her thighs, you take a moment to admire the texture, the forgiving sponginess of the stiffening flesh and its smooth surface, broken only by a collection of pulsating veins and a thick ring that splits the middle.  You squeeze the musky fur of her snatch and pull it down, revealing another " + UnitSystem.display("inch or two", UnitSystem.displayInchesRangeTextually(1, " or ", 2)) + " of moist dick for you to tease; Urta shivers at your touches on her sensitive flesh.  Looking up to meet her gaze, you bend down with glacial slowness, eventually laying the flat of your ");
	...
	if (player.vaginas[0].virgin) {
		...
		outputText("\n\nThe vixen sits bolt upright, her face just " + UnitSystem.literalInches() + " from your ");
		...
		outputText("\n\nTo you, the situation is almost painful, but you soldier on, determined to give the affectionate herm your maidenhead.  You squat lower, tearing something as you take the first few " + UnitSystem.literalInches() + " into your nethers.  It hurts, and there's a little blood, but as more and more of that shaft is sheathed in your sensitive slit, it begins to feel better and better, exquisitely pleasurable.");
...
internal function slurpFawkesCocksForFunAndInflation():void {
	...
	outputText("\n\nYou begin to lose count, begging the gods not to let your belly burst as it crosses its " + UnitSystem.display("fifth", "tenth") + " new " + UnitSystem.literalInch() + " of bloated liquid.  Urta slides out of your throat, forcing you to swallow the cloying jism it leaves behind.  Of course, as full as you are, you can't keep up, making some of it begin to run out the corners of your mouth and down your swelling form.  Eventually, she subsides, dribbling her last over your tongue.  Unable to swallow any more, it streams out, pooling between your [legs].");
...
private function raphaelAndUrtaPartTwo():void {
	...
	if (player.tail.type > Tail.NONE) outputText("lift your tails and ");
...
private function urtaGooTesticleVoreRuinedOrgasms():void {
	...
	outputText("\n\nUrta's orgasmic cry is cut short and a look of frustration appears on her face.  As turned on as she is right now, she's not going to get any satisfaction with you lodged inside of her.  The hot cum bubbles and presses against your fingers, so you widen the plug, which only serves to turn Urta on even more.  Eventually the ruined orgasm begins to recede, and with it comes a wave of suction.  You relax your goo fingers, allowing them to be sucked further down into the " + UnitSystem.displayInchWithHyphenTextually(16) + " column of cock.  A fourth finger disappears with this sudden pull, followed by your thumb.");
...
private function wearZeCollar():void {
	...
	//Second Time
		...
		if (player.tail.type > Tail.NONE) outputText(", tail wagging");
	...
	if (player.tail.type == Tail.NONE) {
		...
		if (player.tail.type == Tail.NONE && player.ass.analWetness > 0) outputText("  Despite your embarrassment, or perhaps because of it, you find your asshole getting wet with desire, practically salivating in anticipation of that thick plug.");
...
private function doggyStyle():void {
	...
	if (player.tail.type == Tail.NONE) outputText(", while she grasps the plug in your ass firmly and pulls. It comes out easily with a wet <b>pop</b>, making your ass feel suddenly empty.  You guess it won't be empty for long, however");
	...
	outputText("\n\nThat seems to be all the encouragement she needs, and, grasping your hips roughly, she sinks several " + UnitSystem.literalInches() + " of her torrid tool directly into your aching, needy ass.  The two of you let out loud, slutty moans in unison.  You find your upper body sinking to the floor, ");
	if (player.biggestTitSize() <= 5) outputText("resting on your folded arms");
	else outputText("resting on your enormous boobs");
	outputText(", while your ass remains high in the air, all the better to be fucked by your hermaphroditic Owner.  Urta pulls out a few " + UnitSystem.literalInches() + " just to push in even deeper, and the feeling is exquisite as, with each thrust, you get the sensation of being filled just a little bit more.  By the time her large balls slap into your ");
	if (player.balls > 0) outputText("own");
	else if (player.hasCock()) outputText("painfully erect member");
	else outputText("slit");
	outputText(", you are overwhelmed by the full, content feeling.  Your eyes roll back in their sockets, and it's hard to focus on anything but the " + UnitSystem.displayInchEstimateWithHyphenTextually(20) + " dick buried in your sensitive ");
...
private function getAPetReward():void {
	...
	outputText(".  Your Owner stretches " + UnitSystem.aFoot() + " out towards you, running her stocking-clad paw along your side.  The little tufts of fur protruding from the fishnet tickle your skin in a sensual fashion, and you can't stop your spine from stiffening at the contact.");
	...
	outputText(".  Urta shivers and lets out a \"<i>Mm,</i>\" while her pillar of horsecock reaches its full size, clocking in at what has to be a good " + UnitSystem.displayInchesEstimateTextually(20) + ".  ");
...
private function urtaTakesPCOnWalkies():void {
	...
	if (player.tail.type  > 0) outputText("tail");
	else outputText("tailplug");
	...
	private function vixenAndCreamPart2():void {
		...
		outputText("Trying to stifle her cries, Urta reaches up and bites down on one of her fingers. You give a little grin and know that you have her on the ropes, just " + UnitSystem.literalInches() + " away from crying out.");
	...
	private function vixenAndCreamPart4():void {
		...
		outputText("\n\nIt's a dizzying scent that immediately arouses your hunger, causing your manhood to ache with mating need. Seizing her thighs, you run your [tongue] along her glistening black lips, caressing every " + UnitSystem.literalInch() + ". Your mouth is immediately rewarded with the succulent flavor of her arousal, tasting its proof on your tongue. ");
		...
		outputText("\n\nAs if to find another place to escape, she suddenly squirts and sprays your face with her warm girl juice. She marks your " + player.faceDescript() + " like an animal, all the while gloriously arching in release.");
	...
	/**
	 * Returns the appropriate cock noun for the selected cock of the player.
	 * @param	index of cock to get the noun for
	 * @return A string containing the cock noun
	 */
	private function getPlayerCockNoun(index:int):String 
	{
		return Appearance.cockNoun(player.cocks[index].cockType);
	}
