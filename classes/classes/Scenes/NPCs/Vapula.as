...
//switch follower names depending on conditions
		public function mouseWaifuFreakout(amily:Boolean = false, jojo:Boolean = false):void
		{
			...
			//Intelligence check
			if (player.inte < (60 + (player.corAdjustedDown()/2))) {
				//[if libido >=50]
...
//Feed
		private function feedVapulaACupOfJizz():void
		{
			...
			outputText("\n\nYour stamina is rapidly overwhelmed and you decide to reward her effort; you savagely press Vapula's head against your groin, effectively burying all " + UnitSystem.displayInchesTextually(player.cocks[0].cockLength) + " of your " + player.cockDescript(0) + " in her waiting throat; her tongue keeps teasing your rod for a few seconds, and then you cum, brutally.  ");
...
//Vapula-Sophie threesome
		...
		private function vapulaSophieThreeSome():void
		{
			...
			outputText("\n\nWithout ceremony you grab the avian slut's fuckpillows and eagerly sandwich your meat between them, pressing the tip of your " + player.cockDescript(x) + " against her tight anus.  As soon as the first " + UnitSystem.literalInches() + " start sliding in, the bimbo slut flaps her wings frenetically as she squawks in pleasure, her anal muscles contracting on their own as an invitation to slide in further.  Before you even think of it ");
...
//Vapula/Jojo Butt-fuck train
		private function jojoButtFuckTrain():void
		{
			...
			if (n1 >= 0) outputText("\n\nA deliciously depraved idea crosses your mind; using your dick muscles, you move your " + player.cockDescript(n1) + " toward Vapula.  It squirms for a moment as you look for her wet snatch, poking her everywhere with your tip and teasing her with your accidental ministrations, but at last you find her vaginal entrance.  Using the rubbery flexibility of your plant-like prick, you brutally shove it down her love-tunnel, trying to force inside as many " + UnitSystem.literalInches() + " as you can.  You can feel her instinctively altering her own body in order to accommodate more dickflesh inside her, and you keep pushing until your " + player.cockDescript(n1) + " is stretched to maximum capacity.  Somehow your tentacle rod is entirely buried in Vapula's warm depths, and her unbelievable tightness is driving you mad with lust.  It twists on its on volition inside her, its vegetable-like texture being more sensitive and receptive to pleasure than a normal prick and the sensations it sends to you are abnormally exquisite.  You almost forgot the asshole you were pounding with your " + player.cockDescript(x) + " but the way Jojo wriggles against it in order to fit more of your length inside him reminds you of your job.");
...
//Tease
		private function teaseVapula():void
		{
			...
			//Requires: Vapula not fucking harem, teased the day before
				...
				//[Naga:
				else if (player.isNaga()) outputText("\n\n\"<i>I would worship your scales, mistress.  I would buff every single one with my tongue so it shone, lick every " + UnitSystem.literalInch() + " of your tail, deep throat you all the way down into my belly.  And I would thank you for the privilege.</i>\"");
				//[Drider:
				...
				else if (player.lowerBody.type == LowerBody.DOG || player.lowerBody.type == LowerBody.CAT || player.lowerBody.type == LowerBody.LIZARD || player.lowerBody.type == LowerBody.KANGAROO || player.lowerBody.type == LowerBody.FOX) outputText("\n\n\"<i>I would worship your feet, mistress.  I would lick every " + UnitSystem.literalInch() + " of your claws, massage your soft undersides with my tongue.  I would pare all of your claws to needle sharpness and then let you test them on my backside.  And I would thank you for the privilege.</i>\"");
				//[Insect:
				else if (player.lowerBody.type == LowerBody.BEE || player.lowerBody.type == LowerBody.CHITINOUS_SPIDER_LEGS) outputText("\n\n\"<i>I would worship your feet, mistress.  I would lick every " + UnitSystem.literalInch() + " of your boots, clean your soles with my tongue.  I wouldn't stop until they shone. And I would thank you for the privilege.</i>\"");
				//[Human/demonic feet:
				else outputText("\n\n\"<i>I would worship your feet, mistress.  I would lick every " + UnitSystem.literalInch() + " of them, clean your soles with my tongue, between your toes, lavish each of your pinkies with attention as if they were ten cocks belonging to you.  And I would thank you for the privilege.</i>\"");
			...
			//Third Tease
				...
				outputText("\n\nYour stamina is rapidly overwhelmed and you decide to reward her effort; you savagely press Vapula's head against your groin, burying all " + UnitSystem.displayInchesTextually(8) + " of your false cock into her waiting throat; in symphony the two of you will your throbbing dildo to expand to pack you mercilessly tight, making you cum brutally.  Your " + player.clitDescript() + " pulses as your vagina contracts ecstatically around the bulging sex toy; vaguely you feel release at the other end, and you hear Vapula loudly and shamelessly enjoy what the dildo pumps out.  You abandon yourself to the climax and keep thrusting your " + player.hipDescript() + " into her face, girlcum spurting around your harness.");
