...
//const RATHAZUL_DEBIMBO_OFFERED:int = 744;
	...
	public function encounterName():String { return "rathazul"; }
...
private function rathazulWorkOffer():Boolean {
	...
	if (totalOffers > 0) {
		...
		if (lethiciteDefense != null) //These will be filled in
