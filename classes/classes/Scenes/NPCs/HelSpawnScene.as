...
internal function heliasAppearanceScreen():void {
	...
	outputText("Hel the salamander stands " + UnitSystem.displayHeight2EstimateTextually(7) + " tall, with pale skin and thick, bright-red scales covering her arms and legs, though she has a normal human torso and face.  A fiery tail swishes gaily behind her, blazing with a ");
	...
	outputText("\n\nHel has a pair of big, soft E-cup breasts, each with a " + UnitSystem.displayInchWithHyphen(0.5, 1) + " nipple at their tip.");
...
private function helSpawnsAppearanceScreen():void {
	...
	outputText("salamander daughter, " + flags[kFLAGS.HELSPAWN_NAME] + ", stands about " + UnitSystem.display("six-foot-six", UnitSystem.displayHeight2EstimateWithHyphenTextually(6, 6)) + " tall, with pale skin and thick, ");
	...
	outputText("\n\n" + flags[kFLAGS.HELSPAWN_NAME] + " has a pair of perky, palmable C-cup breasts, each with a sensitive " + UnitSystem.halfInchCompound() + " nipple at its tip.");
...
public function helSpawnChoosesAFightingStyle():void {
	...
	outputText("her sword held at a guard pose between herself and a training dummy. " + flags[kFLAGS.HELSPAWN_NAME] + " stands " + UnitSystem.aFewFeet() + " behind her mother, watching intently as Hel paces around the dummy, breathing hard.");
...
public function maiVisitsHerKids():void {
	...
	outputText("\n\n\"<i>Hi, [name],</i>\" Mai says with a demure smile, arms wrapped around " + flags[kFLAGS.HELSPAWN_NAME] + "'s belly, trying to hold the daughter that's near " + UnitSystem.aFoot() + " taller than she is.  Finally, laughing, she lets the young salamander go.  " + flags[kFLAGS.HELSPAWN_NAME] + " drops down to sit beside her mother and father, and quickly has both a smooth and scaly hand stroking her hair.");
	//If Chastemander:
