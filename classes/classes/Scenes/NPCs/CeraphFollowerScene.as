...
//[Actually Ceraph] - 
		public function ceraphFollowerAppearance(output:Boolean = true):void
		{
			...
			if (output) {
				...
				outputText(".  Tight buckles link her corset to the long thigh high boots over her legs, the platforms and heels adding nearly " + UnitSystem.aFoot() + " to her height.  Red stripes run right down the front of them and along the soles, as an imitation of laces.\n\n");
...
//*Fuck Ceraph's Pussy (Zeddited)
		private function fuckFollowerCeraphsVagoo():void
		{
			...
			outputText("  Yanking back, you bury all " + UnitSystem.displayInchesTextually(player.cocks[x].cockLength) + " of your " + player.cockDescript(x) + " into Ceraph's unholy, warm snatch, ");
...
//*Ceraph TongueFucks The PC (Zeddited)
		private function followerCeraphTongueFucking():void
		{
			...
			outputText(" clit, and stops over your sensitive pubic skin.  Then, her tongue begins to extend from her mouth, hanging further and further down as if it were unspooling from a hidden reel in her throat.  Ceraph doesn't stop letting out more of the slippery organ until she's got " + UnitSystem.displayFeetEstimateTextually(3) + " of tongue dangling between her tits.  Just looking at it there, undulating below your mons, makes you wet.\n\n");

			outputText("With a sharp intake of breath, she reels in the prodigious proboscis, shortening it down to a more usable " + UnitSystem.displayInchesRangeTextually(10, " or ", 11) + ".  Starting between her parted lips, the tongue thickens, becoming cylindrical in shape and widening until you're sure it's at least " + UnitSystem.displayInchesEstimateTextually(2) + " across.  Veins pulsate and texture the demon's tongue as it fills, giving it a decidedly... phallic appearance.  The transformation finishes, capping Ceraph's cock-like tongue with a rounded, penile cap that completes the illusion.\n\n");
			...
			outputText(" canal.  She twists her flexible mouth-dick inside you, making sure to rub over your g-spot, and then she slides another few " + UnitSystem.literalInches() + " in, forcing what feels like half of it inside you.\n\n");

			outputText("Now breathing heavily, your " + player.hipDescript() + " begin trembling, aching to mount the invading member, fuck it, mate with it; anything to sate your growing desires.  Ceraph gives you a knowing wink and sidles forward, sliding the last several " + UnitSystem.literalInches() + " through your spread nether-lips into the velvety embrace of your " + player.vaginaDescript() + ".  You can feel it, squirming and rubbing inside you, twisting through your pussy with a slow, maddening purpose.  From time to time it brushes your cervix, but never hard, never painfully.  At the same time, it seems to always be in contact with your most sensitive places.  It makes you wonder if Ceraph has practiced this on herself at some point, and you briefly entertain the notion of the demon bent over, vigorously fucking her box with her perverted tongue-prick ravaging her purple pussy.\n\n");
...
//SEX!
		private function fuckCeraphsCatgirls():void
		{
			...
			outputText("You smile at them and say that you'd be happy to have them for your pleasure; their horns suggest that they'll be quite a trip.  The two purr happily and instruct you to lie on your back to start the fun.  You relax as directed and the cat slaves unfasten your " + player.armorName + " from your body.  As they work, they make sure to gently stroke every " + UnitSystem.literalInch() + " of your newly exposed flesh with their soft furry hands as it's revealed; all the while moving closer and closer to your most personal parts.  When " + player.oMultiCockDesc() + " finally tastes the air, it gets even more attention.\n\n");
...
//[Drunk] (female/herm only. No centaurs)
		...
		private function ceraphUrtaRoleplayDrunk2():void
		{
			...
			outputText("\"<i>Oh damnit, damnit, damnit,</i>\" Utra chants as she presses her erection against your drooling slit, the equine " + UnitSystem.literalInches() + " slipping along the sweat-oiled plumpness of your thighs. Inching forward, she presses the flared tip of her head against your tender lips, the distended flesh struggling against the tightness of your snatch, lubricated depths unwillingly parting bit by bit until finally, the bulbous cockhead slips into you, your cunt tightening down around it, firmly locking the guard captain inside you. \"<i>Ah! Ffffffuck!</i>\" she curses.  \"<i>How are you always so tight?</i>\" she groans, happily. Unable to restrain herself, she begins bucking in place, sliding the first " + UnitSystem.displayInchesTextually(3) + " of her throbbing member back and forth inside you, savoring the ripples her rocking motion sends through your " + player.buttDescript() + ", your hypnotic hips mesmerizing the girl riding you. Raising an amber hand, she cracks an open palm against your tender ass as she drives another " + UnitSystem.displayInchesTextually(2) + " inside you, your gut lurching with the force. You try to ");
			if (player.isGoo() || player.isNaga()) outputText("wriggle to a wider stance");
			else outputText("spread your legs");
			outputText(" to make the penetration easier, but the vixen has your lower body firmly trapped between her knees, keeping your hips as tightly clenched as possible, heart-shaped rump throbbing at the fleshy weight within you. \"<i>Don't you love the long arm of the law?</i>\" she snickers, hiccupping  as she gives you another swat across your [skin], this time plunging half her length into your " + player.vaginaDescript() + ", stealing the breath from your lungs. Your squirting honey leaks from between your lips, lubricating the girl's shaft all the way to the ring of her sheath. You can feel the " + UnitSystem.displayInchesTextually(10) + " of her shaft inside you lifting your abdomen off the ground a few " + UnitSystem.literalInches() + " and it's all you can do to dig your fingers into the dirt as she thrusts rapidly, shallow pulses leaving every " + UnitSystem.literalInch() + " of your body jiggling under her.");
...
//[=Yes=]
		private function ceraphLackeyCorruption():void
		{
			...
			outputText("She is quite beautiful... about " + UnitSystem.displayHeight2Short2(5, 4) + " tall, with shoulder-length blonde hair.  Her face is covered by a blindfold, which you forcefully yank from her.  She gasps in fear and looks at you; her eyes are blue like the ocean, while her lips are pink and full.\n\n");
			...
			if (!player.hasCock()) {
				...
				outputText(", then develops into a huge " + UnitSystem.displayInchWithHyphen(16) + " long, " + UnitSystem.displayInchWithHyphen(3) + " thick erection!  The tip practically explodes from the foreskin vainly trying to contain it.  ");
			}
			var x:Number = 0;
			...
			if (player.cockArea(player.biggestCockIndex()) < 48 && player.hasCock()) {
				outputText("Your " + player.cockDescript(x) + " throbs, veins bulging as it grows larger, ballooning to a generous " + UnitSystem.displayInchWithHyphen(20) + " long, " + UnitSystem.displayInchWithHyphen(3) + " thick size.  ");
			}
...
//(should probably add a cock-limit of like, whatever you want, cuz you're fucking her butt)
		private function sweetieNOOOO():void
		{
			...
			if (flags[kFLAGS.MARBLE_DICK_LENGTH] > 0 && flags[kFLAGS.CERAPH_HIDING_DICK] == 0) outputText("Her nubbly member presumably shifts its color from royal purple to a lighter, brownish tone as well, inflating to the familiar " + UnitSystem.displayInchWithHyphenTextually(7) + " measurement; at least, so you'd judge by the sudden bulge in the overalls.  ");
			...
			outputText("\"<i>One last touch,</i>\" she moans as her whole frame begins to jostle about.  With a shake, her entire body leaps up a couple " + UnitSystem.literalInches() + " in height, and another, and another until she's roughly the same size as that familiar cowgirl.");
...
//[of course honey-buns] 
		...
		private function postUdderChoice(newl:Boolean = false):void
		{
			...
			outputText(".  After a few more moments of observation, you turn away, planting your hands on your hips victoriously.  You simply thank the cowgirl, and she responds with a satisfied moan.  Suddenly, a massive splashing sound - as if " + UnitSystem.literalGallons() + " of liquid were suddenly released - reaches your ears, and the barn shimmers and fades into the familiar setting of your camp.  You feel a hand on your shoulder, and you glance down to see a creamy-colored hand, veins of purple creeping along the surface and inching up her fingers.  \"<i>Thank you, " + player.mf("Master", "Mistress") + ",</i>\" Ceraph replies amiably, tittering to herself.  \"<i>You've got some kinks to work out, don't you?  I like that.</i>\"\n\n");
...
//After that is a scene tailored more specifically for the PC. Intention is to give nagas and centaurs and all that their own scene. Currently only scene is for PCs with a dick - should be naga-compatible.
		private function cerminika():void
		{
			...
			if (flags[kFLAGS.CERAPH_HIDING_DICK] == 0) outputText(" while her cock shrinks to what looks approximately like " + UnitSystem.displayInchesEstimateTextually(6) + " of meat, an outright tiny penis for Mareth");
			outputText(".\n\n");
			...
			if (player.hasCock()) {
				...
				outputText("You give her a carefully crafted retort that demonstrates your intellectual superiority, but she just gives you a fake smile and pats your cheek.  Eyes half-closed she slowly slides herself along you, enjoying the sensation of each " + UnitSystem.literalInch() + " of your " + player.cockDescript(0) + " as it brushes along her walls.  \"<i>Mmmm,</i>\" she lets herself purr out, \"<i>Worth... the wait.</i>\"  Her toes curl slightly, one of her legs shifting back slightly to alter the angle you enter her at.  It seems to work how she wants it to, as a deep, satisfied breath accompanies the next downward slide of her hips.");
...
//▶[FuckVagina] requires penis
		private function fuckZetsukosTonguepussy():void
		{
			...
			outputText("  As you begin to grope her enormous jiggling breasts, you keep looking down to watch as her tongue slithers along your length, stretching out across it and then squeezing tight.  It begins to contract, the motion squeezing the first " + UnitSystem.inch() + " or so of your cock inside, and she sends up a moan, repeating the motion again and again, each time pulling a bit more of you inside.\n\n");
...
//▶[Banana?] silly mode
		...
		private function ceraphFollowerCockTaking(smallest:Boolean = false):void
		{
			...
			outputText("\n\nShe pirouettes away, practically dancing into the sky while she strokes and teases the cock you just lost.  You shudder and shake as orgasm wracks your body, your cum falling like rain " + UnitSystem.display("thousands of feet", "hundreds of " + UnitSystem.meters()) + " away.  You swear, you can hear your pet laughing.");
			player.orgasm('Dick');
...
//NippleCunt Stuffing (Ceraph grows dick-nipples to plow your lusty twats!)
		private function stuffSomeNippleCunts():void
		{
			...
			outputText("  At first, the changes make her areola look more like something that belongs on an udder, but as they enlarge beyond even that, you realize they're taking on a distinctly masculine shape, with a slight ridge just below their bulbous tips.  After growing out almost " + UnitSystem.displayInchesEstimateTextually(7) + ", the upward-curving nipples stop filling out.  Ceraph has sprouted nipple-dicks!");
...
//Portal Fuck (AKA Ceraph Hung Out With Cinnabar, Req's PC dick)
		private function portalFuckWithFollowerCeraph():void
		{
			...
			player.orgasm('Generic');
			dynStats("cor", 1);
			awardAchievement(kACHIEVEMENTS.GENERAL_FUCK_WITH_PORTALS);
