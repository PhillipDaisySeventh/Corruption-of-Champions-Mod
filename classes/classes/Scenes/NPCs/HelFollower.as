...
public function helFollowersIntro():void {
	...
	if (followerKiha() && flags[kFLAGS.HEL_INTROS_LEVEL] < 1) {
		...
		outputText("\n\nYou look over your shoulder, and see Hel standing " + UnitSystem.aFewFeet() + " behind you, her meager possessions slung over her shoulder.  The salamander smiles at you, but falters when she sees the dragoness.");
		...
		outputText("\n\nTo your surprise - and Kiha's, by the look on her face - Hel yanks the dragoness into a tight hug, nearly smothering the " + UnitSystem.footCompound() + "-smaller woman between her big breasts.  After a moment of squirming around, Kiha finally manages to escape Hel's grasp and, now blushing brightly, launches off into the air.");
...
private function heliaOptions():void {
	...
	//addButton(4, "Futafication", talkAboutFuta).hint("See if she's in the mood to grow a new penis."); //No-go due to Savin's control.
...
private function listenToHelTalkAboutGnolls():void {
	...
	outputText("\n\n\"<i>Then she whispers, 'Do you like it, girl? Do you love being torn apart by my scepter, with only " + UnitSystem.literalGallons() + " of my harem's cum to ease your pain?'</i>\"");
...
private function talkAboutFuta():void {
	clearOutput();
	//Unfortunately, not happening due to Savin's control.
}
...
private function possessIzma():void {
	...
	outputText("You decide to give Hel's legs a stretch and trot over to the stream near camp.  Walking along the shore, it isn't long before you see a certain dark-red fin cresting the water.  A moment later your beta, Izma, breaches, jumping up out of the water and landing " + UnitSystem.aFewFeet() + " away.  Still dripping from her swim, you watch as Izma shakes a bit of water off before going to get her grass skirt - for now, though, you can see her hefty " + UnitSystem.displayInchWithHyphenTextually(15) + " rod and quad swinging in the breeze.");
	...
	outputText("\n\n\"<i>Shhh,</i>\" you command, giving her prick a hard squeeze.  \"<i>Betas don't get to decide how or when they put their cocks in other peoples' holes,</i>\" you tell her, pushing her down on her back.  Obediently, Izma lays down, her " + UnitSystem.display("fifteen-incher", UnitSystem.displayInchesTextually(15)) + " standing straight up like a flagpole.  You bend down, planting a quick little kiss on the crown of her cock, before slipping up her body, straddling her shoulders.");
	...
	outputText("\n\nYou give the slut a hard spank and throw her back on her back.  Before she can recover, you impale Hel on her cock, ramming all " + UnitSystem.displayInchesTextually(15) + " of sharkmeat into your twat until you can feel her head brushing against your cervix.  Izma groans, rolling her head back; she nearly screams when you grab her perky nipples and pinch them, hard, pulling on them until the shark-slut has to lean up.  You grab her shoulders and smash her face into one of your big, soft tits, putting her mouth up to one of your own rock-hard nips.  She gets the idea and starts licking, running her coarse tongue across your sensitive flesh.  With a low groan, you roll your hips on Izma's cock to reward her for her efforts.  You feel " + UnitSystem.literalInches() + " of thick cockmeat slipping in and out of you as you begin to ride your slut's cock, letting yourself go as her shaft stretches you, her pre lubing up your already-sodden box until you can feel orgasm coming... and Izma's, too.");
...
private function femtaurPlusCampHel():void {
	...
	outputText("\n\nNearly an hour passes before you collapse, finally falling off the toy as " + UnitSystem.literalGallons() + " of fake-spooge leak out of your horsecunt, your fiery lover tumbling off your back to land in a pool of the statue's leavings leaking from her abused cunt.");
...
private function muddyLizardFeet():void {
	...
	outputText("Suddenly, Hel lunges forward, grabbing you by the waist and tossing you both to the ground. With an \"<i>OOPH!</i>\" both of you go tumbling, rolling hard as Hel's toss carries you down a steep slope.  With a splash, you find yourself rolling in the river near camp, the water only a few " + UnitSystem.literalInches() + " deep, just enough to fill your ears as your salamander lover pins you down, grinning wolfishly at you.");
...
private function takeABath():void {
	...
	//{Repeat Intro (If you taught Hel to swin; else, play 1st Time)}
		...
		outputText("\n\nBy the time you arrive at the riverbank, you and Hel are both buck naked, laughing and teasing each other as clothes and weapons fly to the wayside.  With a gleeful shout, Hel cannonballs into the river ahead of you, creating a shockwave of a splash that sends ripples for " + UnitSystem.literalYards() + " around her.  You leap in after her, diving into the shimmering liquid behind your friend.  When you surface, Hel's already lined up a splash, showering you with water - already pleasantly warm thanks to the inferno she's carrying with her.");
		
		outputText("\n\nAfter a few playful minutes of splashing and laughing, the two of you wade back to a small rocky outcropping, sheltering you from wandering eyes.  Hel quickly curls up beside you, her head resting on your [chest] and her warm tail lying across your lap.  You wrap an arm around her shoulders, holding your lover close.  Your lake begins to turn into a sauna, the steam rising in thick clouds all around you until all you can see is the salamander and " + UnitSystem.aFoot() + " of water in front of you.  So concealed, you choose that moment to give Hel a long kiss on the brow, running your fingers through her long hair and down her shoulders.");
...
private function teachHelToSwim():void {
	...
	outputText("\n\nGrabbing the salamander's shoulders, you wade in beside her, keeping her steady as you instruct her in treading the water.  She panics more than once, but you keep a firm grasp on her, keeping her from drowning for nearly an hour until she's finally able to take her first paddle away from you.  She wades out " + UnitSystem.aFewFeet() + ", shakily at first, but soon gaining confidence as she moves just out of arm's reach.");
...
private function giveHeliaAnalTraining():void {
	...
	outputText("\n\nThe drunken salamander wiggles her stuffed backdoor happily around the impaling object as she strokes you faster and faster, talking into the bottom of your [cock biggest], begging it to dump a huge load all over, to drench her with " + UnitSystem.literalGallons() + " of spermy jism. As if you could hold back after such a lurid request. Your muscles clench powerfully");
	...
	outputText("\n\n“<i>That’s what I’m talking about!</i>” she cheers as she stands up, her legs looking " + UnitSystem.anInchOrTwo() + " farther apart than normal as she rises. “<i>I’m gonna leave this guy in another half hour or so to make sure this takes, ");
...
private function helAndSluttyHarpy():void
{
	...
	addButton(4, "Back",  heliaThreesomes);
}
