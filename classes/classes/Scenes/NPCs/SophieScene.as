...
public function meetSophie():void {
	...
	outputText("While hauling yourself up onto a particularly narrow ledge, you come face to face with a harpy's alien visage.  She must have heard you climbing and come to investigate.  Now she's scant " + UnitSystem.literalInches() + " away from you, looking ");
...
private function consensualHotSophieDickings():void {
	...
	outputText(", tracing up and down your " + player.skin.desc + " with slow, measured strokes.  She boasts, \"<i>The last time a willing mate found his way up to my nest, it only took a few moments for him to fertilize me.  He just couldn't handle all this.</i>\"  She pulls you into her breasts for emphasis and squeezes them around your head.\n\n");
...
private function sophieVictoryPussyGrind():void {
	...
	if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_SLAVERING) outputText("Juices squirt from the joined pussies");
	else if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_SLICK) outputText("Juices soak the nesting material");
	else if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_WET) outputText("Juice trickles from the paired pussies");
...
private function fuckDatClit():void {
	...
	outputText("You laugh and make it quite clear to Sophie that you aren't planning to use your pussy.  She looks bewildered as you touch your outer folds and toy with yourself, but comprehension slowly spreads across her features as your clit grows longer, " + UnitSystem.literalAnInch() + " at a time.  The harpy actually looks a little pleased as she remarks, \"<i>Well, maybe this isn't a total wash.  You can't fertilize my eggs, but that thing looks a lot more satisfying than my fingers.  Go ahead, my little lesbian minx; let me feel your clit.</i>\"\n\n");
	...
	if (player.vaginas[0].vaginalWetness >= Vagina.WETNESS_DROOLING) outputText("Juice dribbles down your " + player.legs() + " as your body enjoys the treatment.  ");
...
private function tinyDickSupremeSophieLoss():void {
	...
	outputText("The fluids from her aroused gash drip onto your belly as she bends her legs and begins to bring it closer.  She sneers, \"<i>I'm amazed you haven't cum yet, little girl.  I'm getting closer now, how soon do you think you'll start spurting? Now?  No, but you'll squirt soon.</i>\"  You watch transfixed as Sophie's cunt hovers over-top of you, continuing its slow descent towards your " + player.cockDescript(0) + ".  Oh gods, why are you so hard?  Your cock is twitching on its own by the time her pussy is " + UnitSystem.aFoot() + " away.  No no no, you panic mentally, and think of the most boring, dreadful thing you can.  ");
