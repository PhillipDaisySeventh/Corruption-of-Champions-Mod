...
private function fullOnTentacleTasticGangBangForHolli():void {
	...
	outputText(".  Below the orgy of arboreal affection, Holli's slick petals have spread wide.  You can actually see her interior twitching voraciously.  It opens and closes with pulsing hunger, vibrantly engorged.  As you watch, the fourth of your members lances forward of its own volition, spearing straight for that welcoming hole with no guidance from you.  It hits like a missile.  " + capitalizeFirstLetter(UnitSystem.displayFeetEstimateTextually(2)) + " of that cock is gone in a moment, swallowed deep in the cunt-flower's bottomless depths.  A gush of girl-cum spurts out around the intruding member, and you can feel the muffled moan vibrate through the mouth-bound cock as she gives in to the four-way fucking.");
...
private function vaginalDomHollisTentacruels():void {
	...
	outputText("\n\n\"<i>Bring two tentacles over here, Holli.  I want to see how you look with a mask of your own seed.</i>\"  Holli's pale green skin blushes darker, almost as dark as her viridian hair, but two tentacles appear beside you, as if by magic.  Their heads are flared and purplish, as wide as the shaft and a half, leaking clear trails of slick pre-sap.  You touch the tip of one and giggle when it bubbles up a fresh batch of lubricant.  It's smooth and slick on your hand, perfect for a handjob.  You begin to masturbate the two arrivals, taking care to keep them pointed directly at Holli's face.  The poor woman has her mouth full of dick, a cock deep in your twat, and two swollen heads barely a few " + UnitSystem.literalInches() + " away from her unprotected face.  It's a wonder she can think with all that going on.");
...
internal function enjoyYourBadEndBIYAAAATCH():void {
	...
	//branch of vagina-having
		...
		else if (player.analCapacity() < 30) outputText("Your jaw hits your collarbone as Holli angles the florid head of a long, narrow penis into your field of view.  Judging by how far it comes up her chest, it's almost " + UnitSystem.aFootAndAHalf() + " long, and it's drooling sticky sap all over your back.  With a twisted smile, the demon pushes it along your spine until it reaches your [butt], then shoves it toward the hole.  ");
...
private function holliAndGenderlessSittingInATree():void {
	...
	if (!player.isFurryOrScaley()) outputText(player.skin.tone + "-colored");
