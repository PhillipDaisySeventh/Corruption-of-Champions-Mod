...
package classes.Scenes.NPCs {
	...
	public function finalBadEndWithCowCunt():void
	{
		...
		//PC goes to serve and service Clara, they perform demeaning things for Clara for her amusement, and she then gives them the milk they need.
	 	...
	 	outputText("\n\nOnce you’ve finished drinking, mistress directs you to lie down on her bed.  She wants to use you for her pleasure.  As always, you’re happy to comply.  Just as things have been for so long, she mounts your custom prepared equipment: a kitty cock, " + UnitSystem.lengthInInches(9) + " by " + UnitSystem.displayInches(1.6, 1) + ".  You are just happy that you can serve as her sex toy so well.  It fills you with such joy to watch the body of the most beautiful woman in the world bounce on top of yours, in that fine dress with her chest still exposed and tumbling around above you.");
	...
	public function defeatClaraCuntInAFight(cheated:Boolean = false):void
	{
		...
		if (kGAMECLASS.camp.loversCount() > 1)
		{
	 	...
	 	outputText("\n\n\"<i>Seriously, there is no damn way someone as pathetic as " + player.short + " could accomplish that,</i>\" she continues while struggling to her feet.  \"<i>You need to be like a " + UnitSystem.displayHeight2EstimateWithHyphenTextually(20) + " giant, champion fighter, god master of magic to pull a stunt like wiping out the demons.  " + player.short + " is none of those things.  Do you really think someone who could would actually care about a lowly Lacta Bovine like you?</i>\"  Clara pokes her finger into Marble's chest.  \"<i>I guess the saying among our kind is right, 'the first daughter has the sourest milk.'</i>\"");
	...
	public function murbleSpanksCowCunt():void
	{
		...
		outputText("Marble seems to have a good idea on how to punish Clara already, so you just sit back and watch.");
	 	...
	 	outputText("\n\nMarble picks her sister up off the ground and roughly tosses her onto one of the sitting logs around the firepit.  Clara continues to sob and beg for the abuse to stop, but it is all in vain.  Marble squats down slightly behind her, winds up, and brings down the first of many harsh smacks against her rear end.  Your mate doesn't let up on her punishment until every last " + UnitSystem.literalInch() + " of Clara's heinous hindquarters has been covered in blue welts.  By this point, the wannabe kidnapper and slaver is nothing but a slobbering, incoherent mess.");
	...
	//does not work with centaur, naga, drider, or goo bodies.  However, I don't particularly want to just say you can't do this scene if you have them.
	{
		...
		else if (flags[kFLAGS.MARBLE_DICK_TYPE] > 0)
		{
		 	...
		 	outputText("\n\n\"<i>What?  Why the hell would I be sorry for that?  Moop!</i>\"  There is a low slurp as your mate pushes her newly acquired " + UnitSystem.displayInchWithHyphenTextually(7) + " shaft deep inside her sister's womanhood.  \"<i>Hey!  Yo-mmph,</i>\"  You silence her with your " + player.vaginaDescript() + ", roughly forcing it into her face.  You give a slight twist to the young bovine's ears to remind her what she should be doing, and right away her tongue comes out and starts giving you experimental licks.");
