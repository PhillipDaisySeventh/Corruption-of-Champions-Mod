...
public function morningShouldraAlert():void {
	spriteSelect(SpriteDb.s_ghostGirl2);
	outputText("\n\"<i>Yo, Champ!</i>\" a voice calls, stirring you from your sleep.  You grumble and sit up, rubbing the sleep from your eyes.  Shouldra's standing " + UnitSystem.aFewFeet() + " away from you, hands on hips and staring at you expectantly.  As soon as you slink out of bed, she slides up and wraps you in a big hug, gradually allowing herself to grow transparent and slide into you.  A few moments of adjustments later, you stretch, feeling the otherworldly presence gliding around your body.  \"<i>Alright, Champ,</i>\" Shouldra exclaims, \"<i>Let's paint this land white.</i>\"");
...
private function genderlessShouldraMasturbation():void {
	...
	if (flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 || flags[kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] > 0) outputText("You recognize it instantly as she pulls it free from her chest: the nearly " + UnitSystem.footCompound() + "-long floppy horse cock she impaled you on before.");
	//{if SHOULDRA_GENDERLESS_FUCK_COUNT = 0}
	else if (flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0) outputText("She holds her catch up clear for you to see; to your horror, you have clutched onto an enormous horse cock replica.  All " + UnitSystem.displayInches(13) + " flop restlessly in your grip, seemingly taunting you with the foreboding future that lays before you.");
...
private function nongenderlessAnalShouldraMasturbation():void {
	...
	outputText("  The ghost girl promptly discards your [armor] before hurrying your naked body along into the wilderness away from camp.");
	outputText("\n\nShe leads you to a small clearing in the wood, highlighted by an opening in the slightly dense canopy and a babbling brook " + UnitSystem.aFewFeet() + " further in.  To your right is a short, grassy embankment with a pile of large rocks and boulders embedded into the natural wall.  As the specter leads you towards them, a disconcerting realization sinks in: you have no memory of traveling here.  The last thing you can picture is sprinting away from the camp naked.  Either you really need to work on your mental issues or, more likely, Shouldra would rather you not come here on your own.");
	outputText("\n\nSpeaking of the phantom, your bout of amnesia is the least of her concerns as she has you set aside one rock after another, revealing a tiny cavity in the wall.  ");
	//if SHOULDRA_GENDERLESS_FUCK_COUNT = 0 & event occurrence = 0
	if (flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0 && flags[kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0) outputText("Within lies a rather rustic yet well-built chest.");
	else if (flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 && flags[kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0) outputText("The moment the light reveals what lies within, your [butthole] instinctively clenches shut.  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\" It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it.");
	...
	//if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 OR event occurrence > 0
	if (flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 || flags[kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] > 0) outputText("You recognize it instantly as she pulls it free from her chest: the nearly " + UnitSystem.displayFootEstimateWithHyphen(2) + " floppy horse cock she impaled you on before.");
	//if SHOULDRA_GENDERLESS_FUCK_COUNT = 0
	else outputText("She holds her catch up clear for you to see; to your horror, you have clutched onto an enormous horse cock replica.  All " + UnitSystem.displayInches(13) + " flop restlessly in your grip, seemingly taunting you with the foreboding future that lays before you.");
	outputText("  Shouldra smacks the dildo of doom onto a nearby boulder as she wearily rises you to your [feet].  The inferior, forgotten playthings slide out uselessly from the ghoul's gasping craw as she slowly clambers over top the wiggling horsey wang.");
	outputText("\n\nToo tired to object or plead, you meekly brace for impact as the wraith lines up its target.  Your immense cheeks part way.  Your rectum gapes wide.  Your anal tongue presses firmly against your taint.  \"<i>Down the hatch!</i>\"");
	outputText("\n\nThe forest shudders with your scream.  The phantom easily downs " + UnitSystem.displayInchesTextually(6) + " on the first go.  She wraps her tongue around the shaft, forcing more and more into you.  You swear your pelvis is bulging.  Muffled moans blended with laughter emit from your belabored behind.  You dare not guess how deep Shouldra drills the cock into you before she climaxes - hard.  Your voluptuous ass quavers with ferocity alongside her gagged yelping, throwing you from your perch atop the rock back down to the earth.  Her fun over, you begin to feel the magic subsiding.  Having no desire to learn of the consequences of leaving a massive wang lodged in your shrinking anus, you muster what little strength you can to plumb it free.  With the experience settling down, you can't help but laugh - closer to a timid chuckle, as its the best your exhausted body can offer.  You think you hear Shouldra saying something to you, but you're too worn out to listen to her boasting.");
...
private function maleMasturbationProper():void {
	...
	outputText("\n\nThe ghost girl relinquishes part of her hold on you, most likely knowing full well your new fascination with her construct.  Sure enough, as soon as you take up the reins, your efforts to reach the rose doubles.  Luckily for you, the tentacles, slimy as a swimming goo girl's tentacles, are no match for your lust-driven struggle.  You slip out of their grasp, free-falling for several " + UnitSystem.literalFeet() + " to land, with a big and airy poof, right into the cushiony bloom.  The pleasant and heady aroma of the enlarged rose nearly drives you wild.  You just can't get enough.");
	...
	outputText(" shudders and churns, and you know enough about Shouldra to know exactly what's to come.  Another wave of lust hits you like a freight train, and the thirsty rose feasts on a multi-" + UnitSystem.liter() + " burst of pre.  Though you can't see the stalk around the span of the bloom, you can readily hear and imagine your initial offering sloshing down towards its roots.  The squishing and squeezing intensifies, the rose obviously spurred on by its appetizer.");
...
private function shouldraTongueLicksPCs():void {
	...
	if (player.findPerk(PerkLib.Flexibility) >= 0) {
		...
		outputText(" sliding fingers along the wet appendage, humming a little tune over your tongue until more than " + UnitSystem.aFoot() + " of it droops from your mouth.  \"<i>Now we're getting somewhere,</i>\" you hear her thinking as she works her magic.  There doesn't seem to be a limit to how much she can pull out of your mouth, and soon she has more than " + UnitSystem.displayFeetEstimateTextually(3) + " of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can't manage to wiggle more than the tip.  \"<i>Too thin,</i>\" she mutters, \"<i>much too weak. Doesn't feel right...</i>\"");
	...
	// actually, draconic one is long enough as is even without her upgrades
		...
		outputText("\n\nYou tell your experimentative friend to see for herself.  She opens your jaw wide, letting " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of your inhuman tongue spill out.  A happy squeak, made rather awkward by the floppy appendage, comes from you as Shouldra checks out what you've been packing in your mouth.  \"<i>Tho yuv ha tis-</i>\" she giggles at the sound of talking with it hanging out, but continues talking in your mind.  \"<i>So you've had this thing all this time and I haven't gotten to play with it?  Well that just won't do.</i>\"");
		...
		outputText("sliding fingers along the wet appendage, humming a little tune over your tongue until more than an additional " + UnitSystem.foot() + " of it droops from your mouth.  \"<i>Now we're getting somewhere,</i>\" you hear her thinking as she works her magic.  There doesn't seem to be a limit to how much she can pull out of your mouth, and soon she has more than " + UnitSystem.displayFeetEstimateTextually(3) + " of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can't manage to wiggle more than the tip.  \"<i>Too thin,</i>\" she mutters, \"<i>much too weak. Doesn't feel right...</i>\"");
		outputText("\n\nTaking the midsection of your tongue in your hand, she slowly starts to rub her hand along some of its length.  It feels... odd, somehow, but not entirely unpleasant.  Though you shudder at the first rub, they start to feel more natural as she pushes you on.  Actually, it feels sort of good.  Her strokes remain constant, though some part of you wishes she'd go faster.  It doesn't even register as odd in your addled mind that your tongue is swelling in your hand with every stroke.  Shouldra starts to make wider movements along your smooth stretch of muscle.  Its girth plumps up to fill your palm nicely wherever she brings your hand, and the strange sensations of your flesh on its nerves wrack your body with shudders of pleasure even through Shouldra's grip.");
...
public function shouldraDream1():void {
	...
	if (flags[kFLAGS.SHOULDRA_PLOT_LEVEL] == 3) {
		...
		outputText("Your eyes snap open with the first horror-filled scream.  You tumble off your bed, running to the door and throwing it open.  You run out into a milling group of townsmen, gaze directed by the frantic gesticulations of the town sentry.  There, merely hundreds of " + UnitSystem.literalYards() + " off, approach a horde of figures illuminated by dozens of torches.  A shudder runs through most of you at the sight of the oncoming mob, but none of you attempt to flee.  The militia move back into their homes to fetch their weapons, and you, for better or worse, are, the head sorceress of the village.");
...
private function shouldraYappin():void {
	...
	if (flags[kFLAGS.SHOULDRA_TALK_NEEDED] == 1) {
		...
		//Talk 2 - First Transformation Discussion
			...
			outputText("\n\nYou're about knocked off your [feet] as your hands go into double time, covering every new square " + UnitSystem.literalInch() + " of flesh on your midsection.  ");
		...
		//Talk 3 - "Recent" Goblin Possession Discussion
			...
			outputText("\n\n\"<i>The rest of that day was pretty great.  I was so full of myself; inhabiting a big dick like that and ticking off that goblin went to my 'head,' so to speak.  At that point, I was just this big, thick rod mindlessly floating through the forest with this poor tiger shark dangling below me " + UnitSystem.literalInches() + " off  the ground, still paralyzed with shock.  Out of nowhere, she finally starts talking to her dick, thanking it profusely and asking all sorts of questions.  Must have been the blood rushing to her head or something.  It snapped me back to reality, but I kept up the charade, demanding that she satisfy me as payment for my actions.</i>\"  Shouldra shivers a little, the thought of what came next most likely having left a pleasant impact on her.");
...
private function groBallsBiggaGHOSTYSTYLE():void {
	...
	if (rand(5) == 0) {
		...
		outputText("\n\nYour testicles rumble greatly, " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of " + player.skin.tone + " flesh enveloping their impressive new bulk.  Shouldra gives your enlarged [balls] a little squeeze and leaves you to reacquaint yourself with a new center of balance.");
	}
...
private function shouldraGrowsYoClit():void {
	...
	outputText("She welcomes the new " + UnitSystem.literalInch() + " with a quick flick.  The sensitive [clit] twitches happily in response, confirming the success of the spell.");
...
private function shouldraCockBloating101():void {
	...
	if (player.cocks.length == 1) {
		outputText("Several more " + UnitSystem.literalInches() + " push their way from your ");
	...
	//MULTI
		...
		outputText("Your bouquet of cocks twitches and thickens, each gaining more than " + UnitSystem.anInch() + " of new vibrance.  Shouldra wastes no time in grouping them together, your hands stroking them vigorously.  Knowing your inaction will strand you for the rest of the day, you're able to pry your haunted hands away from your crotch.");
...
private function shouldraGivesYaSomeFukkinTeats():void {
	...
	outputText("\n\nYour nipples press hard against your [armor], easily gaining at least " + UnitSystem.display("a quarter of an inch", "half of a centi" + UnitSystem.meter()) + " in size.  Shouldra gives each [nipple] a hasty inspection, ensuring her work.");
...
private function shouldrasButtBigginator():void {
	...
	outputText("\n\nYour cheeks quake as the magic takes hold, warm ripples greeting the " + UnitSystem.literalInches() + " of new retail estate on your hind quarters.  Shouldra can't resist herself, giving your [butt] a vigorous slap.");
	doNext(camp.returnToCampUseOneHour);
}
...
public function shouldraReductosYourBallsUpInsideYa(rescue:Boolean = false):void {
	...
	outputText("\n\nYour scrotum shifts and squirms, clinging to your testicles as your package recedes into your body by a few " + UnitSystem.literalInches() + ".  The pouting ghost is quick to give you back your body, disappointed in your new [balls].");
	doNext(camp.returnToCampUseOneHour);
}
...
private function shrinkDemNipplzForYoGhost():void {
	...
	if (player.nippleLength/2 < .25) {
		outputText("\n\nYou run a couple fingers around your [nipples], finding them shrunk to a " + UnitSystem.quarterInch() + " long.  A quick squirt of liquid from each surprises you, causing you to jerk back a little.  Shouldra is evidently not too thrilled over your alterations.");
...
private function shouldraAndWormsYoureGonnaHaveABadTime():void {
	...
	if (player.cocks[0].cockLength < 48) outputText(" and cuts right to the chase, ballooning your [cock] into a rigid, wide, " + UnitSystem.displayFootEstimateWithHyphenTextually(4) + " tall slab of meat");
	...
	if (getGame().time.hours <= 12) outputText("morning ");
	else if (getGame().time.hours <= 5) outputText("afternoon ");
	else outputText("evening ");
	outputText("air.  Your hands clue the eidolon in to further activity, introducing her to your urethra all the way down to your [balls], every square wriggling " + UnitSystem.literalInch() + " chock-full of the little buggers, exploring their extended living quarters.");
...
private function kickOutWormiesForYourGhostPalPAL():void {
	...
	outputText("\n\n\"<i>You're a real fucking asshole, you know that?</i>\"  Shouldra says out loud.  Digging deep down for any shred of her trademark confidence, your trembling hands slowly work their way towards your infested manhood.  The confined worms are stirring around with ferocity in their attempt to flee, distending your urethra as they clump together at its base.  Shouldra freezes up, your trembling hands mere " + UnitSystem.literalInches() + " from your wriggling meat.  You give her a mental shout, forcing the spirit into action.  She screams incessantly as your hands move up and down your length, taking special care to avoid the undulating passageway in the front.  Your eyes slam shut as your head turns to face away from the spectacle.");
...
private function goAlongWIthShouldrasEatingSpree():void {
	...
	if (player.hasCock()) {
		...
		if (player.cocks[0].cockLength < 8 || player.cocks[0].cockLength > 25) outputText("\"<i>First though, let's change it to something more manageable.</i>\" Arcane sounds float up towards you, causing your shaft to shift and morph until your throbbing rod is around " + UnitSystem.displayFeetEstimate(2) + " long and dripping pre.  \"<i>Mmm, much better!</i>\"  ");
		outputText("Her eyes close as those sumptuous icing-white lips wrap around the [cockHead] of your aching dick, the cherry tongue canvassing your cockflesh like an artist, until she slowly, oh-so-slowly gulps down " + UnitSystem.literalInch() + " after gradual " + UnitSystem.literalInch() + " of your girth.  Her enormous chocolate rump is visible on the other side of the booth, lulling back and forth in contented bliss.");
