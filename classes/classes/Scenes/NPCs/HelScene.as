...
internal function loseToSalamander():void {
	...
	if (player.hasCock() && (player.gender == 1 || rand(4) < 3) && player.cockThatFits(85) >= 0) {
		...
		outputText("The salamander pulls off your " + player.armorName + " with practiced speed, ");
		if (player.gender == 3) outputText("revealing your " + player.vaginaDescript(0) + " and ");
		...
		outputText(".  She gasps at the sensation and grabs your hips as another shot goes off inside her.  Panting, she gives you one massive, final thrust and cums herself, squeezing your " + player.cockDescript(x) + " hard inside her and screaming as brutal a scream as any warcry to the heavens.");
	...
	//Player Loss – Rape – Female
		...
		if (player.gender == 3) outputText("\"<i>Though not exactly a woman, are we?</i>\" she laughs, giving your " + player.cockDescript(x) + " a quick stroke.  ");
		...
		outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + player.chestDesc() + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her cum-soaked tail from your " + player.vaginaDescript(0) + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.");
	...
	//Player Loss – Rape – Genderless & Male >85 cockarea
		...
		outputText("Before your mind has settled, your new friend has collapsed on top of you, resting her cheek on your " + player.chestDesc() + ".  Her breath is ragged, not unlike yours, and her eyelids seem suddenly heavy.  Smiling, she slowly withdraws her tail from your " + player.assholeDescript() + " and slips it under your head like a pillow, soft and warm, if not a little moist.  Seeing as she doesn't seem intent on going anywhere, you, too, close your eyes and drift off to a peaceful sleep.");
...
internal function fuckHelsAss():void {
	...
	outputText("That's all the encouragement you need.  You line up and thrust in, slowly but surely.  By gods, she's tight as a silken vice, her sphincter gripping down hard upon your cock and making you fight for every " + UnitSystem.literalInch() + ".  She moans and grunts as your " + player.cockDescript(x) + " forces its way in, biting her lower lip for the final " + UnitSystem.literalInches() + " until you've bottomed out, your entire length buried inside her asshole.\n\n");
...
internal function getLickedByHel():void {
	...
	outputText("The salamander grips your " + player.buttDescript() + " with her smooth, scaly hands as she slips her wonderfully long tongue into your " + player.vaginaDescript(0) + ", flicking and tickling every " + UnitSystem.literalInch() + " of your sensitive cunt as she forces in " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + ", until all eight are pushed inside you, driving you wild with lust as she lustily tonguefucks you.  Gripped by building pleasure, you push her onto her back and smash your cunt against her mouth, bucking your hips as she continues her skilled assault, making you shudder and writhe with pleasure.\n\n");

	outputText("Even as she licks your " + player.vaginaDescript(0) + ", you feel a sudden pressure on your own back door. Looking over your shoulder, you see the very tip of her tail pressing against your " + player.assholeDescript() + ", seeking to double your pleasure.  You try and relax your sphincter, letting just a few " + UnitSystem.literalInches() + " into your ass, and even that is enough to make you gasp as her dexterous tip works in conjunction with her long tongue.\n\n");
	...
	if (player.hasCock()) {
		outputText(" while " + player.sMultiCockDesc() + " shoots its load into her red hair");
...
internal function helTailPegging(loss:Boolean = false):void {
	...
	outputText("Eventually, you can take no more, and feel your climax coming on.  The salamander, sensing this from the fashion you're wringing her tail, gives your " + player.buttDescript() + " a hard slap and slams in as far as it can go.  You rocket over the edge, screaming and shuddering so hard that you collapse onto the dirt");
	if (player.gender > 0) {
...
private function nagaCoilsUpHel():void {
	...
	outputText("massive orgasm, you collapse onto your back and release your salamander lover from your grasp.  She crawls up to you and nuzzles into your " + player.chestDesc() + ", wrapping her own tail around you in return.  Soon, you drift off into a calm, peaceful sleep.");
	//(reduce lust, increment Helgate flag by 1)
	player.orgasm('Generic');
	flags[kFLAGS.HEL_FUCK_COUNTER]++;
	flags[kFLAGS.HEL_AFFECTION]++;
...
private function nagaCoilsUpAnalNaga():void {
	...
	outputText("Once both your tails are sufficiently lubricated, the salamander crawls behind you, and presses her back tightly to yours.  In an odd show of kindness, she even takes your hands in hers as her tail slithers between the cheeks of your " + player.buttDescript() + ".  You return the favor, soon pressing the tip of your tail to her tight but relaxed asshole as hers begins to slip into your " + player.assholeDescript() + ".  You gasp with the sensation of the hot, writhing tail-cock pushing inside you, fighting every " + UnitSystem.literalInch() + " to wring sensation out of it even as you push yours deep inside her, hard enough to make her take a sharp breath and knock her knees.");
	player.buttChange(40,true,true,false);
	outputText("\n\n");
...
private function mountHel():void {
	...
	outputText("You're a little nervous about outright breaking her, but she asked for it.  You trot up and swing your front hooves over her shoulders, resting part of your weight on her as your " + player.cockDescript(x) + " presses urgently against her firm ass cheeks.  She gasps and groans under your weight and at the prodding of your cock, so desperately seeking a hole to fill.  Finally, you slip between her legs and enter her cunt, ramming your full " + UnitSystem.displayInchesTextually(player.cocks[x].cockLength) + " into her sweltering depths.  You gasp and shudder at the intense heat of her inner walls, but your lover can only cry with exaltation as your cock fills her to the hilt.\n\n");
	...
	outputText("You fuck and rut and thrust until the salamander lets out a sharp cry, and her steaming inner muscles clamp down like a vice.  You grunt and impale her one last time before your " + player.cockDescript(x) + " explodes within, filling her to the brim with your centaur spunk");
...
private function helVaginaTaur69():void {
	...
	if (player.hasCock()) {
		outputText("Now that you're calmer, the salamander takes the opportunity to grasp " + player.oMultiCockDesc() + " with her free hand and guide it into her mouth.  Her forked, reptilian tongue flicks out, running across your girth as more and more of you slips past her thin lips and down her throat");
	...
	outputText("With a wicked smile, you snatch up the woman's writhing tail and grasp it like a whip, coiling it until only " + UnitSystem.aFoot() + " or so extends past your wrist.  Now, you lean down and prod at her with the tail, trying blindly to set its pointed tip into her vacant cunt.  Finally, you find your mark, her tail slipping past her hips and into her slit.  You thrust the tail forward into its owner, eliciting a yelp of pleasure");
...
private function helPossessionShitPoopCock():void {
	...
	if (player.hasFuckableNipples()) {
		outputText("Well, you can't let her have ALL the fun!  Still leaving the lower half of your body within the bunny-girl, you slip a pair of fingers into one of your hungry nipplecunts.  Grinning, you stretch your nipple-fuckhole out and bend forward, letting your chest-lips kiss the tip of your possessed bunny-cock.  You shudder as you press yourself down upon the bunny rod, taking the first few " + UnitSystem.literalInches() + " into your " + player.chestDesc() + " even as the salamander continues to titfuck the length of your column.  You settle into a rhythm with the salamander, rising and falling in unison as you coax the eggs out of the bunny and toward your nipplecunts.\n\n");
...
private function rapingHelsAssMeansYourCorruptCauseAnalIsEvil():void {
	...
	outputText("She's too exhausted, and you're too skilled, for the attack to land.  Instead, you grab her wide hips and lunge forward, ramming your " + player.cockDescript(x) + " into her ass");
	if (y >= 0) outputText(", and your " + player.cockDescript(y) + " into her waiting vag, doubling the assault on the helpless berserker");
	outputText(" while she's vulnerable.  She screams in surprise, arching her back and squirming in pain.\n\n");

	outputText("She's tight as a silken vice!  Her sphincter grips down hard upon your cock, making you fight for every " + UnitSystem.literalInch() + ", and it's HOT.  You're almost afraid you're going to come away with burns, but you're this far already, and the feeling of such intense heat is incredible.  You continue to force your way into her; she moans and grunts in pain and pleasure over the final " + UnitSystem.literalInches() + " until you've bottomed out, your entire length buried inside her asshole");
...
private function receiveCorruptRimjobsFromHel():void {
	...
	if (player.hasVagina()) outputText("  Her tongue begins to zero in on your " + player.vaginaDescript(0) + ", but you give her a quick penalty swat on the tits.  You've got other plans!");
	outputText("\n\n");
	...
	outputText("Firmly within your depths, she plants her smooth, scaled hands on your " + player.buttDescript() + " and starts to flick her tongue as fast as she can, withdrawing and ramming it back into your ass.  You gasp and moan like a whore");
...
private function helMinoThreeSomeLickItsDick():void {
	...
	if (player.hasCock()) outputText(" while " + player.sMultiCockDesc() + " ejects its load into the mess on the 'taur's chest");
	outputText(".\n\n");
...
private function salamanderXIsabellaDiplomacy():void {
	...
	if (player.str > 60) {
		...
		outputText("\"<i>" + player.short + "!?</i>\" They both blurt at once, surprised by your intervention.");
	}
...
public function followrIzzyxSallyThreesomePretext():void {
	...
	outputText("\"<i>" + player.short + "!</i>\" Isabella gasps, relieved to see you approach. \"<i>");
...
public function isabellaXHelThreeSomeCampStart():void {
	...
	outputText("\"<i>" + player.short + "... it is –moo– good to see youuuuu.</i>\"  She trails off into a long, ecstatic moan as Hel continues to suckle from her massive teat, acknowledging your presence only with a little waggle of her tail and a wink.  ");
...
private function stuffIzzyAndSalamanderWithDicks():void {
	...
	outputText("That's all the invitation you need.  You drop to your knees behind the two redheads and thrust your " + player.cockDescript(x) + " into Hel's snatch, eliciting a sharp moan from the salamander.  ");
	//(IF MULTICOCK and second cock is under 9 inches: 
	if (y >= 0) outputText("Meanwhile, your " + player.cockDescript(y) + " slides easily into Isabella's pussy, making the cow-girl gasp at the sudden and unexpected penetration.  ");
	outputText("You grab Hel's hips and push in, reveling in the incredible heat and tightness of her pussy as your " + player.cockDescript(x) + " slides into her until you've bottomed out");
	if (y >= 0) outputText(" with your " + player.cockDescript(y) + " similarly coming to a rest inside Isabella's depths; you're able to feel the cow's rapid heartbeat hammering through her, causing her already tight cunt to contract rhythmically around your girth");
	outputText(".\n\n");
...
private function izzySallyThreeSomeVagoozlaz():void {
	...
	//(IF HERM: 
	if (player.hasCock()) outputText(" and Hel jerking your " + player.cockDescript(0) + " off");
	...
	if (player.hasCock()) outputText(", wrapping her warm tail around your " + player.cockDescript(0) + " lovingly");
	outputText(".\n\n");
...
public function heliaPlusFoxyFluffs():void {
	...
	//Fox Girls -- Repeat Intro
		...
		outputText("Amused, Hel gives Miko's bountiful bosom a playful grope and says, \"<i>My, my, " + player.short + ", looking for a little foxy foursome?  Well, I think that can be arranged, what do you say, girls?</i>\"");
