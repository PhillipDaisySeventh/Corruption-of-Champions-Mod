...
private function milkWriteFuAppearance():void {
	clearOutput();
	outputText(flags[kFLAGS.MILK_NAME] + " is a " + UnitSystem.display("five-foot-five", UnitSystem.displayHeight2WithHyphenTextually(5, 5)) + " human female, with darkly tanned skin and ebony hair.  ");
...
private function communalBath():void {
	...
	outputText("\n\nWithout prompting, " + flags[kFLAGS.MILK_NAME] + " shifts around to rub a little milk into your skin, gently bathing you.  Her dark fingers run through your hair, washing it thoroughly before moving down to your arms, [chest], and legs, cleansing every " + UnitSystem.literalInch() + " of your " + player.skinFurScales() + ".  You relax to " + flags[kFLAGS.MILK_NAME] + "'s touch, letting her massage the cares out of your weary muscles.  Around you, your followers begin to do much the same, taking turns bathing each other, scrubbing backs and extremities with the soothing milk of " + flags[kFLAGS.MILK_NAME] + "'s bounty.");
...
private function pullInZeMilkGirl():void {
	clearOutput();
	outputText("You call out to " + flags[kFLAGS.MILK_NAME] + " before she can wander away, and wade over to the side of the tub, leaving your face a few scant " + UnitSystem.literalInches() + " from her hefty milkers.  She smiles as you reach up, nuzzling her cheek into your hand, purring your name happily.");
...
private function fuckTheMilkWaifu():void {
	...
	if (player.cockArea(0) < 20) outputText("pushing your few " + UnitSystem.literalInches() + " into her until your hips join, her nice and loose cunt easily taking your length");
...
private function nyanCatMilkTime():void {
	...
	//Milk Time!  (DD Boobs Ver.)
		...
		outputText("\n\nWith each caress and squeeze, " + flags[kFLAGS.MILK_NAME] + " shivers and shakes, her chest soon heaving with her ragged, pleasure-strained breath.  You can see her lustful secretions stain her panties as her hidden cunt quivers, desperate for attention as you milk her over-sensitive mammaries.  Her breathing becomes more irregular, her long legs quaking and eyes rolling back as you squeeze out " + UnitSystem.literalGallon() + " after " + UnitSystem.literalGallon() + ".  Her whimpers of pleasure become outright cries, piercing the quiet of camp with orgasmic moans and shrill screams as your fingers work their magic on her, sending shockwaves of pleasure from hefty teats to sex-addled mind  that make her entire body convulse and writhe at your touch.");
...
private function finishMilkNormall():void {
	clearOutput();
	outputText("You whisper a few soothing words into " + flags[kFLAGS.MILK_NAME] + "'s ear, but are unrelenting in your task.  With squeezing and kneading fingers, you continue to coax the milk from her tits until she's practically white with flowing cream.  A few minutes later though, you can physically feel her explode over the edge of bliss: the stream of milk from her stiff nipples doubles, blasting an arc several " + UnitSystem.literalFeet() + " long as her voice breaks, a shrill cry to the heavens; " + flags[kFLAGS.MILK_NAME] + "'s entire body shudders, her legs nearly giving out as the boobgasm rocks her slender frame.");
...
private function suckleDatMilk():void {
	...
	outputText("\n\nIn response to your gentle suckles and the flicking of your tongue across her sensitive buds, " + flags[kFLAGS.MILK_NAME] + " whimpers and shivers, your every touch electric to the ever-lactating girl.  Her slender arms wrap around your shoulders, holding herself to you as you greedily drink from her bountiful reserves.  She gasps as you reach down and sink your fingers into the full orbs of her ass, rubbing and kneading the soft, yielding flesh just as you did her breasts before.  Her cute gasps of pleasure fill the air, and she gives a shrill cry of surprise and ecstasy as you switch from one leaking teat to the other, which explodes a deluge of milk into your waiting mouth at the barest touch, flesh quivering in motherly release as you drink " + UnitSystem.literalGallon() + " after " + UnitSystem.literalGallon() + ".");
...
private function titFuckDatMilkSlut():void {
	...
	outputText(" your [cock] deep into her mouth.  " + flags[kFLAGS.MILK_NAME] + " accepts it eagerly, opening wide as you stuff " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of your manhood down her throat.  Now she can really go to work: her lips wrap tight around your base, tongue lapping at your underside like candy as her throat muscles massage the shaft.  You slide in and out, watching her throat bulge and contract with each thrust");
