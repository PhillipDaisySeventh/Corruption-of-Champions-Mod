package classes.Scenes.Monsters 
{
	...
	public class DemonSoldier extends Monster
	{
		...
		private function demonPhysicalAttack():void {
			...
			if (attackChooser < 3) {
				...
				if (player.getEvasionRoll()) {
					...
					var dmg:int = this.str + this.weaponAttack + 10 + rand(30);
		...
		public function DemonSoldier() 
		{
			...
			var bonus:int = rand(4); //Add some offset. Additional HP/damage with higher levels.
			this.level = 16 + bonus;
