package classes.Scenes.Monsters.pregnancies 
{
	...
	public class PlayerMinotaurPregnancy implements VaginalPregnancy
	{
		...
		public function PlayerMinotaurPregnancy(pregnancyProgression:PregnancyProgression ,output:GuiOutput) 
		{
			this.output = output;
		...
		public function vaginalBirth():void 
		{
			...
			output.text("He suckles and suckles and suckles, leaving you to wonder just how much milk you were actually holding, but even as you wonder this, your eyes grow wide as the newborn minotaur begins to grow. He gains " + UnitSystem.literalInches() + " at a time, his horns starting to grow from his skull, his muscles rippling and thickening, his cock lengthening, his balls swelling. He reaches " + UnitSystem.displayHeight2EstimateTextually(4) + " tall, but keeps growing, soon then " + UnitSystem.displayHeight2EstimateTextually(5) + " tall, starting to resemble more and more the monster who sired him. Finally, he pulls off your breasts, and finishes his milk-inspired growth spurt at " + UnitSystem.displayHeight2EstimateTextually(6) + " tall, looking practically full grown. His one gesture of gratitude for being brought into the world is a slobbery lick at your cheek, then he turns and runs off towards the mountain, leaving you to recover from the ordeal.  You swiftly pass out.\n\n");
