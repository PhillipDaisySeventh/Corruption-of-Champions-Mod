		...
		*/
		...
		public function goblinElderBeatYaUp():void {
			...
			if (player.cockThatFits(monster.vaginalCapacity()) >= 0 && player.hasCock() && (!player.hasVagina() || rand(2) == 0)) 
			{
				...
				outputText("\n\nYour response is as immediate as it is enthusiastic.  You tell her exactly what she wants and then some more, panting and moaning as the elder's nimble fingers tickle every throbbing-hard " + UnitSystem.literalInch() + " of your over-filled fuck-tool.  It spews another rope of pre so thick and white it may as well be the real deal as you finish, begging, \"<i>Yes, I came here for your delicious, juicy cunny.  Please, fuck my cock.  I need it so bad!  I’ll do anything!</i>\"");
...
//[FEMSAUCE]
		private function gobboGetsRapedFem():void
		{
			...
			//Goblin victory rape, female naga:
				...
				outputText("You pull it out and examine it.  Not much more than " + UnitSystem.anInch() + " long, it's filled with a white fluid.  There's a label, but the lettering is far too small to read.  You think you can make out the word \"<i>wake</i>\", but aren't entirely sure.\n\n");
