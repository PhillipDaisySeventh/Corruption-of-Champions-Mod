...
public function startUrtaQuest():void {
	...
	outputText("\n\nBetween your legs are your mixed sexes; a slick and accommodating pussy well-trained with sex toys, and a monstrous prick fit to give the average stallion an inferiority complex.  The arm-like equine cock, " + UnitSystem.displayInches(20) + " long and " + UnitSystem.displayInchesTextually(3) + " thick, rests above balls that, at over " + UnitSystem.displayInchesTextually(3) + " thick, are easily the size of apples.");
...
private function fuckHelAndKitsunesAsUrta():void {
	...
	outputText("\n\nYou nod eagerly, desperate to cum, to blow your thick load all over the three girls, to paint them milk-white with your seed.  You let yourself be pushed up, one of the fox-twins - Miko, you think - crawling underneath you.  Her added height is just enough to push the first " + UnitSystem.literalInches() + " of your rod into Hel's cunt, her clawed fingers spreading her wide enough to take your massive girth.");
...
private function urtaPutsHerDickInPCsWithDicks(truth:Boolean):void {
	...
	else outputText("  Unfortunately, there's not much give in " + player2.mf("his","her") + " back-door, and you have to sit there smearing pre over it, again and again, each time pushing a little harder.  After what feels like the fiftieth try, you finally pop your fat flare into " + player2.mf("his","her") + " rectum, the tight anal heat causing you to flare from the force of " + player2.mf("his","her") + " pressure.  Slowly, you push " + UnitSystem.literalInch() + " after throbbing " + UnitSystem.literalInch() + " of your swollen, stallion-like erection into " + player2.mf("his","her") + " asshole.");
...
public function urtaLosesToGoblin():void {
	...
	outputText("\n\nYour drug-hazed mind fills with her words and is easily overwhelmed with thoughts of your sexy wife bucking and riding your massive, mustang manhood.  Just the fantasy of her screaming in ecstasy as you stuff her womb, impregnating your darling love, forces another " + UnitSystem.inch() + " of your dick inside her and bloats your balls even more.  \"<i>S-stop teasing me, honey.  I want to feel your perfect pussy so badly,</i>\" you say as your hands slide over her curvy hips and perfectly round ass.  You can't help but feel lucky to have a beautiful wife like her.  You're so drugged up with the goblin's special brew that the idea that something might be wrong about this never enters your mind; all you can think of is how you want to plow your lover's cunt and breed her womb full of slutty daughters.");
	...
	outputText("\n\nGetting right into it, you lose what's left of your rational thoughts in the act of rampant sex.  The only desire in your drugged out, horny and hypnotized mind is to fuck and breed your beautiful goblin wife pregnant over and over.  The fact that your sterile seed won't do anything but bloat her belly with useless spooge never crosses your mind.  Gritting your teeth, you feverishly pound your arm-like stallion cock into her hot, green depths.  Burning arousal fills both your bodies, forcing you closer and closer to your first massive orgasm.  Letting out a shriek of pleasure, your lovely wife beats you to it.  Consumed with eye-crossing ecstasy, she claws at the ground as her stretched cunt clenches around you so tightly you can't pull out even " + UnitSystem.literalAnInch() + " to make another thrust.  With your massive, musky member locked firmly within the vice-like grip of your beloved's welcoming body she lets out a pained groan of ever growing desire, and you discover that you don't have any need to move.  The sweltering, slippery goblin pussy spasming around you gives you all the sensual stimulation you need to finally reach your earth-shattering orgasm.");
...
//Gone	menuLoc = 3;
	...
	addButton(5, "SecondWind", urtaSecondWind).hint("Regain 50% of your HP, 50 fatigue, and reduce lust by 50 once per fight.", "Second Wind");
...
public function useSuccubiMilkOnGnollPrincesses():void {
	...
	outputText("\n\nAnnoyed, you give one of her hefty jugs a slap and buck your hips forward, mashing your head into her mouth.  The gnoll snaps her black-painted lips closed, resisting you until another boob-smack makes her yelp with pain, giving your meaty cock entrance to her oral embrace.  Your captive slut gags around your girth as you push the first " + UnitSystem.literalInches() + " into her mouth, desperately shaking her head, trying to dislodge you.  A few moments of stiff resistance breaks her down, though, and soon you feel her coarse tongue lapping at your sensitive underside, her throat contracting hard around your flared head.  You can't be sure if she's got experience or just natural cocksucking instincts, but either way, the girl's soon sucking your cock like a wanton slut, swallowing every drop of pre her tits massage out of you with lusty abandon.");
...
private function loseToGnollAsUrtaEpilogue():void {
	...
	outputText("\n\nBefore a single, \"<i>Yes, Ma'am,</i>\" cuts the air, a dozen grabbing paws are taking hold of you and pushing you over the table.  Your tits press down on the smooth wood, displacing a bowl and spoon, while a plate is caught under your left nipple.   Jutting up against your nose, a " + UnitSystem.displayInchWithHyphenTextually(4) + ", black gnoll-prick grows excitedly.  Reacting without thought, you open wide, grab it with your tongue, and pull it inside your mouth.  \"<i>Mmmmm,</i>\" you hum, lapping at the small phallus excitedly.  It tastes nice, if a little bit salty, and it quickly begins to ooze sweet pre-cum on your tongue.  You suck in a little, just enough to make it a little harder, and look up at your fellow slave through bleary eyes, winking while you fellate him.");
	...
	outputText("\n\nThe rest of the herd of slave-boys jostles and jockeys for position, and before you know it, two cocks have been placed in your hands.  You jerk on them encouragingly, squeezing each of the " + UnitSystem.displayInchWithHyphenTextually(5) + " boners with gusto.  The extra dicks do nothing for your hungry, quivering gash.  It needs something - anything - inside it!  Some of the gnolls are trying to get to it, but the big, butt-fucking male refuses to move.  He's too enamored with your tight anal walls to even consider moving.");
...
public function urtaSubmitsToMinotaurBadEnd():void {
	...
	outputText("  Your once foe removes his loincloth to fully expose the mammoth between his legs, " + UnitSystem.displayFeetEstimateTextually(3) + " long and nearly twice as girthy as your own.  You're so dazed by his imposing manhood, that you totally miss him flinging his loincloth at you.  It smacks wetly into your face, smothering you in his syrupy spooge.");
...
public function winRapeAMinoLordAsUrta():void {
	...
	outputText("\n\nYou resume your steady push, easily compressing the bull's soft internal organ with your blunt cock-hammer.  He shifts slightly, but holds still when you grab his tail for leverage and push harder.  His prostate bows under the pressure.  Then, when it's almost painful to keep thrusting, it gives, letting you ram " + UnitSystem.displayInchesTextually(4) + " inside in seconds.  He pants, his voice high-pitched.  You can definitely feel his asshole clenching from that, and what's more, you can hear a torrent of fluid spraying from his cock-tip.");
	...
	outputText("\n\nWhen you pull out, the " + UnitSystem.displayInchWithHyphenTextually(3) + " wide gape and river of horse-cum draining out of his ass makes him look a little less tight.  Well, you hope the succubus didn't have any plans for his ass - it'll likely never forget your dick.");
...
private function preggedUrtaWithGodChildEpilogue():void {
	...
	outputText("\n\nThe ball unfolds itself, one spindly leg at a time, each covered in a short layer of fuzz.  The limbs seem too tiny, too frail, even for a creature new to this world.  A hand disengages itself from the rest of the mass, stringing the clear birthing fluids behind it, revealing an equally frail-looking arm.  You can see its head now, fox-like, with a long vulpine muzzle and large, luminous eyes.  The newborn rises on its newly revealed limbs and stretches, standing almost " + UnitSystem.displayHeight2EstimateTextually(5) + " tall when fully unfolded.");
	...
	outputText("\n\nUrta nods down at the child-god, now standing almost " + UnitSystem.display("five-foot six", UnitSystem.displayHeight2EstimateTextually(5, 6)) + ".  He gives a wry smile and a mocking bow, then turns, confidently loping down a hallway.  The room erupts into chaos, the mages chasing after him, trailing at his heels.  It seems Taoth can take care of himself, and for now, you've got a newly fertile lover.");
...
private function getKnockedUpWithGodChild():void {
	...
	outputText("\n\n\"<i>Tight cunt!  Gonna... gonna... no, I gotta... gotta fill it up!</i>\" she cries, arching her back, tits jiggling over top of you as she climaxes.  Her sodden twat explodes over the back of her balls, splattering wetness in a " + UnitSystem.displayFootEstimateWithHyphenTextually(5) + " cone behind her.  At the same time, that slick sack begins to twitch again and again.  It feels like it's vibrating against your [butt], actually shuddering as liquid weight shifts and moves, pumping through the cock-bitch's interior.  Her sheath peels back a little further, and the gigantic equine length inside you distorts slightly, the fat shaft stretching your lips even wider as a huge wad of cum travels through the turgid horse-cock.");
