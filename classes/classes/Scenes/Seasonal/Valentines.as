package classes.Scenes.Seasonal {
	...
	public class Valentines extends BaseContent 
	{
		...
		public function feedScyllaVDay():void {
			...
			outputText("You feed Scylla what feels like " + UnitSystem.aGallon() + " of jizz!");
			player.orgasm('Dick');
		...
		public function goVisitAbby():void {
			...
			outputText("\n\nNodding, you go in and make yourself at home, before Abylon tugs at your hand and seemingly continues to remove her dress, showing herself to you naked, in all of her small, " + UnitSystem.display("couple of feet", UnitSystem.displayHeight2EstimateTextually(2)) + " tall \"<i>glory</i>\". \"<i>W-well, time for you to show what you're made of, champ,</i>\" she says, bending around a small table, wiggling her posh bottom at you with a look of certain hunger and restlessness to her eyes.");
			menu();
			if (player.hasCock()) {
