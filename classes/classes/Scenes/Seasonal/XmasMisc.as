...
package classes.Scenes.Seasonal {
	...
	public class XmasMisc extends BaseContent
	{
		...
		public function takeItRooButtStyle():void {
			...
			outputText("\n\n\"<i>Oh shit!</i>\" she cries, her plump hips pistoning into your [asshole] recklessly.  You estimate at least " + UnitSystem.displayInchesEstimateTextually(8) + " of her meaty member are inside with the first few thrusts alone, not including however many she's already trying to squeeze in. You feel her thick tail brush along your thighs, shivering as she whispers into your ear. \"<i>I'm going to pump you so full of cum, you'll be out of commission for weeks, doll.</i>\"   You try to focus your attention on absorbing her powerful thrusts, gradually easing into it as her lubricants soften up your hot passage.  Eventually, at least " + UnitSystem.displayInchesEstimate(14) + " of pure cock slams deep into your pucker. With every buck, her balls ricochet off ");
		...
		public function KamiBlowJob():void {
			...
			outputText(" and grab the thick rod impulsively with your hand, all " + UnitSystem.displayInches(14) + " of the slick tool in your firm grasp.  Kami giggles in approval as you take the first few licks of the phallus, jerking your hand up and down its length slowly.  \"<i>Mmm... someone knows what they're doing.</i>\"  You spit on the head of her thick cock, smearing the improvised lubricant all over her girth generously, her digitigrade legs crossing and twitching agitatedly in response.  \"<i>Oh god hurry up and put it in your mouth already!</i>\"  You grin at her impatience, teasing her tip a bit longer before finally knuckling down.  Her first few " + UnitSystem.literalInches() + " slide in with much resistance, fresh saliva coating the shaft and easing her in against your tonsils smoothly and without fuss.");
		...
		public function unwrapPolarPete():void {
			...
			outputText("\n\nPanting heavily as his groin rams your face, his fat black sack slapping your chin.  His massive candy cane opens your jaw wide, plunging down your throat as he stretches the silken walls of your insides.  Your throat visibly bulges from the outside as his giant pole plows into your mouth, every " + UnitSystem.literalInch() + " of his dark dick glistens with your spit mixed with his creamy, mint flavored spunk.");
			...
			outputText("\n\nHis entire length hilting in you again and again, both your holes stuffed with Polar Pete's gifts.  He rubs his south pole all over your inner confines, angling his thrusts to grind and smear his warm seed against every " + UnitSystem.literalInch() + " of your chimney.  Your ass cheeks jiggle as his hips ram into them, coaxing muffled moans from your gagged mouth.");
		...
		public function approachNieve():void {
			...
			outputText("\n\nThe ice spirit is about " + UnitSystem.displayHeight2EstimateTextually(5, 10) + " tall.  " + nieveMF("His","Her") + " skin is a pale blue that reminds you of a frozen-over lake.  Between " + nieveMF("his","her") + " thighs, " + nieveMF("he","she") + " sports " + nieveMF("a dark blue human-like cock that appears to be about " + UnitSystem.displayInchesEstimate(9) + " long","a pair of dark blue pussy lips") + ".");
			//[Silly Mode:]
		...
		public function takeNieveVaginal():void {
			...
			//if (corruption > 50) 
			else outputText("\n\nYou ask your toy if he's playing coy, to which he merely gives you another sidelong glance.  You then grab him by the chin and force him to look into your eyes, barely " + UnitSystem.literalAnInch() + " away from each others faces.  You whisper that he's going to empty those pretty blue balls of his directly into your womb, and he'd better get started.  Right.  Now.");
			...
			outputText(".  He slams his " + UnitSystem.displayInchWithHyphenTextually(9) + " blue rod balls deep into your sodden box.  A loud squelch fills the air at the penetration, giving Nieve the go ahead to start in top gear, pistoning in and out at a hurried pace.");
			//[if (hasCock = true)
