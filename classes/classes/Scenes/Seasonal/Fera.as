...
import classes.Scenes.API.Encounter;
	...
	public class Fera extends BaseContent implements Encounter
	{
		...
		public function pumpkinFuck():void {
			...
			outputText("\n\nThe gushy gourd's interior does not disappoint.  Though it lacks the warmth or heartbeat of frantic copulation with a female, the slick plant-pussy is incredibly soft and pliant.  However, the walls seem to be squeezing against every square " + UnitSystem.literalInch() + " of dick that you yield to them, and a gentle suction slowly drags you in, whether you planned on going ");
			...
			if (player.cocks[0].cockLength >= 20) outputText("  After you've fed over " + UnitSystem.aFoot() + " of your [cock biggest] into the gluttonous gourd, you briefly wonder where it's all going.  The pumpkin can't be more than " + UnitSystem.aFootAndAHalf() + " across, yet it's sucking down " + UnitSystem.display("the second foot", "another " + UnitSystem.foot()) + " now, and you have yet to hit any wall!  The suction suddenly increases, yanking you deeper, faster, and you forget all about the whys, whens, and whatevers.  It feels great.");
			outputText("\n\n");
			...
			if (player.cumQ() < 1000) {
				...
				outputText("\n\nOver and over you empty your [balls] into the growing gourd, inflating it larger and larger, passionately giving up every drop of sperm to fuel its unnatural growth.  Even once you feel empty, your [cock biggest] continues to clench and pump, firing blanks in an effort to feed EVERYTHING to the semen-hungry plant.  Still, even your prodigious virility can only take so much, and once your dick starts to go soft inside the massive cunt, it releases you, allowing you to ride out the rest of your orgasm, below, on the ground.  Your descent is graceless, a lazy slide down the orange rind.  Were it not for the gentle slope, it would be a dangerous " + UnitSystem.displayFootEstimateWithHyphenTextually(6) + " fall.");
				outputText("\n\nYou thank the gods for that small mercy as you calm down and climb to your feet, beholding the sudden gargantuan growth as if for the first time.  That pumpkin is at least " + UnitSystem.displayHeight2EstimateTextually(6) + " tall, and the swollen pussy that devoured your cum?  It has grown with it, now a gash big enough to devour a man.  A few strings of semen trail from the labia to the ground, but it looks like most of your cum is vanishing into the pumpkin's depths, drank down for some purpose only the demons would know.");
		...
		public function pumpkinFuckPartII():void {
			...
			outputText("\n\nYou cry out when they slide into your ears, the slimy slickness worming into your cranium as they dribble warm lubricants everywhere.  " + capitalizeFirstLetter(UnitSystem.literalInch()) + " after " + UnitSystem.literalInch() + " of ropy green vine disappears inside you, and your first thought, aside from the panic coursing through your veins, is, \"<i>How is this even possible?</i>\"  The next one isn't nearly as cogent, as your entire body seems to light up with sensation, every " + UnitSystem.literalInch() + " of skin bathed in wet kisses, fragrant cunts, pillowy tits, and the occasional slippery dong.  It's an electric cacophony of pleasure like no other.  All of these sensual caresses move together, a perfectly orchestrated ballet of erotic movement timed to the rhythm of the gently thrusting ear-tentacles.");
		...
		public function mountPumpkin():void {
			...
			if (player.pregnancyIncubation > 0 || (player.wetness() < 2 && player.totalFertility() < 30)) {
				...
				outputText("\n\nThe gourd's oozing stem does not disappoint.  Though it lacks the warmth or heartbeat of frantic copulation with a male, the slick plant-cock is both hard and pliant.  However, the shaft seems to be pulsating against every square " + UnitSystem.literalInch() + " of pussy that you lower onto it, and that gentle pulsing slowly draws you down, whether you planned on going to the hilt or not.  Not that you mind - the pulsing plant seems to be doing an adequate job of stimulating your walls as it passes through your glossy gates.");
		...
		public function pumpkinMountingLevelII():void {
			...
			outputText("\n\nYou cry out when they slide into your ears, the slimy slickness worming into your cranium as they dribble warm lubricants everywhere.  " + capitalizeFirstLetter(UnitSystem.literalInch()) + " after " + UnitSystem.literalInch() + " of ropy green vine disappears inside you, and your first thought, aside from the panic coursing through your veins, is <i>\"How is this even possible?\"</i>  The next one isn't nearly as cogent, as your entire body seems to light up with sensation, every " + UnitSystem.literalInch() + " of skin bathed in wet kisses, pulsing cocks, fragrant balls, and the occasional slippery cunt.  It's an electric cacophony of pleasure like no other.  All of these sensual caresses move together, a perfectly orchestrated ballet of erotic movement timed to the rhythm of the gently thrusting ear-tentacles.");
		...
		public function feraSceneTwoIntroduction():void {
			clearOutput();
			outputText("While you're walking through the deepest, darkest parts of these overgrown woodlands, you come across a wild glade, filled with hundreds and hundreds of the most beautiful blossoming flowers. They cover the " + UnitSystem.displayQualifiedFeetEstimateTextually(100, "or so ") + " across the clearing densely, some small, like dandelions and orchids, others enormous, on stalks as thick as small tree-trunks, blooming so vibrantly that you find yourself rubbing your eyes after gazing at them, dazzled by their many hued palettes. Sweet aromas of a thousand types of flowers blend together into a symphony of nasal delight, and you breathe deep, laughing loudly and openly at this wondrous find.");
		...
		public function dickBoostingFuntimes():void {
			...
			outputText("\n\nOn command, you pound away, causing the huge pillows to shiver and shudder with your slap-happy impacts, feeling the tightness of an on-command orgasm building deep within you, as inexorable as the rising tide. Your eyes cross from the pleasure, and you hilt yourself, erupting what feels like " + UnitSystem.literalGallon() + " after " + UnitSystem.literalGallon() + " of sticky, fertilizing spooge into the suck-hungry passage, flooding it with your jism.");
		...
		public function tightLikeAToigar():void {
			...
			outputText("\n\nThe tentacle's inky spots expand to big, black blotches before combining together to turn the first " + UnitSystem.literalFoot() + " of the thing into a rubbery onyx dong.  The corrupted, sextoy-like texture spreads like wildfire down the stalk and beyond your view, though you're sure it must stop somewhere, because the other tentacles never change color.  That succulent syrup that leaks from the tip changes to the same color, every bit the same tone but still completely liquid, dripping down off of it to splatter wetly on the floor as Fera strokes it once more.");
