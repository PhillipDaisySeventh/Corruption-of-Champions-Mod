...
package classes.Scenes.Seasonal {
	...
	public class XmasJackFrost extends BaseContent
	{
		...
		public function rideCorruptJojoCock():void {
			...
			outputText("\n\nNow that's what you like to hear, and you promptly impale yourself on Jojo's handy shaft, brutally forcing it " + UnitSystem.literalInch() + " by " + UnitSystem.literalInch() + " inside you until you have forced him to the ground with your efforts.  Moaning with satisfaction at being stuffed, you begin to roughly rise and fall, pistoning back and forth in order to sate your pleasures.");
