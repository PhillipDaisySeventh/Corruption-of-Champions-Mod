package classes.Scenes.Dungeons.AnzuPalace 
{
	...
	public class AnzuScene extends BaseContent// implements TimeAwareInterface
	{
		...
		private function apporachInitialPalace():void {
			...
			outputText("\n\nHiding yourself in the treeline, you approach within " + UnitSystem.aFewFeet() + " of the building. On a closer inspection, the palace looks to be in good condition. ");
			if (player.inte < 60) {
				...
				outputText("\n\nBefore you is a kind of avian, about " + UnitSystem.displayHeight2EstimateTextually(18) + " tall, with an intimidating appearance, and judging by his expression, highly irritated by the discovery that he isn’t alone in his house. Perhaps entering without permission wasn’t the smartest idea…");
				outputText("\n\nUnfortunately, he doesn’t give you much time to think about it, because either your hiding place was terrible, or he has to deal with intruders so often that now he can detect them easily. Before you realize it, the avian approaches you menacingly, and in the blink of an eye, grabs you by the neck and holds you " + UnitSystem.aFewFeet() + " in the air. He really must hate unannounced visitors. ");
				...
				outputText("\n\nWalking towards the palace facade, you easily find the door. It’s huge, about " + UnitSystem.display("twenty-four feet", UnitSystem.displayFeetEstimateTextually(24)) + " of solid iron. A little doubtful, you knock the door three times. Initially, it looks like there is no one inside as there is no answer, but soon heavy steps are heard gradually approaching the door.");
				outputText("\n\nA little nervous, you aren’t prepared for what comes out of the door. A kind of anthro bird, about " + UnitSystem.displayHeight2EstimateTextually(18) + " tall, with golden-orange hair tipped in red feathers, a head covered in golden and orange feathers in an autumnal pattern, and eyes with turquoise irises and a dark turquoise sclera which is staring at you.");
				outputText("\n\nHis build is strong and imposing, wearing purple robes studded with gold and amethyst. Under his robes he appears to wear a white shirt and brown pants. Judging from the bulge in his pants he is no \"<i>little</i>\" man. On his back he has four wings covered in a pattern of gold, light green, and dark teal feathers with purple feathers on the tips. Behind him, a tail made of a fan of turquoise feathers, equally ending on purple tips, swishes from side to side, while he awaits patiently your answer.");
		...
		public function anzuTransition():void {
			if (anzuRelationshipLevel() == 1) {
				...
				outputText("\n\n\[name], you’ve truly been the best friend I could asked for. But lately, each time that you visit me, I’ve started to feel different. I don’t know how to say it…This is the first time on my entire existence I’ve felt like this. Well, I think that I…</i>\"");
				outputText("\n\nYes?");
		...
		private function anzuAppearance():void {
			...
			credits.modContent = true;
			credits.authorText = "Coalsack";
			outputText("Anzu is a " + UnitSystem.displayHeight2Short2(18, 2) + " tall avian, with a strong and athletic build, worthy of a god.");
			...
			outputText("\n\nCovered for now in his clothing, his avian cock is " + UnitSystem.displayInches(38) + " long and " + UnitSystem.displayInches(4.8, 1) + " wide, with two cantaloupe sized balls hanging below. His robes hide the gargantuan bulge relatively well, but you still can see the outline of his penis sometimes.");
		...
		private function anzuTalkPowers():void {
			...
			outputText("\n\nOnly a couple of times. The first was almost two thousand years ago. The Council was in formation. I was a low-ranking member in those times, and the land was inhabited by horrid monstrosities standing " + UnitSystem.display("hundreds and hundreds of feet", "a hundred " + UnitSystem.meter()) + " tall. Some even reached the thousands. We the Annuna cannot establish our supremacy over the mortals with those creatures wandering around. Then I created and perfected this ability. The rest of the Annuna tried to do the same, with poor results. Impressed by my capacity, Enki elevated me to middle-rank and put me in the front to fight those monstrosities. After a century and half, the beasts were totally eradicated.");
			...
			outputText("\n\nHe says, pointing to a pair of knives on the wall. Almost " + UnitSystem.displayFeetEstimateTextually(5) + " long each, they’re bathed in a layer of gold. Each one has the shape of a wing, with an intricate pattern of feathers. When you approach to see them better, you notice how the ‘feathers’ protrude past the blade. They are in reality a set of sharp spikes, vicious enough to tear away the flesh of anything unlucky enough to get too close to them.");
			outputText("\n\n\"<i>But, between all those, I prefer this.</i>\"");
			outputText("\n\nAnzu shows you a huge sword, almost " + UnitSystem.displayFeetEstimateTextually(8) + " long, covered in gold and decorated with blue and white gems. A bird decorates the pommel, and the blade is decorated with a letters in a strange language.");
		...
		private function catchAnalPart2():void {
			...
			outputText("Climbing over him, you " + (player.hasLongTongue() ? "wrap your nimble tongue around" : "start caressing and licking the sides of") + " his partially hard avian meat. After a bit of licking across its length, you switch you attentions to his tip, taking the point of the tapered penis on your mouth and sliding playfully your tongue on his cumslit. Soon, the " + UnitSystem.displayInchWithHyphenTextually(40) + " rod rises to full erection, and the first droplets of pre dribble from his tip and land in your tongue. You remove your mouth and take some of his leaking pre in your hand, smearing it carefully across your soon-to-be ravaged [asshole]. Despite being already lubed by your saliva, you take some more pre and use it for lube every corner of Anzu’s semi-hard maleness.");
			...
			outputText("\n\nFollowing his advice, you slowly take the meaty tool on your anus, letting out a whorish moan as you feel the dripping maleness invading your butt. Already lubricated with his copious amounts of pre, the first " + UnitSystem.literalInches() + " of his cock slide in easily.");
			...
			outputText("\n\nHis hands go to your hips, grabbing " + (player.isNaga() ? "your coils" : player.isTaur() ? "your rear and hind legs," : "your lower body") + " and making use of his strength to raise up your body, and insert and slip out the first " + UnitSystem.displayInchesTextually(9) + " of his gigantic erection of your ass with teasingly slow pace. Despite his slow motions, " + (player.hasCock() ? "your [cock] rises hard" : "your body tingles") + " at the anal stimulation. When you thought that he finished to play with you, he raises your ass from his cock, leaving only the first " + UnitSystem.literalInches() + " of his tip teasing the entrance of your backdoor.");
			...
			outputText("\n\nThen, without warning, you feel almost " + UnitSystem.displayInchesEstimateTextually(11) + " of pure avian meat invading your [asshole] in a single thrust. Yelping at the sudden intrusion, you’re given a few seconds to rest as the thick penis slides out, before Anzu rams his cock inside again, this time a few " + UnitSystem.literalInches() + " deeper. You moan like a whore each time that the monster makes its way on your [asshole].");
			...
			outputText("\n\nWith each thrust more and more " + UnitSystem.literalInches() + " of the huge tool invade your ass. The copious pre that it dribbles mixes with some cum from his last load, leaving your backside sticky with it. Not that you have time to think about it, because almost " + UnitSystem.displayInchesEstimateTextually(30) + " of cock are making its way inside you. For a second you’re worried about him trying to ram his entire cock inside, but your friend seems to recognize the logic limits of your body, and stops at this rate. Not that his vigor diminishes, as he compensates this increasing the speed and strength of his already energetic thrusts. Y" + (player.hasCock() ? "our poor prostate is thoroughly smashed by his invading dick, while y" : "") + "our nipples get as hard as diamonds by your overstimulated state.");
		...
		private function getBlown():void {
			...
			outputText("\n\nYour misconceptions about getting a blowjob from him quickly prove themselves wrong at the wonderful feeling of his tongue worshipping every " + UnitSystem.literalInch() + " of your [cock], leaving it thoroughly slicked and covered on his saliva. At the same time his digits keep teasing your ass, and finally, finding their way to your prostate, prodding it gently.");
		...
		private function fuckGodlyBirdButt():void {
			...
			outputText("\n\nThen your cock meet the entrance of his rosebud, then, you start to penetrating him, slowly at the start, " + UnitSystem.literalInch() + " by " + UnitSystem.literalInch() + ", and then you increase your pace, until half of you cock is buried inside. A moan of delight escapes from Anzu’s mouth while you thrust inside him. If the hardness of his cock proof anything, he must be really enjoying this.")
		...
		private function racingWithAnzuAccept():void {
			...
			outputText("\n\nSeeing you ready, Anzu spreads his wings wide, forcing you to stand away " + UnitSystem.display("a couple of feet", "half a " + UnitSystem.meter()) + ", and soon he launches himself to the sky. The wind propelled by the beating of his wings almost makes you stumble, but you manage to keep yourself on your feet.");
		...
		private function sleepingWithAnzuBlowjob():void {
			...
			outputText("\n\nSofty disentangling yourself from the avian’s embrace, you try to get off from the unsurprisingly tall bed, without luck, as your " + player.feet() + " get stuck with something as you climb down the bed. Then, a familiar wetness near the area where your [leg] got stuck, reinforced with a tugging from the thing that refrains you from leaving, makes you turn back, only to found that the thing entangled with your " + player.foot() + " is nothing less than the avian’s underwear.");
			outputText("\n\nWhat a…curious way to get stuck. Adjusting yourself to get your " + player.foot() + " free, you end in an even more uncomfortable position, as you end up with your " + player.faceDescript() + " on Anzu’s crotch, and your " + (player.isNaga() ? "tail swishing over" : "[legs] resting on") + " the huge avian’s lower belly. In this position, you get a much closer look to the avian’s underwear, and realize that its cloth is tented and with a wet spot on the top. This, added to the subtle noises and moves that he makes from time to time, is a clear signal that the avian is having a…rather naughty dream.");
			...
			outputText("\n\nBit by bit you engulf more and more " + UnitSystem.literalInches() + " of bird meat on your " + player.faceDescript() + ", " + (player.tallness >= 120 ? "and despite having some problems with the final " + UnitSystem.literalInches() + ", manage to get most of it on your " + player.faceDescript() + " on your throat" : player.tallness >= 60 ? "and having troubles past " + UnitSystem.displayInchesTextually(15) + ", as its tip touches the back of your throat, you decide to stop at this point" : "the tip itself being a mouthful, you struggle to get past a few " + UnitSystem.literalInches() + " though your throat") + ". Nevertheless, you try to make the most of it and take as much of his dick as you can.");
