		...
		*/
		...
		public function memeberedFolksFindTrueWuv():void {
			...
			if (player.HP < 1) {
				...
				outputText("\n\nA short witch shoulders through her sisters to appraise you.  Her sisters part before her confident strides with a surprising degree of deference, even though this woman is at least " + UnitSystem.aFoot() + " shorter than most of them.  She doesn't even have huge breasts!  They might be double-D's or E's if she's lucky.  Obscuring a great deal of the right half of her face, a swirling tattoo with patterns intricate enough to make your vision swim clearly differentiates her from her cohorts.");
			...
			//Lust
				...
				outputText("\n\nOne of them, a shorter girl with a mass of interlocking arcane tattoos emerges from the crowd.  She's got a tight body with two surprisingly modest sets of DD-cup tits.  If she weren't nearly " + UnitSystem.aFoot() + " taller than the rest, those boobs would look tiny by comparison, but they're perfectly proportional for her frame.  The other girls give her plenty of room as she closes in on you, perhaps out of respect or fear.  She eyes you while you lewdly grope yourself, eventually speaking.");
		...
		public function repeatLoseToCumWitchForDudes():void {
			...
			if (player.cockThatFits(monster.vaginalCapacity()) < 0) {
				...
				outputText("\n\nYou black out when she prods your groin with a fresh tingle of magic, launching a torrent of jism " + UnitSystem.aDozenFeet() + " into the air in the process.");
		...
		public function TDMsLoseToCumWitchScene():void {
			...
			outputText(" the flow of her constantly dribbling pre, tingling with magical power is something that you've never felt before.  Making things more interesting, the position that you're in leaves your grip on her dick remarkably different than how you'd grab your own while masturbating.  Of course what is important is that you want to rub every last " + UnitSystem.literalInch() + " of her lovely length, and feel every second of it through her strange spell.  The feeling of your cum being sucked out of your [balls] only makes the whole experience feel even better.");
		...
		public function cumWitchDefeated():void {
			...
			//3+ Tentas
			if (player.countCocksOfType(CockTypesEnum.TENTACLE) >= 3) addButton(2,"Tentacles",tentacleVictoryGangbangCumWitch).hint("Fuck the Cum Witch with your tentacle cocks.");
			//Female Victory Sex
		...
		internal function sphinxAppearance():void {
			...
			outputText("\n\nSanura has a pair of soft, round C-cup breasts, each with a " + UnitSystem.displayInchWithHyphen(0.5, 1) + " nipple at their tip.");
		...
		public function fuckDatLionPussah():void {
			...
			else if (player.cumQ() < 10000) outputText("\n\nSanura's belly distends, looking suddenly pregnant with an enormous cum-baby.  A veritable flood of spooge surges out of her abused cunt, absolutely coating your lower body and almost all the sand within several " + UnitSystem.literalFeet() + " in the hot white fluid.");
			else outputText("\n\nSanura's belly expands outwards, as though she were suddenly nine months pregnant, but it doesn't stop there.  Her belly continues to inflate until it's resting on your stomach... and then it lifts her body off several " + UnitSystem.literalInches() + " of yours.  To top it all off, a milky white flood of biblical proportions flows out of her abused hole, coating your entire body, as well as most of the desert within " + UnitSystem.displayFeetEstimateTextually(10) + ", in semeny goodness.");
		...
		public function fenPutsHisShittyFetishInYoSphinx():void {
			...
			outputText("\n\nThe butt-breaking horse-cock releases enough cum into you to make your middle audibly gurgle and your belly begin to distend, flooding your intestines with tingles and liquid warmth.  Thankfully, Sanura slowly begins to pull out, even as she's cumming, her cock flexing in your brutalized asshole for every " + UnitSystem.literalInch() + " it's pulled past, leaving enough goo in its wake that your innards never get to relax.");
		...
		public function sexWithFriendlySandMother():void {
			...
			menu();
			//friendly cunt fuck:
			if (player.hasVagina()) addButton(0, "GetMilkFill", lesboMilkFilling).hint("Get into female sex with the Sand Mother and get your vagina stuffed with milk!", "Get Milk Fill");
		...
		public function sandMotherPOMenu():void {
			...
			if (player.lust >= 33) {
				...
				if (player.countCocksOfType(CockTypesEnum.TENTACLE) >= 5) addButton(2,"TentacleBang",tentacleGangBang).hint("Fuck the Sand Mother with your tentacle cocks.", "Tentacle Bang");
		...
		public function defeatTheSandMother():void {
			...
			if (player.countCocksOfType(CockTypesEnum.TENTACLE) >= 5) addButton(3,"TentacleFuck",tentacleGangBang).hint("Fuck the Sand Mother with your tentacle cocks.", "Tentacle Fuck");
		}
		...
		public function fuckTheSandMothersCunt():void {
			...
			outputText(".  She moans out loud, throwing her bleached tresses around wildly in pleasure while " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of cock snakes into her passage");
			if (y >= 0) outputText("s");
		...
		public function loseToSandMotherBadEnd():void {
			...
			outputText("\n\nNo!  You try to squirm out from under her, but with her deft caresses and your recent combat, your muscles are as weak as a babe's.  You can't even roll over to make a crawl for it.  The best you manage is a weak rocking from side to side and pushing yourself " + UnitSystem.anInchOrTwo() + " towards the exit, which seems further away than ever.  Your [hips], reacting to a particularly skillful squeeze, lurch upward, and a weak whimper escapes your mouth.  A dollop of clear pre oozes out of your tip onto the Sand Mother's soft arch, acting as lubricant for the gentle, forced footjob.  Gasping in between guttural whimpers, you slump down and submit to the insistent caresses of her toes.");
		...
		public function friendlySandMotherFuck():void {
			...
			outputText(", the hot moisture gobbling up your " + UnitSystem.literalInches() + ", clinging hot and wet to the oversensitive, pulsating dick");
			if (y >= 0) outputText("s");
		...
		public function lesboMilkFilling():void {
			...
			outputText("\n\n\"<i>Ungh, uhh... gonna c-c-u-uuuhhhhhhh!</i>\" the Sand Mother babbles, splattering wetness from her pussies onto your [butt] in a shower of girl-goo.  She screeches, \"<i>FUCK YES!  SO GOOD!</i>\" before shutting down.  with her four tits cradled in her arm, she squeezes all of them at once, and you you're suddenly stuffed with what feels like " + UnitSystem.literalGallons() + " of gushing pleasure.  Your body was climbing towards orgasm already, but the explosive injection is just too potent for your ecstatic, quivering pussy-lips to endure.  You groan as orgasmic heat radiates through you, culminating in a cunt-clenching squeeze so strong that the nipples are forced to empty inside you a moment before they're popped out.  A milky creampie drips down your [legs] as your twitching [butt] falls into the witch's lap, leaking all over her.");
		...
		public function cumWitchBlessed(virility:Boolean = true):void {
			...
			if (virility) {
				if (player.findPerk(PerkLib.MagicalVirility) < 0) {
					outputText("\n\n(Perk Unlocked: Magical Virility - " + UnitSystem.displayLitersShort(200) + " more cum per orgasm and enhanced virility.)");
					player.createPerk(PerkLib.MagicalVirility,0,0,0,0);
				}
				else if (player.perkv1(PerkLib.MagicalVirility) < 3) {
					outputText("\n\n(Perk Upgraded: Magical Virility - " + UnitSystem.displayLitersShort(100) + " more cum per orgasm and enhanced virility.)");
		...
		public function fuckAllThePregWitches():void {
			...
			//{else if cumVeryHigh-cumExtreme]}
				...
				outputText(" prepared for the deluge that explodes from your genitals.  " + capitalizeFirstLetter(UnitSystem.liter()) + " after " + UnitSystem.liter() + " pours forth, filling up ");
		...
		public function milkBathsAhoy():void {
			...
			if (!player.isGenderless()) addButton(1, "DrinkNFap", drinkNFap).hint("Drink some milk and masturbate.", "Drink & Masturbate");
		...
		public function grabTheMilkGirl():void {
			clearOutput();
			outputText("You call out to the milk slave before she can slink away, and wade over to the side of the tub, leaving your face a few scant " + UnitSystem.literalInches() + " from her massive, milk-laden jugs. She cocks her head to the side, obviously unused to the attention, and quietly whispers, \"<i>" + player.mf("M-master?","M-mistress?") + "</i>\"");
		...
		public function fuckMilkbabeWithPenor():void {
			...
			else if (player.cockArea(x) < 50) outputText("pushing your many " + UnitSystem.literalInches() + " into her until your hips join, her nice and loose cunt easily taking your length");
