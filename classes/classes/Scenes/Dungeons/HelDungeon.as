	...
	public class HelDungeon extends DungeonAbstractContent
	{
		...
		*/
		...
		public function kiriSexAnal():void {
			...
			outputText("\n\nIt takes some doing, but you eventually manage to push your prick in past her tight sphincter.  With a relieved sigh, you start to push into her ass, slowly but steadily feeding her " + UnitSystem.literalInches() + " of your [cock " + y + "] until ");
		...
		public function talkToValeria():void {
			...
			outputText("\n\n\"<i>Oh, hi,</i>\" she laughs.  She pours half-way out of your armor, forming her face a few " + UnitSystem.literalInches() + " from yours.  Kiri leaps in shock, wide-eyed as your armor becomes a new person before you.");
		...
		public function phoenixMissionary():void {
			...
			if (x < 0) x = player.smallestCockIndex();
			var y:Number = x + 1;
			outputText("You grab the healthiest looking phoenix off the top of the pile and throw the hermaphrodite on her back " + UnitSystem.aFewFeet() + " from her sisters.  She grunts, looking up at you with grim, fierce eyes.  \"<i>I'll never submit!  I am a proud warrior, not some-</i>\" Yeah, whatever.  You rip her chain shirt open, revealing the large, soft globes of her D-cups beneath.  The phoenix gasps at the sudden exposure and turns her head away, fixing her expression in place like chiseled marble, determined not to look you in the eye as you take your pleasure.");
		...
		public function phoenixWanking():void {
			...
			clearOutput();
			outputText("You grab the healthiest looking phoenix off the top of the pile and throw the hermaphrodite on her back " + UnitSystem.aFewFeet() + " from her sisters.  She grunts, looking up at you with grim, fierce eyes.  \"<i>I'll never submit!  I am a proud warrior, not some-</i>\"  Yeah, whatever.  You rip her chain shirt open, revealing the large, soft globes of her D-cups beneath.  The phoenix gasps at the sudden exposure and turns her head away, determined not to look you in the eye as you take your pleasure.  You grope one of her breasts roughly, pinching the nipple between your fingers until she's whimpering with pain and pleasure.  You let up for just a moment and tell the girl that she's going to get you off with her special endowments, or you're going to put her in a world of hurt.");
		...
		public function gitButtRoadPhoenix():void {
			clearOutput();
			outputText("You grab the healthiest looking phoenix off the top of the pile and throw the hermaphrodite on her back " + UnitSystem.aFewFeet() + " from her sisters.  She grunts, looking up at you with grim, fierce eyes.  \"<i>I'll never submit!  I am a proud warrior, not some-</i>\" Yeah, whatever.  You rip her chain shirt open, revealing the large, soft globes of her D-cups beneath. The phoenix gasps at the sudden exposure and turns her head away, determined not to look you in the eye as you take your pleasure.  Gripping the warrior by her hefty boobs, you tell the phoenix that it's her lucky goddamn day: you're going to let her fuck your ass.");
		...
		public function phoenixAginal():void {
			clearOutput();
			outputText("You grab the healthiest looking phoenix off the top of the pile and throw the hermaphrodite on her back " + UnitSystem.aFewFeet() + " from her sisters.  She grunts, looking up at you with grim, fierce eyes.  \"<i>I'll never submit!  I am a proud warrior, not some-</i>\"  Yeah, whatever.  You rip her chain shirt open, revealing the large, soft globes of her D-cups beneath.  The phoenix gasps at the sudden exposure and turns her head away, determined not to look you in the eye as you take your pleasure.  You ignore her temporary defiance and grab her cock.");
		...
		public function takeQueensStaff():void {
			clearOutput();
			outputText("You pick up the Harpy Queen's staff.  It is a tall whitewood staff, nearly " + UnitSystem.displayFeetEstimateTextually(6) + " in length, and covered in glowing eldritch runes, with a singular shimmering sphere of crystal at its head, which seems to have a swirling mist within.");
		...
		public function vaginalHarpyQueenSex():void {
			...
			outputText("\n\nHel swings her leg around, planting herself firmly over the Harpy Queen's face. She crouches down, planting her cunt just " + UnitSystem.literalAnInch() + " above the queen's nose, her long fiery tail swishing just above her cunt.  \"<i>You should feel honored, whore,</i>\" Hel growls, grabbing the queen by the hair.  \"<i>One egg fathered by my friend's seed is worth a thousand of your weakling sluts. Go on, thank " + player.mf("him","her") + "!</i>\"");
