package classes.Scenes.Dungeons.LethicesKeep
{
	...
	public class MinotaurKingScenes extends BaseContent
	{
		...
		private function dockucocku(cockIdx:int):void
		{
			...
			outputText("\n\nHis bulging flare and unique anatomy help you to wrangle the rebelliously twitching boner, aiding you in holding still while you line [cock " + (cockIdx + 1) + "] up with the dribbling slit. His flesh is hot in your hands, and his free-flowing fluids feel like bathing warm oil on your [cockHead " + (cockIdx + 1) + "]. You tremble, awash in the delirious desire to thrust it home all at once, to impale this massive beast-cock on your smaller length in one massive stroke.");
			outputText("\n\nBut you hold back for now, starting by gently easing your [cockHead " + (cockIdx + 1) + "] into the welcoming embrace of the Minotaur King’s larger erection. He grunts in discomfort at the sensation, weakly craning his head up to watch you, but after a second he slumps right back down on the ground, moaning. He’s too turned on to care that you’re feeding " + UnitSystem.literalInch() + " after " + UnitSystem.literalInch() + " of your penis into his own; he’d accept anything that would get him off at this point. What a slut.");
			outputText("\n\nYou waver momentarily, bathing your [cock " + (cockIdx + 1) + "]");
			if (player.balls > 0)
			{
		...
		private function buttufucku():void
		{
			...
			outputText("\n\nShe’s watching you too. Her hungry, soulless eyes are watching you stroke your cock, watching you line it up with the angry pucker of the minotaur King’s asshole. The corrupt Queen licks her lips when you push forward. You rub your " + player.cockHead(x) + " against her most trusted servant’s entrance, slowly splitting his derriere, reshaping it into a vessel for your pleasure. He’s tight, tighter than you would expect from such a massive creature. His asshole clutches at every " + UnitSystem.literalInch() + " of cock you feed it, almost like it wants to squeeze you off, to massage you with rapt enthusiasm.");
			...
			outputText(" You erupt a split-second before he does, squirting thick ropes of jism into his sucking asshole. Then he goes off, shooting a torrent of spunk " + UnitSystem.displayFeetEstimateTextually(20) + " into the air. Horned goblins dance in the deluge, tongues extended and hands cupped to catch as much as possible.");
