package classes.Scenes.Dungeons.LethicesKeep
{
	...
	public class LethiceScenes extends BaseContent
	{
		...
		private function plowHerPussy():void
		{
			...
			outputText("\n\nLethice’s wings beat weakly against the throne, but her tail swishes around your [chest] - a clear sign she likes everything you’re doing to her. You grin and give the slender appendage a good yank, just enough to make its owner moan and grind her hips firmly against your crotch. Keeping the other hand on her shining-red rump to steady her, you start to pull back out, slowly taking your shaft back through every " + UnitSystem.literalInch() + " of her inhumanly wet twat. You withdraw all the way back, until just your [cockHead] is spreading her pussy open. Her cavernous hole seems to be sucking you back in before you can blink, though, and before you know it you’re starting pound away at the demoness’s upraised ass with abandon.");
		...
		private function queenHer():void
		{
			...
			outputText("\n\nShe does, and you instantly regret your command. The tongue buried inside you suddenly changes in texture, growing rings of concentric, rounded nubs all along its length that rub viciously against your walls with even the slightest motion, and she’s more than happy the thrust deep inside you, pounding away like a proper cock... but with all the flexibility of a tentacle, coiling around itself and exploring every " + UnitSystem.literalInch() + " of pussy it can get. Under that kind of pressure, you can’t help but moan and gasp, putting a hand on your belly and able to feel her tongue-cock inside yourself. Your flesh bulges obscenely, straining to contain Lethice’s immense cock.");
		...
		private function boobPlay(hpVictory:Boolean):void
		{
			...
			if(player.hasCock())
			{
				...
				outputText("\n\nThankfully, you’re pretty sure the demoness’s grossly swollen tits are more than enough to keep her weighted to the ground. She’s probably put on " + UnitSystem.displayWeightEstimateTextually(50) + " of boob now, both so full of corrupted milk. You give her a gloating grin and reach up to tweak her nipples, making Lethice cry out around your [cockHead]. Now this is more like it!");
				outputText("\n\nThe Demon Queen’s finally learning her place: firmly planted on your cock, using every " + UnitSystem.literalInch() + " of her tainted body for your pleasure - and yours only. Seeing Lethice on her back, used like a common tramp, drives you wild with renewed lust. Pistoning your [hips] ever harder, you feel your climax rising steadily, milked out by the soft embrace of the demoness’s tits, now slathered with a thick coating of their owner’s milk like a glaze of lube.");
