	...
	public class MinotaurKing extends Monster {
		...
		override public function get long():String {
			...
			if (!_orgasms == 0) {
				...
				str = "Still standing between you and the Demon Queen, the Minotaur King is breathing heavily. His cock is slathered with the residue of his own potent orgasm. His immense, " + UnitSystem.displayHeight2Estimate(14) + " tall form hunches slightly as he stares at you, one hand still clutching to his axe. Driving him back to his peak would undoubtedly push him even beyond his considerable endurance. The only problem is that alluring <i>aroma</i> that surrounds him, suffusing the air with the scent of sweaty bedroom romps and sizzling pleasure. You better finish him quick.";
				if (lust100 < 40)
		...
		override public function won(hpVictory:Boolean, pcCameWorms:Boolean):void { game.lethicesKeep.minotaurKing.hailToTheKingBaby(hpVictory,pcCameWorms); }
		...
		public function lustDump():void {
			...
			outputText("\n\nA monstrous hand closes around Excellia’s torso, lifting her into the air. The curvy cow-slut does the only thing she can in such a situation - she moos and spreads her legs, a gleeful smile plastered across her excited visage. The Minotaur King doesn’t wait a second, impaling her on the spot, sliding what looks like " + UnitSystem.displayFeetEstimateTextually(3) + " of virile cock deep into his favorite slut. His balls slap against her bulging belly once he’s fully inside, getting a coating of pussy-juice for their trouble.");
			...
			outputText("\n\nExcellia’s master joins her a second later. There’s little change in the sound of his grunts. You wouldn’t even know if it wasn’t for the sudden ballooning of her belly and the cascade of cum between her legs, coating her lord’s legs in a veneer of lusty white. The amount of spunk is absolutely gobsmacking. You watch in awe as Excellia’s formerly taut belly stretches into a gravid dome. She looks like she could give birth any moment now, yet there’s nothing in her womb but " + UnitSystem.literalGallon() + " upon " + UnitSystem.literalGallon() + " of tainted minotaur spunk.");
			if (player.findPerk(PerkLib.MinotaurCumAddict) >= 0)
