package classes.Scenes.Dungeons.LethicesKeep 
{
	...
	public class HermCentaurScenes extends BaseContent
	{
		...
		private function maleFuckHer():void
		{
			...
			outputText("\n\nWith a mighty shove, you deeply penetrate her throat and begin to cum.  Your dick-slit opens as the first wave of pearlescent goo surges forth, and it flows unimpeded into the centaur's accepting belly.  At the same time, her cockhead has flared to twice the thickness of its shaft, and her balls are literally bouncing up and down in her taut sack.  Thick waves of horse-cum are pouring out of her distended cum-slit with alarming frequency, and for " + UnitSystem.aFewFeet() + " behind her, the grasses are soaked in a clear, feminine shine.");
		...
		private function femFuckHerII(cockType:int):void
		{
			...
			else if (cockType == DOGGECOCK)
			{
				...
				outputText("\n\nSmirking, you reply, \"<i>That's more like it,</i>\" even as you shift down, letting the pointed crown of her cock finally taste the juicy vulva of your pussy.  From then on, you let your box do the talking, slowly sliding down and squeezing each freshly devoured " + UnitSystem.literalInch() + " with deliberate cuntractions.  The knot stops you when it presses on your labia, your unready pussy not quite ready to take it.  Small dollops of warm dick-juice slowly roll out inside you, mixing with your own copious lube as it soaks into the centaur's underfur.");
		...
		private function maleLoss(hpVictory:Boolean):void
		{
			...
			outputText("\n\nThe equine half of your oppressor is directly above you, dripping strands of thick, female cum onto your face while her hard cock rains its pre-jizz over [eachCock] in a show of supreme dominance.  Still, you try to rise - perhaps due to foolish pride, desire, or just sheer instinct.  The centaur drops down before you get a few " + UnitSystem.literalInches() + " up, smashing her cunny into your face and bearing you to the ground.  Her weight is immense, and though some is kept on her forelegs and little spread to the haunches on either side of your face, you still get buried nose-deep in sloppy, black-lipped snatch.");
			...
			outputText(".  She wears a black reflective bra, though you swear you can see pink protrusions under the shiny fabric, wriggling around constantly.  As expected with such dress, her nipples are hard as bullets.  A bulbous, " + UnitSystem.displayInchEstimateWithHyphenTextually(10) + " penis bobs between her thighs, thickening nicely as it fills to its full size, kissing your lips with a moist bead of pre as it fully erects.  The omnibus");
