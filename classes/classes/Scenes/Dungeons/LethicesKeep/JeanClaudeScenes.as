package classes.Scenes.Dungeons.LethicesKeep 
{
	...
	public class JeanClaudeScenes extends BaseContent
	{
		...
		private function bwombBadEnd():void
		{
			...
			outputText("\n\n“<i>The demons were scared of you, thought you might bring their empire down. And you shall. I will fill you full of my eggs. You will give me dozens, hundreds of loyal soldiers and eager breeders. Whilst Lethice’s fodder fret and furrow over how to produce anything from their cursed seed except fucking imps, we will procreate, we will create an army underneath them, and then, then we shall tear them apart from within. We shall set ourselves above everyone, bring back the old ways, walk Mareth the way our ancestors did, feared by all. A Tyrannosauracy!</i>” He laughs richly as he thrusts himself deep into you, enjoying every " + UnitSystem.literalInch() + " of your [cunt] as you moan, and he goes on in a lower tone. “<i>My genes are good, but if this is to work I guess I will have to spread our bets a little. Loan you out some. You’d like that, wouldn’t you? Sleep with the crew some nights?</i>”");
