package classes.Items.Weapons 
{
	...
	public class LargeAxe extends Weapon
	{
		public function LargeAxe(tier:int, degrades:Boolean = false) 
		{
			...
			this.tier = tier;
			super(ids[tier], "L. Axe", eqptNames[tier], longNames[tier] + " large enough for a minotaur", "cleave", 15, 100, "", Weapon.PERK_LARGE); 
		}

    override public function get description():String {
			description = "This massive axe once belonged to a minotaur. It'd be hard for anyone smaller than a giant to wield effectively. The axe is double-bladed and deadly-looking. Requires height of " + UnitSystem.displayHeight2Short2(6, 6) + " or 80 strength.";
