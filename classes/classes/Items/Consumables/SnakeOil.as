	...
	public class SnakeOil extends Consumable 
	{
		...
		override public function useItem():Boolean
		{
			...
			if (changes === 0 && player.tongue.type === Tongue.SNAKE && player.face.type !== Face.SNAKE_FANGS && rand(3) === 0 && changes < changeLimit) {
				outputText("\n\nWithout warning, you feel your canine teeth jump almost " + UnitSystem.anInch() + " in size, clashing on your gums, cutting yourself quite badly. As you attempt to find a new way to close your mouth without dislocating your jaw, you notice that they are dripping with a bitter, khaki liquid.  Watch out, and <b>try not to bite your tongue with your poisonous fangs!</b>");
